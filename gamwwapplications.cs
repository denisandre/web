...
namespace GeneXus.Programs {
   public class gamwwapplications : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV38ManageFiltersExecutionStep, AV51Pgmname, AV11FilName, AV47IsAuthorized_Display, AV48IsAuthorized_Update, AV49IsAuthorized_Delete, AV19IsAuthorized_GAMActionPermission, AV27IsAuthorized_UAMenus, AV20IsAuthorized_Name, AV50IsAuthorized_Insert) ;
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(38), 2, 0)+","+"null"+");", "Incluir", bttBtninsert_Jsonclick, 5, "Incluir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWApplications.htm");
            ...
            wb_table1_19_192( true) ;
         }
         else
         {
            wb_table1_19_192( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_192e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV51Pgmname = "GAMWWApplications";
         edtavGamactionpermission_Enabled = 0;
         AssignProp("", false, edtavGamactionpermission_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavGamactionpermission_Enabled), 5, 0), !bGXsfl_38_Refreshing);
         edtavUamenus_Enabled = 0;
         AssignProp("", false, edtavUamenus_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUamenus_Enabled), 5, 0), !bGXsfl_38_Refreshing);
         edtavGuid_Enabled = 0;
         AssignProp("", false, edtavGuid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavGuid_Enabled), 5, 0), !bGXsfl_38_Refreshing);
         edtavId_Enabled = 0;
      ...
      private void E17192( )
      {
         ...
         AV52GXV1 = 1;
         while ( AV52GXV1 <= AV24GAMApplications.Count )
         {
            AV6Application = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV24GAMApplications.Item(AV52GXV1));
      ...
      protected void E11192( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWApplicationsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV51Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               S152 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV51Pgmname+"GridState",  AV39ManageFiltersXml) ;
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV37Session.Get(AV51Pgmname+"GridState"), "") == 0 )
         {
            AV35GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV51Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV35GridState.FromXml(AV37Session.Get(AV51Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S162 ();
         if (returnInSub) return;
      ...
      protected void S162( )
      {
         ...
         returnInSub = false;
         AV53GXV2 = 1;
         while ( AV53GXV2 <= AV35GridState.gxTpr_Filtervalues.Count )
         {
            AV36GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV35GridState.gxTpr_Filtervalues.Item(AV53GXV2));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV51Pgmname+"GridState",  AV35GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_19_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_24_192e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_192e( true) ;
         }
         else
         {
            wb_table1_19_192e( false) ;
         }
      }

      protected void wb_table2_24_192( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382819193", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwapplications.js", "?202382819197", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_382( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_38_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGamactionpermission_Enabled!=0)&&(edtavGamactionpermission_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 40,'',false,'"+sGXsfl_38_idx+"',38)\"" : " ");
            ...
            /* Single line edit */
            TempTags = " " + ((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 43,'',false,'"+sGXsfl_38_idx+"',38)\"" : " ");
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16Id), 12, 0, ",", "")),StringUtil.LTrim( ((edtavId_Enabled!=0) ? context.localUtil.Format( (decimal)(AV16Id), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV16Id), "ZZZZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,43);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavId_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavId_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)38,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMKeyNumLong",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavGamactionpermission_Title',ctrl:'vGAMACTIONPERMISSION',prop:'Title'},{av:'edtavUamenus_Title',ctrl:'vUAMENUS',prop:'Title'},{av:'AV38ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV51Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV47IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV48IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV19IsAuthorized_GAMActionPermission',fld:'vISAUTHORIZED_GAMACTIONPERMISSION',pic:'',hsh:true},{av:'AV27IsAuthorized_UAMenus',fld:'vISAUTHORIZED_UAMENUS',pic:'',hsh:true},{av:'AV20IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV50IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17192',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'AV47IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV48IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV19IsAuthorized_GAMActionPermission',fld:'vISAUTHORIZED_GAMACTIONPERMISSION',pic:'',hsh:true},{av:'AV27IsAuthorized_UAMenus',fld:'vISAUTHORIZED_UAMENUS',pic:'',hsh:true},{av:'AV20IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("VGRIDACTIONS.CLICK","{handler:'E18192',iparms:[{av:'cmbavGridactions'},{av:'AV45GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV51Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'edtavGamactionpermission_Title',ctrl:'vGAMACTIONPERMISSION',prop:'Title'},{av:'edtavUamenus_Title',ctrl:'vUAMENUS',prop:'Title'},{av:'AV47IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV48IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV19IsAuthorized_GAMActionPermission',fld:'vISAUTHORIZED_GAMACTIONPERMISSION',pic:'',hsh:true},{av:'AV27IsAuthorized_UAMenus',fld:'vISAUTHORIZED_UAMENUS',pic:'',hsh:true},{av:'AV20IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV50IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'AV16Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E14192',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV38ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV51Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV11FilName',fld:'vFILNAME',pic:''},{av:'edtavGamactionpermission_Title',ctrl:'vGAMACTIONPERMISSION',prop:'Title'},{av:'edtavUamenus_Title',ctrl:'vUAMENUS',prop:'Title'},{av:'AV47IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV48IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV49IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV19IsAuthorized_GAMActionPermission',fld:'vISAUTHORIZED_GAMACTIONPERMISSION',pic:'',hsh:true},{av:'AV27IsAuthorized_UAMenus',fld:'vISAUTHORIZED_UAMENUS',pic:'',hsh:true},{av:'AV20IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV50IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
