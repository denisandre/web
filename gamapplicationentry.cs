   ...
   public class gamapplicationentry : GXDataArea
   {
      ...
      protected void WB180( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV43Id), 12, 0, ",", "")), StringUtil.LTrim( ((edtavId_Enabled!=0) ? context.localUtil.Format( (decimal)(AV43Id), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV43Id), "ZZZZZZZZZZZ9"))), " dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavId_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtavId_Enabled, 0, "text", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 0, -1, 0, true, "GeneXusSecurityCommon\\GAMKeyNumLong", "end", false, "", "HLP_GAMApplicationEntry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_88_182( true) ;
         }
         else
         {
            wb_table1_88_182( false) ;
         }
         return  ;
      }

      protected void wb_table1_88_182e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            wb_table2_216_182( true) ;
         }
         else
         {
            wb_table2_216_182( false) ;
         }
         return  ;
      }

      protected void wb_table2_216_182e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E13182( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
         {
            ...
            AV71GXV2 = 1;
            AV70GXV1 = AV6Application.getmenus(AV48MenuFilter, out  AV39Errors);
            while ( AV71GXV2 <= AV70GXV1.Count )
            {
               AV47Menu = ((GeneXus.Programs.genexussecurity.SdtGAMApplicationMenu)AV70GXV1.Item(AV71GXV2));
      ...
      protected void S162( )
      {
         ...
         {
            AV72GXV3 = 1;
            while ( AV72GXV3 <= AV39Errors.Count )
            {
               AV38Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV39Errors.Item(AV72GXV3));
         ...
         {
            AV73GXV4 = 1;
            while ( AV73GXV4 <= AV63UserErrors.Count )
            {
               AV38Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV63UserErrors.Item(AV73GXV4));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV38Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV38Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void wb_table2_216_182( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_216_182e( true) ;
         }
         else
         {
            wb_table2_216_182e( false) ;
         }
      }

      protected void wb_table1_88_182( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_88_182e( true) ;
         }
         else
         {
            wb_table1_88_182e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828194164", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapplicationentry.js", "?2023828194165", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_unnamedtable5_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("VSTSMODE.CLICK","{handler:'E12181',iparms:[{av:'cmbavStsmode'},{av:'AV56STSMode',fld:'vSTSMODE',pic:''}]");
