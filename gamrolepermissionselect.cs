...
namespace GeneXus.Programs {
   public class gamrolepermissionselect : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV40ManageFiltersExecutionStep, AV48Pgmname, AV15FilName, AV24PermissionAccessType, AV11BoolenFilter, AV27RoleId, AV10ApplicationId, AV19IsAuthorized_Name) ;
      ...
      protected void WB1Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_1Q2( true) ;
         }
         else
         {
            wb_table1_14_1Q2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_1Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 43 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(43), 2, 0)+","+"null"+");", "Adicionar selecionados", bttBtnadd_Jsonclick, 5, "Adicionar selecionados", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOADD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMRolePermissionSelect.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      {
         /* GeneXus formulas. */
         AV48Pgmname = "GAMRolePermissionSelect";
         edtavName_Enabled = 0;
         AssignProp("", false, edtavName_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavName_Enabled), 5, 0), !bGXsfl_43_Refreshing);
         edtavId_Enabled = 0;
         AssignProp("", false, edtavId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavId_Enabled), 5, 0), !bGXsfl_43_Refreshing);
         edtavAppid_Enabled = 0;
         AssignProp("", false, edtavAppid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavAppid_Enabled), 5, 0), !bGXsfl_43_Refreshing);
         edtavDsc_Enabled = 0;
         AssignProp("", false, edtavDsc_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDsc_Enabled), 5, 0), !bGXsfl_43_Refreshing);
      }
      ...
      private void E171Q2( )
      {
         ...
         {
            AV49GXV1 = 1;
            while ( AV49GXV1 <= AV29GAMPermissions.Count )
            {
               AV23Permission = ((GeneXus.Programs.genexussecurity.SdtGAMPermission)AV29GAMPermissions.Item(AV49GXV1));
               AV28Select = false;
               AssignAttri("", false, chkavSelect_Internalname, AV28Select);
      ...
      protected void E111Q2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMRolePermissionSelectFilters")) + "," + UrlEncode(StringUtil.RTrim(AV48Pgmname+"GridState"));
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         AV53GXV4 = 1;
         while ( AV53GXV4 <= AV37GridState.gxTpr_Filtervalues.Count )
         {
            AV38GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV37GridState.gxTpr_Filtervalues.Item(AV53GXV4));
      ...
      protected void wb_table1_14_1Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_19_1Q2( true) ;
         }
         else
         {
            wb_table2_19_1Q2( false) ;
         }
         return  ;
      }

      protected void wb_table2_19_1Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_1Q2e( true) ;
         }
         else
         {
            wb_table1_14_1Q2e( false) ;
         }
      }

      protected void wb_table2_19_1Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_19_1Q2e( true) ;
         }
         else
         {
            wb_table2_19_1Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828192049", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrolepermissionselect.js", "?2023828192051", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121Q2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV40ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV48Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV15FilName',fld:'vFILNAME',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV24PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV11BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV27RoleId',fld:'vROLEID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV10ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV19IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         ...
         setEventMetadata("'DOADD'","{handler:'E141Q2',iparms:[{av:'AV27RoleId',fld:'vROLEID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV28Select',fld:'vSELECT',grid:43,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_43',ctrl:'GRID',grid:43,prop:'GridRC',grid:43},{av:'AV9AppId',fld:'vAPPID',grid:43,pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV18ID',fld:'vID',grid:43,pic:'',hsh:true},{av:'AV8Access',fld:'vACCESS',grid:43,pic:''},{av:'AV20isOK',fld:'vISOK',pic:''},{av:'AV10ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true}]");
