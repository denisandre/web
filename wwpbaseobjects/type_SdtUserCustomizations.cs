...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "UserCustomizations" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtUserCustomizations : GxSilentTrnSdt
   {
      ...
      public void Load( string AV143UserCustomizationsId ,
                        string AV144UserCustomizationsKey )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV143UserCustomizationsId,(string)AV144UserCustomizationsKey});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\UserCustomizations", Namespace = "agl_tresorygroup")]
