...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "WWP_UserExtended" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_UserExtended : GxSilentTrnSdt
   {
      ...
      public void Load( string AV49WWPUserExtendedId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV49WWPUserExtendedId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\WWP_UserExtended", Namespace = "agl_tresorygroup")]
