...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_Mail" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_Mail : GxSilentTrnSdt
   {
      ...
      public void Load( long AV122WWPMailId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV122WWPMailId});
         return  ;
      }
      ...
      public GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments> gxTpr_Attachments_GXBCLevelCollection
      {
         get {
            if ( gxTv_SdtWWP_Mail_Attachments == null )
            {
               gxTv_SdtWWP_Mail_Attachments = new GXBCLevelCollection<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail_Attachments>( context, "WWP_Mail.Attachments", "agl_tresorygroup");
            }
   ...
   [DataContract(Name = @"WWPBaseObjects\Mail\WWP_Mail", Namespace = "agl_tresorygroup")]
