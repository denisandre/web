...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   [XmlType(TypeName =  "WWP_MailTemplate" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_MailTemplate : GxSilentTrnSdt
   {
      ...
      public void Load( string AV130WWPMailTemplateName )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV130WWPMailTemplateName});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Mail\WWP_MailTemplate", Namespace = "agl_tresorygroup")]
