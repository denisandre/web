...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   ...
   [XmlType(TypeName =  "WWP_DiscussionMessageMention" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_DiscussionMessageMention : GxSilentTrnSdt
   {
      ...
      public void Load( long AV137WWPDiscussionMessageId ,
                        string AV138WWPDiscussionMentionUserId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV137WWPDiscussionMessageId,(string)AV138WWPDiscussionMentionUserId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessageMention", Namespace = "agl_tresorygroup")]
