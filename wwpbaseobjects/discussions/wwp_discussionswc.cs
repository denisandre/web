...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   public class wwp_discussionswc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         A142WWPDiscussionMessageEntityReco = GetPar( "WWPDiscussionMessageEntityReco");
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV24WWPDiscussionMessageEntityRecordId, AV8WWPEntityId, AV33Pgmname, AV14IsFirstDiscussionRecord, AV25WWPDiscussionMessageIdToExpand, AV28WWPSubscriptionEntityRecordDescription, AV27WWPNotificationLink, AV7WWPDiscussionMessage, A142WWPDiscussionMessageEntityReco, sPrefix) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPDISCUSSIONMESSAGEENTITYRECO", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( A142WWPDiscussionMessageEntityReco, "")), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         forbiddenHiddens = new GXProperties();
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"WWP_DiscussionsWC");
         forbiddenHiddens.Add("WWPDiscussionMessageEntityReco", StringUtil.RTrim( context.localUtil.Format( A142WWPDiscussionMessageEntityReco, "")));
      ...
      protected void WB2M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNewthread_Internalname, "Iniciar um novo tópico", "", "", lblNewthread_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e112m1_client"+"'", "", "StartNewThreadTB", 7, "", lblNewthread_Visible, 1, 0, 0, "HLP_WWPBaseObjects\\Discussions\\WWP_DiscussionsWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 16 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtWWPDiscussionMessageEntityReco_Internalname, A142WWPDiscussionMessageEntityReco, StringUtil.RTrim( context.localUtil.Format( A142WWPDiscussionMessageEntityReco, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPDiscussionMessageEntityReco_Jsonclick, 0, "Attribute", "", "", "", "", edtWWPDiscussionMessageEntityReco_Visible, 0, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WWPBaseObjects\\Discussions\\WWP_DiscussionsWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string A142WWPDiscussionMessageEntityReco ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPDISCUSSIONMESSAGEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A137WWPDiscussionMessageId), "ZZZZZZZZZ9"), context));
      ...
      protected void RF2M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A49WWPUserExtendedId = H002M2_A49WWPUserExtendedId[0];
               A136WWPDiscussionMessageThreadId = H002M2_A136WWPDiscussionMessageThreadId[0];
               n136WWPDiscussionMessageThreadId = H002M2_n136WWPDiscussionMessageThreadId[0];
               A62WWPEntityId = H002M2_A62WWPEntityId[0];
               A40000WWPUserExtendedPhoto_GXI = H002M2_A40000WWPUserExtendedPhoto_GXI[0];
               A142WWPDiscussionMessageEntityReco = H002M2_A142WWPDiscussionMessageEntityReco[0];
               AssignAttri(sPrefix, false, "A142WWPDiscussionMessageEntityReco", A142WWPDiscussionMessageEntityReco);
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPDISCUSSIONMESSAGEENTITYRECO", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( A142WWPDiscussionMessageEntityReco, "")), context));
               A137WWPDiscussionMessageId = H002M2_A137WWPDiscussionMessageId[0];
               A141WWPDiscussionMessageMessage = H002M2_A141WWPDiscussionMessageMessage[0];
               A140WWPDiscussionMessageDate = H002M2_A140WWPDiscussionMessageDate[0];
               A50WWPUserExtendedFullName = H002M2_A50WWPUserExtendedFullName[0];
               A40000WWPUserExtendedPhoto_GXI = H002M2_A40000WWPUserExtendedPhoto_GXI[0];
               A50WWPUserExtendedFullName = H002M2_A50WWPUserExtendedFullName[0];
               E162M2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPDISCUSSIONMESSAGEID"+"_"+sGXsfl_16_idx, GetSecureSignedToken( sPrefix+sGXsfl_16_idx, context.localUtil.Format( (decimal)(A137WWPDiscussionMessageId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV33Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV33Pgmname, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISFIRSTDISCUSSIONRECORD", AV14IsFirstDiscussionRecord);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISFIRSTDISCUSSIONRECORD", GetSecureSignedToken( sPrefix, AV14IsFirstDiscussionRecord, context));
      ...
      protected void E152M2( )
      {
         ...
         if ( AV25WWPDiscussionMessageIdToExpand == 0 )
         {
            ...
            {
               A136WWPDiscussionMessageThreadId = H002M4_A136WWPDiscussionMessageThreadId[0];
               n136WWPDiscussionMessageThreadId = H002M4_n136WWPDiscussionMessageThreadId[0];
               A142WWPDiscussionMessageEntityReco = H002M4_A142WWPDiscussionMessageEntityReco[0];
               AssignAttri(sPrefix, false, "A142WWPDiscussionMessageEntityReco", A142WWPDiscussionMessageEntityReco);
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPDISCUSSIONMESSAGEENTITYRECO", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( A142WWPDiscussionMessageEntityReco, "")), context));
               A62WWPEntityId = H002M4_A62WWPEntityId[0];
               A137WWPDiscussionMessageId = H002M4_A137WWPDiscussionMessageId[0];
               AV25WWPDiscussionMessageIdToExpand = A137WWPDiscussionMessageId;
               AssignAttri(sPrefix, false, "AV25WWPDiscussionMessageIdToExpand", StringUtil.LTrimStr( (decimal)(AV25WWPDiscussionMessageIdToExpand), 10, 0));
               GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWPDISCUSSIONMESSAGEIDTOEXPAND", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV25WWPDiscussionMessageIdToExpand), "ZZZZZZZZZ9"), context));
      ...
      private void E162M2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Discussionsonethreadcollapsedwc_Component) != 0 )
         {
            ...
            WebComp_Discussionsonethreadcollapsedwc.componentprepare(new Object[] {(string)sPrefix+"W0048",(string)sGXsfl_16_idx,(long)A137WWPDiscussionMessageId});
            WebComp_Discussionsonethreadcollapsedwc.componentbind(new Object[] {(string)""});
         }
         if ( A137WWPDiscussionMessageId == AV25WWPDiscussionMessageIdToExpand )
         {
            ...
            if ( StringUtil.Len( WebComp_Wcdiscussionsonethreadwc_Component) != 0 )
            {
               ...
               WebComp_Wcdiscussionsonethreadwc.componentprepare(new Object[] {(string)sPrefix+"W0045",(string)sGXsfl_16_idx,(long)A137WWPDiscussionMessageId,(string)AV28WWPSubscriptionEntityRecordDescription,(string)AV27WWPNotificationLink});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828123281", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/discussions/wwp_discussionswc.js", "?2023828123284", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Suggest/SuggestRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'chkavIsdiscussionanswerswcloaded.Visible',ctrl:'vISDISCUSSIONANSWERSWCLOADED',prop:'Visible'},{av:'edtWWPDiscussionMessageId_Visible',ctrl:'WWPDISCUSSIONMESSAGEID',prop:'Visible'},{av:'AV28WWPSubscriptionEntityRecordDescription',fld:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',pic:''},{av:'AV27WWPNotificationLink',fld:'vWWPNOTIFICATIONLINK',pic:''},{av:'sPrefix'},{av:'A137WWPDiscussionMessageId',fld:'WWPDISCUSSIONMESSAGEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV8WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV24WWPDiscussionMessageEntityRecordId',fld:'vWWPDISCUSSIONMESSAGEENTITYRECORDID',pic:''},{av:'A136WWPDiscussionMessageThreadId',fld:'WWPDISCUSSIONMESSAGETHREADID',pic:'ZZZZZZZZZ9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14IsFirstDiscussionRecord',fld:'vISFIRSTDISCUSSIONRECORD',pic:'',hsh:true},{av:'AV25WWPDiscussionMessageIdToExpand',fld:'vWWPDISCUSSIONMESSAGEIDTOEXPAND',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV7WWPDiscussionMessage',fld:'vWWPDISCUSSIONMESSAGE',pic:'',hsh:true},{av:'A142WWPDiscussionMessageEntityReco',fld:'WWPDISCUSSIONMESSAGEENTITYRECO',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E162M2',iparms:[{av:'AV14IsFirstDiscussionRecord',fld:'vISFIRSTDISCUSSIONRECORD',pic:'',hsh:true},{av:'A40000WWPUserExtendedPhoto_GXI',fld:'WWPUSEREXTENDEDPHOTO_GXI',pic:''},{av:'A137WWPDiscussionMessageId',fld:'WWPDISCUSSIONMESSAGEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV25WWPDiscussionMessageIdToExpand',fld:'vWWPDISCUSSIONMESSAGEIDTOEXPAND',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV28WWPSubscriptionEntityRecordDescription',fld:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',pic:''},{av:'AV27WWPNotificationLink',fld:'vWWPNOTIFICATIONLINK',pic:''}]");
         ...
         setEventMetadata("ENTER","{handler:'E122M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24WWPDiscussionMessageEntityRecordId',fld:'vWWPDISCUSSIONMESSAGEENTITYRECORDID',pic:''},{av:'AV8WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'chkavIsdiscussionanswerswcloaded.Visible',ctrl:'vISDISCUSSIONANSWERSWCLOADED',prop:'Visible'},{av:'edtWWPDiscussionMessageId_Visible',ctrl:'WWPDISCUSSIONMESSAGEID',prop:'Visible'},{av:'AV14IsFirstDiscussionRecord',fld:'vISFIRSTDISCUSSIONRECORD',pic:'',hsh:true},{av:'AV25WWPDiscussionMessageIdToExpand',fld:'vWWPDISCUSSIONMESSAGEIDTOEXPAND',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV28WWPSubscriptionEntityRecordDescription',fld:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',pic:''},{av:'AV27WWPNotificationLink',fld:'vWWPNOTIFICATIONLINK',pic:''},{av:'AV7WWPDiscussionMessage',fld:'vWWPDISCUSSIONMESSAGE',pic:'',hsh:true},{av:'A142WWPDiscussionMessageEntityReco',fld:'WWPDISCUSSIONMESSAGEENTITYRECO',pic:'',hsh:true},{av:'sPrefix'},{av:'AV15Message',fld:'vMESSAGE',pic:''},{av:'AV26WWPEntityName',fld:'vWWPENTITYNAME',pic:''},{av:'Ucmentions_Selecteditemsjson',ctrl:'UCMENTIONS',prop:'SelectedItemsJson'},{av:'A137WWPDiscussionMessageId',fld:'WWPDISCUSSIONMESSAGEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A136WWPDiscussionMessageThreadId',fld:'WWPDISCUSSIONMESSAGETHREADID',pic:'ZZZZZZZZZ9'}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'chkavIsdiscussionanswerswcloaded.Visible',ctrl:'vISDISCUSSIONANSWERSWCLOADED',prop:'Visible'},{av:'edtWWPDiscussionMessageId_Visible',ctrl:'WWPDISCUSSIONMESSAGEID',prop:'Visible'},{av:'AV14IsFirstDiscussionRecord',fld:'vISFIRSTDISCUSSIONRECORD',pic:'',hsh:true},{av:'AV25WWPDiscussionMessageIdToExpand',fld:'vWWPDISCUSSIONMESSAGEIDTOEXPAND',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV28WWPSubscriptionEntityRecordDescription',fld:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',pic:''},{av:'AV27WWPNotificationLink',fld:'vWWPNOTIFICATIONLINK',pic:''},{av:'AV7WWPDiscussionMessage',fld:'vWWPDISCUSSIONMESSAGE',pic:'',hsh:true},{av:'sPrefix'},{av:'A137WWPDiscussionMessageId',fld:'WWPDISCUSSIONMESSAGEID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV8WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A142WWPDiscussionMessageEntityReco',fld:'WWPDISCUSSIONMESSAGEENTITYRECO',pic:'',hsh:true},{av:'AV24WWPDiscussionMessageEntityRecordId',fld:'vWWPDISCUSSIONMESSAGEENTITYRECORDID',pic:''},{av:'A136WWPDiscussionMessageThreadId',fld:'WWPDISCUSSIONMESSAGETHREADID',pic:'ZZZZZZZZZ9'},{av:'AV33Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[{av:'divWcdiscussionsonethreadcell_Visible',ctrl:'WCDISCUSSIONSONETHREADCELL',prop:'Visible'},{av:'AV14IsFirstDiscussionRecord',fld:'vISFIRSTDISCUSSIONRECORD',pic:'',hsh:true},{av:'AV25WWPDiscussionMessageIdToExpand',fld:'vWWPDISCUSSIONMESSAGEIDTOEXPAND',pic:'ZZZZZZZZZ9',hsh:true},{av:'divGridcell_Visible',ctrl:'GRIDCELL',prop:'Visible'},{av:'AV13IsDiscussionAnswersWCLoaded',fld:'vISDISCUSSIONANSWERSWCLOADED',pic:''},{av:'lblNewthread_Visible',ctrl:'NEWTHREAD',prop:'Visible'}]}");
      ...
      public override void initialize( )
      {
         ...
         WebComp_Discussionsonethreadcollapsedwc_Component = "";
         scmdbuf = "";
         H002M2_A49WWPUserExtendedId = new string[] {""} ;
         H002M2_A136WWPDiscussionMessageThreadId = new long[1] ;
         H002M2_n136WWPDiscussionMessageThreadId = new bool[] {false} ;
         H002M2_A62WWPEntityId = new long[1] ;
         H002M2_A40000WWPUserExtendedPhoto_GXI = new string[] {""} ;
         H002M2_A142WWPDiscussionMessageEntityReco = new string[] {""} ;
         H002M2_A137WWPDiscussionMessageId = new long[1] ;
         H002M2_A141WWPDiscussionMessageMessage = new string[] {""} ;
         H002M2_A140WWPDiscussionMessageDate = new DateTime[] {DateTime.MinValue} ;
         H002M2_A50WWPUserExtendedFullName = new string[] {""} ;
         ...
         H002M4_A136WWPDiscussionMessageThreadId = new long[1] ;
         H002M4_n136WWPDiscussionMessageThreadId = new bool[] {false} ;
         H002M4_A142WWPDiscussionMessageEntityReco = new string[] {""} ;
         H002M4_A62WWPEntityId = new long[1] ;
         H002M4_A137WWPDiscussionMessageId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.discussions.wwp_discussionswc__default(),
            new Object[][] {
                new Object[] {
               H002M2_A49WWPUserExtendedId, H002M2_A136WWPDiscussionMessageThreadId, H002M2_n136WWPDiscussionMessageThreadId, H002M2_A62WWPEntityId, H002M2_A40000WWPUserExtendedPhoto_GXI, H002M2_A142WWPDiscussionMessageEntityReco, H002M2_A137WWPDiscussionMessageId, H002M2_A141WWPDiscussionMessageMessage, H002M2_A140WWPDiscussionMessageDate, H002M2_A50WWPUserExtendedFullName
               }
               , new Object[] {
               H002M3_AGRID_nRecordCount
               }
               , new Object[] {
               H002M4_A136WWPDiscussionMessageThreadId, H002M4_n136WWPDiscussionMessageThreadId, H002M4_A142WWPDiscussionMessageEntityReco, H002M4_A62WWPEntityId, H002M4_A137WWPDiscussionMessageId
               }
            }
         );
      ...
      private string[] H002M2_A49WWPUserExtendedId ;
      private long[] H002M2_A136WWPDiscussionMessageThreadId ;
      private bool[] H002M2_n136WWPDiscussionMessageThreadId ;
      private long[] H002M2_A62WWPEntityId ;
      private string[] H002M2_A40000WWPUserExtendedPhoto_GXI ;
      private string[] H002M2_A142WWPDiscussionMessageEntityReco ;
      private long[] H002M2_A137WWPDiscussionMessageId ;
      private string[] H002M2_A141WWPDiscussionMessageMessage ;
      private DateTime[] H002M2_A140WWPDiscussionMessageDate ;
      private string[] H002M2_A50WWPUserExtendedFullName ;
      private long[] H002M3_AGRID_nRecordCount ;
      private long[] H002M4_A136WWPDiscussionMessageThreadId ;
      private bool[] H002M4_n136WWPDiscussionMessageThreadId ;
      private string[] H002M4_A142WWPDiscussionMessageEntityReco ;
      private long[] H002M4_A62WWPEntityId ;
      private long[] H002M4_A137WWPDiscussionMessageId ;
