...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   ...
   [XmlType(TypeName =  "WWP_DiscussionMessage" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_DiscussionMessage : GxSilentTrnSdt
   {
      ...
      public void Load( long AV137WWPDiscussionMessageId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV137WWPDiscussionMessageId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessage", Namespace = "agl_tresorygroup")]
