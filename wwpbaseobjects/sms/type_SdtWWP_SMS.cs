...
namespace GeneXus.Programs.wwpbaseobjects.sms {
   ...
   [XmlType(TypeName =  "WWP_SMS" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_SMS : GxSilentTrnSdt
   {
      ...
      public void Load( long AV75WWPSMSId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV75WWPSMSId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\SMS\WWP_SMS", Namespace = "agl_tresorygroup")]
