   ...
   public class wwp_masterpagetopactionswc : GXWebComponent
   {
      ...
      protected void WB2S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            AV5UserImage_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage))&&String.IsNullOrEmpty(StringUtil.RTrim( AV17Userimage_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)) ? AV17Userimage_GXI : context.PathToRelativeUrl( AV5UserImage));
      ...
      protected void E112S2( )
      {
         ...
         AssignProp(sPrefix, false, imgavUserimage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV5UserImage)) ? AV17Userimage_GXI : context.convertURL( context.PathToRelativeUrl( AV5UserImage))), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382895152", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wwp_masterpagetopactionswc.js", "?202382895156", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOACTIONCHANGEPASSWORD'","{handler:'E122S2',iparms:[]");
         setEventMetadata("'DOACTIONCHANGEPASSWORD'",",oparms:[]}");
         setEventMetadata("'DOLOGOUT'","{handler:'E132S2',iparms:[]");
      ...
      private string AV17Userimage_GXI ;
