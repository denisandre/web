...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPTransactionContext.Attribute" , Namespace="agl_tresorygroup" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPTransactionContext.Attribute", Namespace="agl_tresorygroup")]
