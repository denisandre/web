...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   ...
   [XmlType(TypeName =  "WWP_Subscription" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_Subscription : GxSilentTrnSdt
   {
      ...
      public void Load( long AV67WWPSubscriptionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV67WWPSubscriptionId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Subscriptions\WWP_Subscription", Namespace = "agl_tresorygroup")]
