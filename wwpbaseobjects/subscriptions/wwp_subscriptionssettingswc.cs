...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettingswc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV16WWPEntityId = (long)(Math.Round(NumberUtil.Val( GetPar( "WWPEntityId"), "."), 18, MidpointRounding.ToEven));
         A73WWPNotificationDefinitionAllow = StringUtil.StrToBool( GetPar( "WWPNotificationDefinitionAllow"));
         ...
         A71WWPNotificationDefinitionDescr = GetPar( "WWPNotificationDefinitionDescr");
         ...
         A72WWPNotificationDefinitionAppli = (short)(Math.Round(NumberUtil.Val( GetPar( "WWPNotificationDefinitionAppli"), "."), 18, MidpointRounding.ToEven));
         A68WWPSubscriptionEntityRecordId = GetPar( "WWPSubscriptionEntityRecordId");
         A70WWPSubscriptionEntityRecordDes = GetPar( "WWPSubscriptionEntityRecordDes");
         AV12NotifShowOnlySubscribedEvents = StringUtil.StrToBool( GetPar( "NotifShowOnlySubscribedEvents"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV30Pgmname, A62WWPEntityId, AV16WWPEntityId, A73WWPNotificationDefinitionAllow, A65WWPNotificationDefinitionId, A71WWPNotificationDefinitionDescr, A49WWPUserExtendedId, AV29Udparg1, A69WWPSubscriptionSubscribed, A61WWPSubscriptionRoleId, A67WWPSubscriptionId, A72WWPNotificationDefinitionAppli, A68WWPSubscriptionEntityRecordId, A70WWPSubscriptionEntityRecordDes, AV12NotifShowOnlySubscribedEvents, sPrefix) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV30Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV30Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPENTITYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A62WWPEntityId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPENTITYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16WWPEntityId), 10, 0, ",", "")));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONALLOW", A73WWPNotificationDefinitionAllow);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONDESCR", A71WWPNotificationDefinitionDescr);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONAPPLI", StringUtil.LTrim( StringUtil.NToC( (decimal)(A72WWPNotificationDefinitionAppli), 1, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONENTITYRECORDID", A68WWPSubscriptionEntityRecordId);
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONENTITYRECORDDES", A70WWPSubscriptionEntityRecordDes);
      ...
      protected void WB2I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_11_2I2( true) ;
         }
         else
         {
            wb_table1_11_2I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_11_2I2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
      ...
      private void E142I2( )
      {
         ...
         {
            A65WWPNotificationDefinitionId = H002I2_A65WWPNotificationDefinitionId[0];
            A72WWPNotificationDefinitionAppli = H002I2_A72WWPNotificationDefinitionAppli[0];
            A73WWPNotificationDefinitionAllow = H002I2_A73WWPNotificationDefinitionAllow[0];
            A62WWPEntityId = H002I2_A62WWPEntityId[0];
            A71WWPNotificationDefinitionDescr = H002I2_A71WWPNotificationDefinitionDescr[0];
            AV5WWPNotificationDefinitionId = A65WWPNotificationDefinitionId;
            AssignAttri(sPrefix, false, edtavWwpnotificationdefinitionid_Internalname, StringUtil.LTrimStr( (decimal)(AV5WWPNotificationDefinitionId), 10, 0));
            AV18WWPNotificationDescriptionBase = A71WWPNotificationDefinitionDescr;
            ...
            /* Using cursor H002I3 */
            pr_default.execute(1, new Object[] {A65WWPNotificationDefinitionId, AV29Udparg1});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A61WWPSubscriptionRoleId = H002I3_A61WWPSubscriptionRoleId[0];
               n61WWPSubscriptionRoleId = H002I3_n61WWPSubscriptionRoleId[0];
               A69WWPSubscriptionSubscribed = H002I3_A69WWPSubscriptionSubscribed[0];
               A49WWPUserExtendedId = H002I3_A49WWPUserExtendedId[0];
               n49WWPUserExtendedId = H002I3_n49WWPUserExtendedId[0];
               A67WWPSubscriptionId = H002I3_A67WWPSubscriptionId[0];
               A68WWPSubscriptionEntityRecordId = H002I3_A68WWPSubscriptionEntityRecordId[0];
               A70WWPSubscriptionEntityRecordDes = H002I3_A70WWPSubscriptionEntityRecordDes[0];
               AV7WWPSubscriptionId = A67WWPSubscriptionId;
               AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV7WWPSubscriptionId), 10, 0));
               if ( A72WWPNotificationDefinitionAppli != 1 )
               {
                  if ( StringUtil.StrCmp(A68WWPSubscriptionEntityRecordId, "") != 0 )
                  {
                     AV6WWPSubscriptionEntityRecordDescription = A70WWPSubscriptionEntityRecordDes;
                     AssignAttri(sPrefix, false, edtavWwpsubscriptionentityrecorddescription_Internalname, AV6WWPSubscriptionEntityRecordDescription);
                     AV19WWPSubscriptionEntityRecordId = A68WWPSubscriptionEntityRecordId;
                     AssignAttri(sPrefix, false, edtavWwpsubscriptionentityrecordid_Internalname, AV19WWPSubscriptionEntityRecordId);
            ...
            pr_default.close(1);
            if ( ! AV14SubscriptionLoaded && ! AV11IncludeNotification && ( A72WWPNotificationDefinitionAppli != 2 ) && ! AV12NotifShowOnlySubscribedEvents )
            {
               AV9GridRecordCount = (short)(AV9GridRecordCount+1);
               /* Load Method */
               if ( wbStart != -1 )
      ...
      protected void wb_table1_11_2I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 14 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_11_2I2e( true) ;
         }
         else
         {
            wb_table1_11_2I2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382894234", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettingswc.js", "?202382894236", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         }
      ...
      protected void sendrow_142( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_14_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Check box */
            TempTags = " " + ((chkavIncludenotification.Enabled!=0)&&(chkavIncludenotification.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 21,'"+sPrefix+"',false,'"+sGXsfl_14_idx+"',14)\"" : " ");
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavWwpnotificationdefinitionid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5WWPNotificationDefinitionId), 10, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5WWPNotificationDefinitionId), "ZZZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavWwpnotificationdefinitionid_Enabled!=0)&&(edtavWwpnotificationdefinitionid_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,31);\"" : " "),(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavWwpnotificationdefinitionid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(int)edtavWwpnotificationdefinitionid_Visible,(short)1,(short)0,(string)"text",(string)"1",(short)10,(string)"chr",(short)1,(string)"row",(short)10,(short)0,(short)0,(short)14,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavWwpsubscriptionid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7WWPSubscriptionId), 10, 0, ",", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7WWPSubscriptionId), "ZZZZZZZZZ9"))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+((edtavWwpsubscriptionid_Enabled!=0)&&(edtavWwpsubscriptionid_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,34);\"" : " "),(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavWwpsubscriptionid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(int)edtavWwpsubscriptionid_Visible,(short)1,(short)0,(string)"text",(string)"1",(short)10,(string)"chr",(short)1,(string)"row",(short)10,(short)0,(short)0,(short)14,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            if ( GridContainer.GetWrapped() == 1 )
            {
               GridContainer.CloseTag("cell");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GridRow.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {(string)edtavWwpsubscriptionentityrecorddescription_Internalname,(string)AV6WWPSubscriptionEntityRecordDescription,(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavWwpsubscriptionentityrecorddescription_Enabled!=0)&&(edtavWwpsubscriptionentityrecorddescription_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,40);\"" : " "),(short)0,(int)edtavWwpsubscriptionentityrecorddescription_Visible,(short)1,(short)0,(short)80,(string)"chr",(short)3,(string)"row",(short)0,(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"200",(short)-1,(short)0,(string)"",(string)"",(short)-1,(bool)true,(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(short)0,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            if ( GridContainer.GetWrapped() == 1 )
            {
               GridContainer.CloseTag("cell");
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecordid_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecorddescription_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E142I2',iparms:[{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecordid_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecorddescription_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecordid_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecorddescription_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecordid_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecorddescription_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecordid_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDID',prop:'Visible'},{av:'edtavWwpsubscriptionentityrecorddescription_Visible',ctrl:'vWWPSUBSCRIPTIONENTITYRECORDDESCRIPTION',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV16WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A73WWPNotificationDefinitionAllow',fld:'WWPNOTIFICATIONDEFINITIONALLOW',pic:''},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A70WWPSubscriptionEntityRecordDes',fld:'WWPSUBSCRIPTIONENTITYRECORDDES',pic:''},{av:'AV12NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'AV30Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'subGrid_Recordcount'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002I2_A65WWPNotificationDefinitionId = new long[1] ;
         H002I2_A72WWPNotificationDefinitionAppli = new short[1] ;
         H002I2_A73WWPNotificationDefinitionAllow = new bool[] {false} ;
         H002I2_A62WWPEntityId = new long[1] ;
         H002I2_A71WWPNotificationDefinitionDescr = new string[] {""} ;
         AV18WWPNotificationDescriptionBase = "";
         H002I3_A65WWPNotificationDefinitionId = new long[1] ;
         H002I3_A61WWPSubscriptionRoleId = new string[] {""} ;
         H002I3_n61WWPSubscriptionRoleId = new bool[] {false} ;
         H002I3_A69WWPSubscriptionSubscribed = new bool[] {false} ;
         H002I3_A49WWPUserExtendedId = new string[] {""} ;
         H002I3_n49WWPUserExtendedId = new bool[] {false} ;
         H002I3_A67WWPSubscriptionId = new long[1] ;
         H002I3_A68WWPSubscriptionEntityRecordId = new string[] {""} ;
         H002I3_A70WWPSubscriptionEntityRecordDes = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettingswc__default(),
            new Object[][] {
                new Object[] {
               H002I2_A65WWPNotificationDefinitionId, H002I2_A72WWPNotificationDefinitionAppli, H002I2_A73WWPNotificationDefinitionAllow, H002I2_A62WWPEntityId, H002I2_A71WWPNotificationDefinitionDescr
               }
               , new Object[] {
               H002I3_A65WWPNotificationDefinitionId, H002I3_A61WWPSubscriptionRoleId, H002I3_n61WWPSubscriptionRoleId, H002I3_A69WWPSubscriptionSubscribed, H002I3_A49WWPUserExtendedId, H002I3_n49WWPUserExtendedId, H002I3_A67WWPSubscriptionId, H002I3_A68WWPSubscriptionEntityRecordId, H002I3_A70WWPSubscriptionEntityRecordDes
               }
            }
         );
         AV30Pgmname = "WWPBaseObjects.Subscriptions.WWP_SubscriptionsSettingsWC";
      ...
      private long[] H002I2_A65WWPNotificationDefinitionId ;
      private short[] H002I2_A72WWPNotificationDefinitionAppli ;
      private bool[] H002I2_A73WWPNotificationDefinitionAllow ;
      private long[] H002I2_A62WWPEntityId ;
      private string[] H002I2_A71WWPNotificationDefinitionDescr ;
      private long[] H002I3_A65WWPNotificationDefinitionId ;
      private string[] H002I3_A61WWPSubscriptionRoleId ;
      private bool[] H002I3_n61WWPSubscriptionRoleId ;
      private bool[] H002I3_A69WWPSubscriptionSubscribed ;
      private string[] H002I3_A49WWPUserExtendedId ;
      private bool[] H002I3_n49WWPUserExtendedId ;
      private long[] H002I3_A67WWPSubscriptionId ;
      private string[] H002I3_A68WWPSubscriptionEntityRecordId ;
      private string[] H002I3_A70WWPSubscriptionEntityRecordDes ;
   ...
   public class wwp_subscriptionssettingswc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H002I3(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] , (long)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002I2", "SELECT WWPNotificationDefinitionId, WWPNotificationDefinitionAppli, WWPNotificationDefinitionAllow, WWPEntityId, WWPNotificationDefinitionDescr FROM WWP_NotificationDefinition WHERE (WWPEntityId = :AV16WWPEntityId) AND (WWPNotificationDefinitionAllow) ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002I2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002I3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002I3,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
