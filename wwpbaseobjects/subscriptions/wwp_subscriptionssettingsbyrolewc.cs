...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionssettingsbyrolewc : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV26Pgmname, A62WWPEntityId, AV13WWPEntityId, A72WWPNotificationDefinitionAppli, A65WWPNotificationDefinitionId, A71WWPNotificationDefinitionDescr, A61WWPSubscriptionRoleId, AV16WWPSubscriptionRoleId, A67WWPSubscriptionId, AV10NotifShowOnlySubscribedEvents, sPrefix) ;
      ...
      protected void WB2J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_11_2J2( true) ;
         }
         else
         {
            wb_table1_11_2J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_11_2J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
      ...
      private void E142J2( )
      {
         ...
         {
            A65WWPNotificationDefinitionId = H002J2_A65WWPNotificationDefinitionId[0];
            A72WWPNotificationDefinitionAppli = H002J2_A72WWPNotificationDefinitionAppli[0];
            A62WWPEntityId = H002J2_A62WWPEntityId[0];
            A71WWPNotificationDefinitionDescr = H002J2_A71WWPNotificationDefinitionDescr[0];
            AV5WWPNotificationDefinitionId = A65WWPNotificationDefinitionId;
            AssignAttri(sPrefix, false, edtavWwpnotificationdefinitionid_Internalname, StringUtil.LTrimStr( (decimal)(AV5WWPNotificationDefinitionId), 10, 0));
            AV15WWPNotificationDescriptionBase = A71WWPNotificationDefinitionDescr;
            ...
            AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV6WWPSubscriptionId), 10, 0));
            /* Using cursor H002J3 */
            pr_default.execute(1, new Object[] {A65WWPNotificationDefinitionId, AV16WWPSubscriptionRoleId, A72WWPNotificationDefinitionAppli});
            while ( (pr_default.getStatus(1) != 101) )
            {
               A61WWPSubscriptionRoleId = H002J3_A61WWPSubscriptionRoleId[0];
               n61WWPSubscriptionRoleId = H002J3_n61WWPSubscriptionRoleId[0];
               A67WWPSubscriptionId = H002J3_A67WWPSubscriptionId[0];
               AV6WWPSubscriptionId = A67WWPSubscriptionId;
               AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV6WWPSubscriptionId), 10, 0));
      ...
      protected void wb_table1_11_2J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
         ...
         if ( wbEnd == 14 )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_11_2J2e( true) ;
         }
         else
         {
            wb_table1_11_2J2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382894556", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionssettingsbyrolewc.js", "?202382894557", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV13WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'AV16WWPSubscriptionRoleId',fld:'vWWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'AV10NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E142J2',iparms:[{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV13WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'AV16WWPSubscriptionRoleId',fld:'vWWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'AV10NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         ...
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavWwpnotificationdefinitionid_Visible',ctrl:'vWWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'A62WWPEntityId',fld:'WWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV13WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'A72WWPNotificationDefinitionAppli',fld:'WWPNOTIFICATIONDEFINITIONAPPLI',pic:'9'},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9'},{av:'A71WWPNotificationDefinitionDescr',fld:'WWPNOTIFICATIONDEFINITIONDESCR',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'AV16WWPSubscriptionRoleId',fld:'vWWPSUBSCRIPTIONROLEID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'AV10NotifShowOnlySubscribedEvents',fld:'vNOTIFSHOWONLYSUBSCRIBEDEVENTS',pic:''},{av:'sPrefix'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'subGrid_Recordcount'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002J2_A65WWPNotificationDefinitionId = new long[1] ;
         H002J2_A72WWPNotificationDefinitionAppli = new short[1] ;
         H002J2_A62WWPEntityId = new long[1] ;
         H002J2_A71WWPNotificationDefinitionDescr = new string[] {""} ;
         AV15WWPNotificationDescriptionBase = "";
         H002J3_A65WWPNotificationDefinitionId = new long[1] ;
         H002J3_A61WWPSubscriptionRoleId = new string[] {""} ;
         H002J3_n61WWPSubscriptionRoleId = new bool[] {false} ;
         H002J3_A67WWPSubscriptionId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionssettingsbyrolewc__default(),
            new Object[][] {
                new Object[] {
               H002J2_A65WWPNotificationDefinitionId, H002J2_A72WWPNotificationDefinitionAppli, H002J2_A62WWPEntityId, H002J2_A71WWPNotificationDefinitionDescr
               }
               , new Object[] {
               H002J3_A65WWPNotificationDefinitionId, H002J3_A61WWPSubscriptionRoleId, H002J3_n61WWPSubscriptionRoleId, H002J3_A67WWPSubscriptionId
               }
            }
         );
         AV26Pgmname = "WWPBaseObjects.Subscriptions.WWP_SubscriptionsSettingsByRoleWC";
      ...
      private long[] H002J2_A65WWPNotificationDefinitionId ;
      private short[] H002J2_A72WWPNotificationDefinitionAppli ;
      private long[] H002J2_A62WWPEntityId ;
      private string[] H002J2_A71WWPNotificationDefinitionDescr ;
      private long[] H002J3_A65WWPNotificationDefinitionId ;
      private string[] H002J3_A61WWPSubscriptionRoleId ;
      private bool[] H002J3_n61WWPSubscriptionRoleId ;
      private long[] H002J3_A67WWPSubscriptionId ;
   ...
   public class wwp_subscriptionssettingsbyrolewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002J2", "SELECT WWPNotificationDefinitionId, WWPNotificationDefinitionAppli, WWPEntityId, WWPNotificationDefinitionDescr FROM WWP_NotificationDefinition WHERE (WWPEntityId = :AV13WWPEntityId) AND (WWPNotificationDefinitionAppli = 1) ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002J2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002J3", "SELECT WWPNotificationDefinitionId, WWPSubscriptionRoleId, WWPSubscriptionId FROM WWP_Subscription WHERE (WWPNotificationDefinitionId = :WWPNotificationDefinitionId) AND (WWPSubscriptionRoleId = ( :AV16WWPSubscriptionRoleId)) AND (:WWPNotificationDefinitionAppli = 1) ORDER BY WWPNotificationDefinitionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002J3,100, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
