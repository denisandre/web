...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   public class wwp_subscriptionspanel : GXWebComponent
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         A69WWPSubscriptionSubscribed = StringUtil.StrToBool( GetPar( "WWPSubscriptionSubscribed"));
         A61WWPSubscriptionRoleId = GetPar( "WWPSubscriptionRoleId");
         ...
         A68WWPSubscriptionEntityRecordId = GetPar( "WWPSubscriptionEntityRecordId");
         AV20WWPSubscriptionEntityRecordId = GetPar( "WWPSubscriptionEntityRecordId");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV5WWPEntityId, AV7WWPNotificationAppliesTo, AV26Pgmname, A49WWPUserExtendedId, AV29Udparg1, A69WWPSubscriptionSubscribed, A61WWPSubscriptionRoleId, AV23WWPSubscriptionRoleIdCollection, AV8WWPNotificationId, A68WWPSubscriptionEntityRecordId, AV20WWPSubscriptionEntityRecordId, A67WWPSubscriptionId, AV24WWPNotificationDefinitionId, sPrefix) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV26Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV26Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPUSEREXTENDEDID", StringUtil.RTrim( A49WWPUserExtendedId));
         GxWebStd.gx_hidden_field( context, sPrefix+"vUDPARG1", StringUtil.RTrim( AV29Udparg1));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vUDPARG1", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV29Udparg1, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONSUBSCRIBED", A69WWPSubscriptionSubscribed);
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONROLEID", StringUtil.RTrim( A61WWPSubscriptionRoleId));
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vWWPSUBSCRIPTIONROLEIDCOLLECTION", AV23WWPSubscriptionRoleIdCollection);
         }
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPNOTIFICATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8WWPNotificationId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWPNOTIFICATIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV8WWPNotificationId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONENTITYRECORDID", A68WWPSubscriptionEntityRecordId);
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPSUBSCRIPTIONENTITYRECORDID", AV20WWPSubscriptionEntityRecordId);
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPSUBSCRIPTIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A67WWPSubscriptionId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPNOTIFICATIONDEFINITIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24WWPNotificationDefinitionId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWPNOTIFICATIONDEFINITIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV24WWPNotificationDefinitionId), "ZZZZZZZZZ9"), context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONSECFU", A109WWPNotificationDefinitionSecFu);
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONISAUT", A110WWPNotificationDefinitionIsAut);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV29Udparg1 ,
                                       bool A69WWPSubscriptionSubscribed ,
                                       string A61WWPSubscriptionRoleId ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPNOTIFICATIONDEFINITIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A65WWPNotificationDefinitionId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"WWPNOTIFICATIONDEFINITIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A65WWPNotificationDefinitionId), 10, 0, ".", "")));
      }
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         {
            A73WWPNotificationDefinitionAllow = H002K2_A73WWPNotificationDefinitionAllow[0];
            A72WWPNotificationDefinitionAppli = H002K2_A72WWPNotificationDefinitionAppli[0];
            A62WWPEntityId = H002K2_A62WWPEntityId[0];
            A65WWPNotificationDefinitionId = H002K2_A65WWPNotificationDefinitionId[0];
            A71WWPNotificationDefinitionDescr = H002K2_A71WWPNotificationDefinitionDescr[0];
            A109WWPNotificationDefinitionSecFu = H002K2_A109WWPNotificationDefinitionSecFu[0];
            if ( String.IsNullOrEmpty(StringUtil.RTrim( A109WWPNotificationDefinitionSecFu)) )
            {
               A110WWPNotificationDefinitionIsAut = true;
               AssignAttri(sPrefix, false, "A110WWPNotificationDefinitionIsAut", A110WWPNotificationDefinitionIsAut);
            }
            else
            {
      ...
      protected void RF2K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A73WWPNotificationDefinitionAllow = H002K3_A73WWPNotificationDefinitionAllow[0];
               A72WWPNotificationDefinitionAppli = H002K3_A72WWPNotificationDefinitionAppli[0];
               A62WWPEntityId = H002K3_A62WWPEntityId[0];
               A65WWPNotificationDefinitionId = H002K3_A65WWPNotificationDefinitionId[0];
               A71WWPNotificationDefinitionDescr = H002K3_A71WWPNotificationDefinitionDescr[0];
               A109WWPNotificationDefinitionSecFu = H002K3_A109WWPNotificationDefinitionSecFu[0];
               if ( String.IsNullOrEmpty(StringUtil.RTrim( A109WWPNotificationDefinitionSecFu)) )
               {
                  A110WWPNotificationDefinitionIsAut = true;
                  AssignAttri(sPrefix, false, "A110WWPNotificationDefinitionIsAut", A110WWPNotificationDefinitionIsAut);
      ...
      protected void send_integrity_lvl_hashes2K2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPNOTIFICATIONDEFINITIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV24WWPNotificationDefinitionId), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWPNOTIFICATIONDEFINITIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV24WWPNotificationDefinitionId), "ZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_WWPNOTIFICATIONDEFINITIONID"+"_"+sGXsfl_9_idx, GetSecureSignedToken( sPrefix+sGXsfl_9_idx, context.localUtil.Format( (decimal)(A65WWPNotificationDefinitionId), "ZZZZZZZZZ9"), context));
      }
      ...
      protected void E122K2( )
      {
         ...
         {
            A63WWPEntityName = H002K4_A63WWPEntityName[0];
            A62WWPEntityId = H002K4_A62WWPEntityId[0];
            AV5WWPEntityId = A62WWPEntityId;
      ...
      private void E142K2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            /* Grid_Load Routine */
            returnInSub = false;
            AV8WWPNotificationId = A65WWPNotificationDefinitionId;
      ...
      protected void S122( )
      {
         ...
         {
            AV9GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV26Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV26Pgmname+"GridState",  AV9GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E112K2( )
      {
         ...
         AssignAttri(sPrefix, false, chkavIncludenotification_Internalname, AV12IncludeNotification);
         new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_userupdatesubscription(context ).execute(  AV12IncludeNotification, ref  AV22WWPSubscriptionId,  A65WWPNotificationDefinitionId,  AV20WWPSubscriptionEntityRecordId,  AV14RecordAttDescription) ;
         AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV22WWPSubscriptionId), 10, 0));
         if ( 1 == 0 )
         {
            /* Start For Each Line */
      ...
      protected void S142( )
      {
         ...
         {
            A68WWPSubscriptionEntityRecordId = H002K5_A68WWPSubscriptionEntityRecordId[0];
            A65WWPNotificationDefinitionId = H002K5_A65WWPNotificationDefinitionId[0];
            A61WWPSubscriptionRoleId = H002K5_A61WWPSubscriptionRoleId[0];
            n61WWPSubscriptionRoleId = H002K5_n61WWPSubscriptionRoleId[0];
            A69WWPSubscriptionSubscribed = H002K5_A69WWPSubscriptionSubscribed[0];
            A49WWPUserExtendedId = H002K5_A49WWPUserExtendedId[0];
            n49WWPUserExtendedId = H002K5_n49WWPUserExtendedId[0];
            A67WWPSubscriptionId = H002K5_A67WWPSubscriptionId[0];
            AV22WWPSubscriptionId = A67WWPSubscriptionId;
            AssignAttri(sPrefix, false, edtavWwpsubscriptionid_Internalname, StringUtil.LTrimStr( (decimal)(AV22WWPSubscriptionId), 10, 0));
            AV12IncludeNotification = true;
            AssignAttri(sPrefix, false, chkavIncludenotification_Internalname, AV12IncludeNotification);
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( A61WWPSubscriptionRoleId)) )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382812499", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/subscriptions/wwp_subscriptionspanel.js", "?202382812499", false, true);
         }
      ...
      protected void sendrow_92( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_9_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GridRow.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {(string)edtWWPNotificationDefinitionDescr_Internalname,(string)A71WWPNotificationDefinitionDescr,(string)"",(string)"",(short)0,(short)1,(short)0,(short)0,(short)80,(string)"chr",(short)3,(string)"row",(short)0,(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"200",(short)-1,(short)0,(string)"",(string)"",(short)-1,(bool)true,(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(short)0,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
      ...
      protected void StartGridControl9( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A71WWPNotificationDefinitionDescr));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A65WWPNotificationDefinitionId), 10, 0, ".", ""))));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV5WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV7WWPNotificationAppliesTo',fld:'vWWPNOTIFICATIONAPPLIESTO',pic:'9'},{av:'edtWWPNotificationDefinitionId_Visible',ctrl:'WWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'AV20WWPSubscriptionEntityRecordId',fld:'vWWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'AV23WWPSubscriptionRoleIdCollection',fld:'vWWPSUBSCRIPTIONROLEIDCOLLECTION',pic:'',hsh:true},{av:'AV8WWPNotificationId',fld:'vWWPNOTIFICATIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV24WWPNotificationDefinitionId',fld:'vWWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E142K2',iparms:[{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'AV23WWPSubscriptionRoleIdCollection',fld:'vWWPSUBSCRIPTIONROLEIDCOLLECTION',pic:'',hsh:true},{av:'AV8WWPNotificationId',fld:'vWWPNOTIFICATIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'AV20WWPSubscriptionEntityRecordId',fld:'vWWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'AV24WWPNotificationDefinitionId',fld:'vWWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("TABLESUBSCRIPTIONITEM.CLICK","{handler:'E112K2',iparms:[{av:'AV12IncludeNotification',fld:'vINCLUDENOTIFICATION',grid:9,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_9',ctrl:'GRID',grid:9,prop:'GridRC',grid:9},{av:'AV22WWPSubscriptionId',fld:'vWWPSUBSCRIPTIONID',grid:9,pic:'ZZZZZZZZZ9'},{av:'A65WWPNotificationDefinitionId',fld:'WWPNOTIFICATIONDEFINITIONID',grid:9,pic:'ZZZZZZZZZ9',hsh:true},{av:'AV20WWPSubscriptionEntityRecordId',fld:'vWWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'AV14RecordAttDescription',fld:'vRECORDATTDESCRIPTION',pic:''}]");
         ...
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV5WWPEntityId',fld:'vWWPENTITYID',pic:'ZZZZZZZZZ9'},{av:'AV7WWPNotificationAppliesTo',fld:'vWWPNOTIFICATIONAPPLIESTO',pic:'9'},{av:'edtWWPNotificationDefinitionId_Visible',ctrl:'WWPNOTIFICATIONDEFINITIONID',prop:'Visible'},{av:'edtavWwpsubscriptionid_Visible',ctrl:'vWWPSUBSCRIPTIONID',prop:'Visible'},{av:'A49WWPUserExtendedId',fld:'WWPUSEREXTENDEDID',pic:''},{av:'AV29Udparg1',fld:'vUDPARG1',pic:'',hsh:true},{av:'A69WWPSubscriptionSubscribed',fld:'WWPSUBSCRIPTIONSUBSCRIBED',pic:''},{av:'A61WWPSubscriptionRoleId',fld:'WWPSUBSCRIPTIONROLEID',pic:''},{av:'AV23WWPSubscriptionRoleIdCollection',fld:'vWWPSUBSCRIPTIONROLEIDCOLLECTION',pic:'',hsh:true},{av:'AV8WWPNotificationId',fld:'vWWPNOTIFICATIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A68WWPSubscriptionEntityRecordId',fld:'WWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'AV20WWPSubscriptionEntityRecordId',fld:'vWWPSUBSCRIPTIONENTITYRECORDID',pic:''},{av:'A67WWPSubscriptionId',fld:'WWPSUBSCRIPTIONID',pic:'ZZZZZZZZZ9'},{av:'AV24WWPNotificationDefinitionId',fld:'vWWPNOTIFICATIONDEFINITIONID',pic:'ZZZZZZZZZ9',hsh:true},{av:'sPrefix'},{av:'AV26Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H002K2_A73WWPNotificationDefinitionAllow = new bool[] {false} ;
         H002K2_A72WWPNotificationDefinitionAppli = new short[1] ;
         H002K2_A62WWPEntityId = new long[1] ;
         H002K2_A65WWPNotificationDefinitionId = new long[1] ;
         H002K2_A71WWPNotificationDefinitionDescr = new string[] {""} ;
         H002K2_A109WWPNotificationDefinitionSecFu = new string[] {""} ;
         H002K3_A73WWPNotificationDefinitionAllow = new bool[] {false} ;
         H002K3_A72WWPNotificationDefinitionAppli = new short[1] ;
         H002K3_A62WWPEntityId = new long[1] ;
         H002K3_A65WWPNotificationDefinitionId = new long[1] ;
         H002K3_A71WWPNotificationDefinitionDescr = new string[] {""} ;
         H002K3_A109WWPNotificationDefinitionSecFu = new string[] {""} ;
         H002K4_A63WWPEntityName = new string[] {""} ;
         H002K4_A62WWPEntityId = new long[1] ;
         A63WWPEntityName = "";
         ...
         H002K5_A68WWPSubscriptionEntityRecordId = new string[] {""} ;
         H002K5_A65WWPNotificationDefinitionId = new long[1] ;
         H002K5_A61WWPSubscriptionRoleId = new string[] {""} ;
         H002K5_n61WWPSubscriptionRoleId = new bool[] {false} ;
         H002K5_A69WWPSubscriptionSubscribed = new bool[] {false} ;
         H002K5_A49WWPUserExtendedId = new string[] {""} ;
         H002K5_n49WWPUserExtendedId = new bool[] {false} ;
         H002K5_A67WWPSubscriptionId = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_subscriptionspanel__default(),
            new Object[][] {
                new Object[] {
               H002K2_A73WWPNotificationDefinitionAllow, H002K2_A72WWPNotificationDefinitionAppli, H002K2_A62WWPEntityId, H002K2_A65WWPNotificationDefinitionId, H002K2_A71WWPNotificationDefinitionDescr, H002K2_A109WWPNotificationDefinitionSecFu
               }
               , new Object[] {
               H002K3_A73WWPNotificationDefinitionAllow, H002K3_A72WWPNotificationDefinitionAppli, H002K3_A62WWPEntityId, H002K3_A65WWPNotificationDefinitionId, H002K3_A71WWPNotificationDefinitionDescr, H002K3_A109WWPNotificationDefinitionSecFu
               }
               , new Object[] {
               H002K4_A63WWPEntityName, H002K4_A62WWPEntityId
               }
               , new Object[] {
               H002K5_A68WWPSubscriptionEntityRecordId, H002K5_A65WWPNotificationDefinitionId, H002K5_A61WWPSubscriptionRoleId, H002K5_n61WWPSubscriptionRoleId, H002K5_A69WWPSubscriptionSubscribed, H002K5_A49WWPUserExtendedId, H002K5_n49WWPUserExtendedId, H002K5_A67WWPSubscriptionId
               }
            }
         );
         AV26Pgmname = "WWPBaseObjects.Subscriptions.WWP_SubscriptionsPanel";
      ...
      private bool[] H002K2_A73WWPNotificationDefinitionAllow ;
      private short[] H002K2_A72WWPNotificationDefinitionAppli ;
      private long[] H002K2_A62WWPEntityId ;
      private long[] H002K2_A65WWPNotificationDefinitionId ;
      private string[] H002K2_A71WWPNotificationDefinitionDescr ;
      private string[] H002K2_A109WWPNotificationDefinitionSecFu ;
      private bool[] H002K3_A73WWPNotificationDefinitionAllow ;
      private short[] H002K3_A72WWPNotificationDefinitionAppli ;
      private long[] H002K3_A62WWPEntityId ;
      private long[] H002K3_A65WWPNotificationDefinitionId ;
      private string[] H002K3_A71WWPNotificationDefinitionDescr ;
      private string[] H002K3_A109WWPNotificationDefinitionSecFu ;
      private string[] H002K4_A63WWPEntityName ;
      private long[] H002K4_A62WWPEntityId ;
      private string[] H002K5_A68WWPSubscriptionEntityRecordId ;
      private long[] H002K5_A65WWPNotificationDefinitionId ;
      private string[] H002K5_A61WWPSubscriptionRoleId ;
      private bool[] H002K5_n61WWPSubscriptionRoleId ;
      private bool[] H002K5_A69WWPSubscriptionSubscribed ;
      private string[] H002K5_A49WWPUserExtendedId ;
      private bool[] H002K5_n49WWPUserExtendedId ;
      private long[] H002K5_A67WWPSubscriptionId ;
   ...
   public class wwp_subscriptionspanel__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 3 :
                     return conditional_H002K5(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (bool)dynConstraints[6] , (long)dynConstraints[7] , (long)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002K2", "SELECT WWPNotificationDefinitionAllow, WWPNotificationDefinitionAppli, WWPEntityId, WWPNotificationDefinitionId, WWPNotificationDefinitionDescr, WWPNotificationDefinitionSecFu FROM WWP_NotificationDefinition WHERE (WWPNotificationDefinitionAllow = TRUE) AND (WWPNotificationDefinitionAppli = :AV7WWPNotificationAppliesTo) AND (WWPEntityId = :AV5WWPEntityId) ORDER BY WWPNotificationDefinitionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K2,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002K3", "SELECT WWPNotificationDefinitionAllow, WWPNotificationDefinitionAppli, WWPEntityId, WWPNotificationDefinitionId, WWPNotificationDefinitionDescr, WWPNotificationDefinitionSecFu FROM WWP_NotificationDefinition WHERE (WWPNotificationDefinitionAllow = TRUE) AND (WWPNotificationDefinitionAppli = :AV7WWPNotificationAppliesTo) AND (WWPEntityId = :AV5WWPEntityId) ORDER BY WWPNotificationDefinitionId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002K4", "SELECT WWPEntityName, WWPEntityId FROM WWP_Entity WHERE LOWER(WWPEntityName) = ( LOWER(:AV6WWPEntityName)) ORDER BY WWPEntityId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K4,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H002K5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K5,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
