...
namespace GeneXus.Programs.wwpbaseobjects {
   public class gethomesampledataservice : GXWebProcedure
   {
      ...
      public override void webExecute( )
      {
         ...
         initialize();
         Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "agl_tresorygroup") ;
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.Method), "get") == 0 )
         {
            if ( StringUtil.StrCmp(StringUtil.Lower( GXSoapHTTPRequest.QueryString), "wsdl") == 0 )
            {
               ...
               GXSoapXMLWriter.WriteAttribute("soapAction", "agl_tresorygroupaction/"+"wwpbaseobjects.AGETHOMESAMPLEDATASERVICE.Execute");
         ...
         if ( ( StringUtil.StringSearch( currMethod+"&", "Execute&", 1) > 0 ) || ( currSoapErr != 0 ) )
         {
            ...
            if ( currSoapErr == 0 )
            {
               if ( Gxm2rootcol != null )
               {
                  Gxm2rootcol.writexmlcollection(GXSoapXMLWriter, "ReturnValue", "agl_tresorygroup", "HomeSampleDataItem", "agl_tresorygroup");
               }
            }
            else
            {
      ...
      {
         this.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "agl_tresorygroup") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem> aP0_Gxm2rootcol )
      {
         ...
         objgethomesampledataservice.Gxm2rootcol = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem>( context, "HomeSampleDataItem", "agl_tresorygroup") ;
      ...
      void executePrivate( )
      {
         ...
         {
            AV6HomeSampleDataItem = ((GeneXus.Programs.wwpbaseobjects.SdtHomeSampleData_HomeSampleDataItem)AV5HomeSampleData.Item(AV9GXV1));
