...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebNotification" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_WebNotification : GxSilentTrnSdt
   {
      ...
      public void Load( long AV89WWPWebNotificationId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV89WWPWebNotificationId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Web\WWP_WebNotification", Namespace = "agl_tresorygroup")]
