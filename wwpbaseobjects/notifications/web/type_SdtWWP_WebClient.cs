...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebClient" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_WebClient : GxSilentTrnSdt
   {
      ...
      public void Load( string AV90WWPWebClientId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV90WWPWebClientId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Web\WWP_WebClient", Namespace = "agl_tresorygroup")]
