...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_visualizeallnotifications : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV20Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "WWPNOTIFICATIONICON", A118WWPNotificationIcon);
         GxWebStd.gx_hidden_field( context, "WWPNOTIFICATIONCREATED", context.localUtil.TToC( A66WWPNotificationCreated, 10, 12, 0, 0, "/", ":", " "));
         GxWebStd.gx_boolean_hidden_field( context, "WWPNOTIFICATIONISREAD", A124WWPNotificationIsRead);
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_MANAGESUBSCRIPTIONS", AV15IsAuthorized_ManageSubscriptions);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_MANAGESUBSCRIPTIONS", GetSecureSignedToken( "", AV15IsAuthorized_ManageSubscriptions, context));
      ...
      protected void RF2H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A49WWPUserExtendedId = H002H2_A49WWPUserExtendedId[0];
               n49WWPUserExtendedId = H002H2_n49WWPUserExtendedId[0];
               A118WWPNotificationIcon = H002H2_A118WWPNotificationIcon[0];
               A124WWPNotificationIsRead = H002H2_A124WWPNotificationIsRead[0];
               A66WWPNotificationCreated = H002H2_A66WWPNotificationCreated[0];
               A102WWPNotificationMetadata = H002H2_A102WWPNotificationMetadata[0];
               n102WWPNotificationMetadata = H002H2_n102WWPNotificationMetadata[0];
               A121WWPNotificationLink = H002H2_A121WWPNotificationLink[0];
               A64WWPNotificationId = H002H2_A64WWPNotificationId[0];
               A120WWPNotificationShortDescriptio = H002H2_A120WWPNotificationShortDescriptio[0];
               A119WWPNotificationTitle = H002H2_A119WWPNotificationTitle[0];
               E152H2 ();
      ...
      private void E152H2( )
      {
         ...
         lblNotificationitemicon_Caption = StringUtil.Format( "<i class='%1 %2'></i>", "NotificationFontIcon", A118WWPNotificationIcon, "", "", "", "", "", "", "");
         AV18WWPNotificationCreated = A66WWPNotificationCreated;
         AssignAttri("", false, edtavWwpnotificationcreated_Internalname, context.localUtil.TToC( AV18WWPNotificationCreated, 8, 5, 0, 3, "/", ":", " "));
      ...
      protected void E162H2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wwpbaseobjects.notifications.common.wwp_visualizenotification.aspx"+UrlEncode(StringUtil.LTrimStr(A64WWPNotificationId,10,0));
      ...
      protected void E172H2( )
      {
         ...
         returnInSub = false;
         new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_changenotificationstatus(context ).gxep_setnotificationreadunreadbyid( ref  A64WWPNotificationId) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828211920", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_visualizeallnotifications.js", "?2023828211921", false, true);
         }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_24_idx - GRID_nFirstRecordOnPage <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "CardNotificationAttributeDescription";
            StyleString = "";
            GridRow.AddColumnProperties("html_textarea", 1, isAjaxCallMode( ), new Object[] {(string)edtWWPNotificationShortDescriptio_Internalname,(string)A120WWPNotificationShortDescriptio,(string)"",(string)"",(short)0,(short)1,(short)0,(short)0,(short)80,(string)"chr",(short)3,(string)"row",(short)0,(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"200",(short)-1,(short)0,(string)"",(string)"",(short)-1,(bool)true,(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(short)0,(string)""});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
            GridRow.AddColumnProperties("div_end", -1, isAjaxCallMode( ), new Object[] {(string)"start",(string)"top",(string)"div"});
      ...
      protected void StartGridControl24( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A119WWPNotificationTitle));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A120WWPNotificationShortDescriptio));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A64WWPNotificationId), 10, 0, ".", ""))));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A121WWPNotificationLink));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A102WWPNotificationMetadata));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E152H2',iparms:[{av:'A121WWPNotificationLink',fld:'WWPNOTIFICATIONLINK',pic:''},{av:'A118WWPNotificationIcon',fld:'WWPNOTIFICATIONICON',pic:''},{av:'A66WWPNotificationCreated',fld:'WWPNOTIFICATIONCREATED',pic:'99/99/9999 99:99:99.999'},{av:'A124WWPNotificationIsRead',fld:'WWPNOTIFICATIONISREAD',pic:''}]");
         ...
         setEventMetadata("'DOVISUALIZE'","{handler:'E162H2',iparms:[{av:'A64WWPNotificationId',fld:'WWPNOTIFICATIONID',pic:'ZZZZZZZZZ9'}]");
         setEventMetadata("'DOVISUALIZE'",",oparms:[{av:'A64WWPNotificationId',fld:'WWPNOTIFICATIONID',pic:'ZZZZZZZZZ9'}]}");
         setEventMetadata("'DOMARKASREAD'","{handler:'E172H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'edtWWPNotificationId_Visible',ctrl:'WWPNOTIFICATIONID',prop:'Visible'},{av:'edtWWPNotificationLink_Visible',ctrl:'WWPNOTIFICATIONLINK',prop:'Visible'},{av:'edtWWPNotificationMetadata_Visible',ctrl:'WWPNOTIFICATIONMETADATA',prop:'Visible'},{av:'AV15IsAuthorized_ManageSubscriptions',fld:'vISAUTHORIZED_MANAGESUBSCRIPTIONS',pic:'',hsh:true},{av:'A64WWPNotificationId',fld:'WWPNOTIFICATIONID',pic:'ZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'DOMANAGESUBSCRIPTIONS'","{handler:'E122H2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV20Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'edtWWPNotificationId_Visible',ctrl:'WWPNOTIFICATIONID',prop:'Visible'},{av:'edtWWPNotificationLink_Visible',ctrl:'WWPNOTIFICATIONLINK',prop:'Visible'},{av:'edtWWPNotificationMetadata_Visible',ctrl:'WWPNOTIFICATIONMETADATA',prop:'Visible'},{av:'AV15IsAuthorized_ManageSubscriptions',fld:'vISAUTHORIZED_MANAGESUBSCRIPTIONS',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         AV19Udparg1 = "";
         H002H2_A49WWPUserExtendedId = new string[] {""} ;
         H002H2_n49WWPUserExtendedId = new bool[] {false} ;
         H002H2_A118WWPNotificationIcon = new string[] {""} ;
         H002H2_A124WWPNotificationIsRead = new bool[] {false} ;
         H002H2_A66WWPNotificationCreated = new DateTime[] {DateTime.MinValue} ;
         H002H2_A102WWPNotificationMetadata = new string[] {""} ;
         H002H2_n102WWPNotificationMetadata = new bool[] {false} ;
         H002H2_A121WWPNotificationLink = new string[] {""} ;
         H002H2_A64WWPNotificationId = new long[1] ;
         H002H2_A120WWPNotificationShortDescriptio = new string[] {""} ;
         H002H2_A119WWPNotificationTitle = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.notifications.common.wwp_visualizeallnotifications__default(),
            new Object[][] {
                new Object[] {
               H002H2_A49WWPUserExtendedId, H002H2_n49WWPUserExtendedId, H002H2_A118WWPNotificationIcon, H002H2_A124WWPNotificationIsRead, H002H2_A66WWPNotificationCreated, H002H2_A102WWPNotificationMetadata, H002H2_n102WWPNotificationMetadata, H002H2_A121WWPNotificationLink, H002H2_A64WWPNotificationId, H002H2_A120WWPNotificationShortDescriptio,
               H002H2_A119WWPNotificationTitle
               }
               , new Object[] {
      ...
      private string[] H002H2_A49WWPUserExtendedId ;
      private bool[] H002H2_n49WWPUserExtendedId ;
      private string[] H002H2_A118WWPNotificationIcon ;
      private bool[] H002H2_A124WWPNotificationIsRead ;
      private DateTime[] H002H2_A66WWPNotificationCreated ;
      private string[] H002H2_A102WWPNotificationMetadata ;
      private bool[] H002H2_n102WWPNotificationMetadata ;
      private string[] H002H2_A121WWPNotificationLink ;
      private long[] H002H2_A64WWPNotificationId ;
      private string[] H002H2_A120WWPNotificationShortDescriptio ;
      private string[] H002H2_A119WWPNotificationTitle ;
   ...
   public class wwp_visualizeallnotifications__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002H2", "SELECT WWPUserExtendedId, WWPNotificationIcon, WWPNotificationIsRead, WWPNotificationCreated, WWPNotificationMetadata, WWPNotificationLink, WWPNotificationId, WWPNotificationShortDescriptio, WWPNotificationTitle FROM WWP_Notification WHERE WWPUserExtendedId = ( :AV19Udparg1) ORDER BY WWPNotificationCreated DESC, WWPNotificationId  OFFSET :GXPagingFrom2 LIMIT CASE WHEN :GXPagingTo2 > 0 THEN :GXPagingTo2 ELSE 1e9 END",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002H2,51, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002H3", "SELECT COUNT(*) FROM WWP_Notification WHERE WWPUserExtendedId = ( :AV19Udparg1) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002H3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
