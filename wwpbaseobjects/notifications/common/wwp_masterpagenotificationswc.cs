...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   public class wwp_masterpagenotificationswc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382894090", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/notifications/common/wwp_masterpagenotificationswc.js", "?202382894090", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDSDTNOTIFICATIONSDATAS.LOAD","{handler:'E152L2',iparms:[{av:'AV6SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDSDTNOTIFICATIONSDATAS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDSDTNOTIFICATIONSDATAS',prop:'GridRC',grid:15}]");
         ...
         setEventMetadata("'DOCHECKALLNOTIF'","{handler:'E112L2',iparms:[{av:'GRIDSDTNOTIFICATIONSDATAS_nFirstRecordOnPage'},{av:'GRIDSDTNOTIFICATIONSDATAS_nEOF'},{av:'AV6SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'nRC_GXsfl_15',ctrl:'GRIDSDTNOTIFICATIONSDATAS',prop:'GridRC',grid:15},{av:'AV5IsAuthorized_CheckAllNotif',fld:'vISAUTHORIZED_CHECKALLNOTIF',pic:'',hsh:true},{av:'sPrefix'}]");
         ...
         setEventMetadata("NOTIFICATIONITEM.CLICK","{handler:'E122L2',iparms:[{av:'AV6SDTNotificationsData',fld:'vSDTNOTIFICATIONSDATA',grid:15,pic:''},{av:'nGXsfl_15_idx', ctrl: 'GRID', prop:'GridCurrRow', grid:15},{av:'GRIDSDTNOTIFICATIONSDATAS_nFirstRecordOnPage'},{av:'nRC_GXsfl_15',ctrl:'GRIDSDTNOTIFICATIONSDATAS',prop:'GridRC',grid:15},{av:'GRIDSDTNOTIFICATIONSDATAS_nEOF'},{av:'sPrefix'},{av:'AV5IsAuthorized_CheckAllNotif',fld:'vISAUTHORIZED_CHECKALLNOTIF',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV6SDTNotificationsData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem>( context, "WWP_SDTNotificationsDataItem", "agl_tresorygroup");
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXKey = "";
         ...
         EvtRowId = "";
         sEvtType = "";
         GXt_objcol_SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem1 = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_SDTNotificationsData_WWP_SDTNotificationsDataItem>( context, "WWP_SDTNotificationsDataItem", "agl_tresorygroup");
