...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_Notification" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_Notification : GxSilentTrnSdt
   {
      ...
      public void Load( long AV64WWPNotificationId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV64WWPNotificationId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Common\WWP_Notification", Namespace = "agl_tresorygroup")]
