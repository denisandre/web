...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_NotificationDefinition" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_NotificationDefinition : GxSilentTrnSdt
   {
      ...
      public void Load( long AV65WWPNotificationDefinitionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV65WWPNotificationDefinitionId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Common\WWP_NotificationDefinition", Namespace = "agl_tresorygroup")]
