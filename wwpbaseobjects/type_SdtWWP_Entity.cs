...
namespace GeneXus.Programs.wwpbaseobjects {
   ...
   [XmlType(TypeName =  "WWP_Entity" , Namespace = "agl_tresorygroup" )]
   [Serializable]
   public class SdtWWP_Entity : GxSilentTrnSdt
   {
      ...
      public void Load( long AV62WWPEntityId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV62WWPEntityId});
         return  ;
      }
   ...
   [DataContract(Name = @"WWPBaseObjects\WWP_Entity", Namespace = "agl_tresorygroup")]
