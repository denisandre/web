...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="AuditingObject.RecordItem.AttributeItem" , Namespace="agl_tresorygroup" )]
	[Serializable]
	...
	[DataContract(Name=@"AuditingObject.RecordItem.AttributeItem", Namespace="agl_tresorygroup")]
