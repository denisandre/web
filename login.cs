...
namespace GeneXus.Programs {
   public class login : GXDataArea
   {
      ...
      protected void gxnrGridauthtypes_newrow_invoke( )
      {
         ...
         AssignProp("", false, cmbavTypeauthtype_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(cmbavTypeauthtype.Visible), 5, 0), !bGXsfl_62_Refreshing);
         edtavNameauthtype_Visible = (int)(Math.Round(NumberUtil.Val( GetNextPar( ), "."), 18, MidpointRounding.ToEven));
         AssignProp("", false, edtavNameauthtype_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavNameauthtype_Visible), 5, 0), !bGXsfl_62_Refreshing);
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal FormBackgroundImage\" data-gx-class=\"form-horizontal FormBackgroundImage\" novalidate action=\""+formatLink("login.aspx") +"\">") ;
      ...
      protected void WB0E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "ImageTop" + " " + ((StringUtil.StrCmp(imgLogologin_gximage, "")==0) ? "GX_Image_core_TresoryLogo01_Claro_Class" : "GX_Image_"+imgLogologin_gximage+"_Class");
            StyleString = "";
            sImgUrl = (string)(context.GetImagePath( "5eb76d30-0bf6-4964-94b2-79b45e2981b9", "", context.GetTheme( )));
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavLogonto, cmbavLogonto_Internalname, StringUtil.RTrim( AV25LogOnTo), 1, cmbavLogonto_Jsonclick, 5, "'"+""+"'"+",false,"+"'"+"EVLOGONTO.CLICK."+"'", "svchar", "", cmbavLogonto.Visible, cmbavLogonto.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeLoginImageLeft", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,22);\"", "", true, 0, "HLP_Login.htm");
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavKeepmeloggedin_Internalname, StringUtil.BoolToStr( AV22KeepMeLoggedIn), "", "Keep Me Logged In", chkavKeepmeloggedin.Visible, chkavKeepmeloggedin.Enabled, "true", "Mantenha-me conectado", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(40, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,40);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavRememberme_Internalname, StringUtil.BoolToStr( AV27RememberMe), "", "Remember Me", chkavRememberme.Visible, chkavRememberme.Enabled, "true", "Lembrar-me", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(44, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,44);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(62), 2, 0)+","+"null"+");", bttBtnenter_Caption, bttBtnenter_Jsonclick, 5, "Confirmar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 DataContentCellLogin CellPaddingLogin", "start", "top", "", "", "div");
            wb_table1_50_0E2( true) ;
         }
         else
         {
            wb_table1_50_0E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_50_0E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 62 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUrl_Internalname, AV30URL, StringUtil.RTrim( context.localUtil.Format( AV30URL, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavUrl_Jsonclick, 0, "Attribute", "", "", "", "", edtavUrl_Visible, 1, 0, "text", "", 0, "px", 1, "row", 2048, 0, 0, 0, 0, -1, 0, true, "GeneXusSecurityCommon\\GAMURL", "start", true, "", "HLP_Login.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 20), "VIMAGEAUTHTYPE.CLICK") == 0 ) )
                           {
                              ...
                              AV17ImageAuthType = cgiGet( edtavImageauthtype_Internalname);
                              AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)) ? AV49Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV17ImageAuthType))), !bGXsfl_62_Refreshing);
                              AssignProp("", false, edtavImageauthtype_Internalname, "SrcSet", context.GetImageSrcSet( AV17ImageAuthType), true);
      ...
      protected void gxnrGridauthtypes_newrow( )
      {
         ...
         {
            sendrow_622( ) ;
            nGXsfl_62_idx = ((subGridauthtypes_Islastpage==1)&&(nGXsfl_62_idx+1>subGridauthtypes_fnc_Recordsperpage( )) ? 1 : nGXsfl_62_idx+1);
            sGXsfl_62_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_62_idx), 4, 0), 4, "0");
            SubsflControlProps_622( ) ;
         }
      ...
      protected void E140E2( )
      {
         ...
         else
         {
            if ( ! AV18isConnectionOK )
            {
               ...
               {
                  AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryguid(AV28RepositoryGUID, out  AV36Errors);
                  AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
               }
               else
               {
                  ...
                  {
                     AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnection(((GeneXus.Programs.genexussecurity.SdtGAMConnectionInfo)AV9ConnectionInfoCollection.Item(1)).gxTpr_Name, out  AV36Errors);
                     AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
                  }
               }
            }
         }
         tblTablenoaccount_Visible = 0;
         AssignProp("", false, tblTablenoaccount_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(tblTablenoaccount_Visible), 5, 0), true);
      ...
      private void E150E2( )
      {
         ...
         returnInSub = false;
         AV48GXV1 = 1;
         while ( AV48GXV1 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV48GXV1));
            if ( ! AV6AuthenticationType.gxTpr_Needusername )
            {
               ...
               {
                  AV17ImageAuthType = context.GetImagePath( AV6AuthenticationType.gxTpr_Smallimagename, "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV17ImageAuthType);
                  AV49Imageauthtype_GXI = GXDbFile.PathToUrl( AV6AuthenticationType.gxTpr_Smallimagename);
               }
               else
               {
                  edtavImageauthtype_gximage = "GAM_GAMButtonGAMRemoteSmall";
                  AV17ImageAuthType = context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV17ImageAuthType);
                  AV49Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )));
               }
               ...
               {
                  DoAjaxLoad(62, GridauthtypesRow);
               }
            }
      ...
      protected void E110E2( )
      {
         ...
         AV24LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV31UserName, AV32UserPassword, AV5AdditionalParameter, out  AV36Errors);
         if ( AV24LoginOK )
         {
         ...
         {
            if ( AV36Errors.Count > 0 )
            {
               if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(1)).gxTpr_Code == 24 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(1)).gxTpr_Code == 23 ) )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
                  {
                     gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "gamchangepassword.aspx"+UrlEncode(StringUtil.RTrim(AV16IDP_State));
                  CallWebObject(formatLink("gamchangepassword.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
                  context.wjLocDisableFrm = 1;
               }
               else if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(1)).gxTpr_Code == 161 )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
                  {
                     gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "gamupdateregisteruser.aspx"+UrlEncode(StringUtil.RTrim(AV16IDP_State));
                  CallWebObject(formatLink("gamupdateregisteruser.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
                  context.wjLocDisableFrm = 1;
               }
               else if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(1)).gxTpr_Code == 400 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(1)).gxTpr_Code == 410 ) )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
                  {
                     gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "gamotpauthentication.aspx"+UrlEncode(StringUtil.RTrim(AV16IDP_State));
      ...
      protected void E160E2( )
      {
         ...
         /* Refresh Routine */
         returnInSub = false;
         AV38isRedirect = false;
         AV37ErrorsLogin = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
         if ( AV37ErrorsLogin.Count > 0 )
         {
            if ( ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV37ErrorsLogin.Item(1)).gxTpr_Code == 1 ) || ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV37ErrorsLogin.Item(1)).gxTpr_Code == 104 ) )
            {
            }
            else
            {
         ...
         if ( ! AV38isRedirect )
         {
            AV42SessionValid = new GeneXus.Programs.genexussecurity.SdtGAMSession(context).isvalid(out  AV41Session, out  AV36Errors);
            if ( AV42SessionValid && ! AV41Session.gxTpr_Isanonymous )
            {
               AV30URL = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrorsurl();
               AssignAttri("", false, "AV30URL", AV30URL);
               if ( String.IsNullOrEmpty(StringUtil.RTrim( AV30URL)) )
               {
                  AV45GAMApplicationCollection = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV46GAMApplicationFilter, out  AV36Errors);
                  AV50GXV2 = 1;
                  while ( AV50GXV2 <= AV45GAMApplicationCollection.Count )
                  {
                     AV47GAMApplication = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV45GAMApplicationCollection.Item(AV50GXV2));
                     if ( StringUtil.StrCmp(AV47GAMApplication.gxTpr_Guid, "8d9934db-05db-4d64-adba-5e0466c3appU") != 0 )
                     {
                        if (true) break;
                     }
                     AV50GXV2 = (int)(AV50GXV2+1);
                  }
                  AV47GAMApplication = AV47GAMApplication.get();
                  if ( StringUtil.StrCmp(AV47GAMApplication.gxTpr_Homeobject, "") != 0 )
                  {
                     new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).applicationgohome(AV47GAMApplication.gxTpr_Guid) ;
                  }
                  else
                  {
                     CallWebObject(formatLink("home.aspx") );
            ...
            else
            {
               ...
               AV7AuthenticationTypes = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getenabledauthenticationtypes(AV23Language, out  AV36Errors);
               AV51GXV3 = 1;
               while ( AV51GXV3 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV51GXV3));
                  if ( AV6AuthenticationType.gxTpr_Needusername )
                  {
               ...
               AV20isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getrememberlogin(out  AV25LogOnTo, out  AV8AuxUserName, out  AV33UserRememberMe, out  AV36Errors);
               ...
               AV40Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).get();
               if ( cmbavLogonto.ItemCount > 1 )
               {
                  AV25LogOnTo = AV40Repository.gxTpr_Defaultauthenticationtypename;
                  AssignAttri("", false, "AV25LogOnTo", AV25LogOnTo);
               }
               ...
               if (returnInSub) return;
               AV52GXV4 = 1;
               while ( AV52GXV4 <= AV7AuthenticationTypes.Count )
               {
                  AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV52GXV4));
         ...
         AssignProp("", false, cmbavLogonto_Internalname, "Values", cmbavLogonto.ToJavascriptSource(), true);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV6AuthenticationType", AV6AuthenticationType);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV40Repository", AV40Repository);
      }
      ...
      protected void E120E2( )
      {
         ...
         AV19isModeOTP = false;
         AV53GXV5 = 1;
         while ( AV53GXV5 <= AV7AuthenticationTypes.Count )
         {
            AV6AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV7AuthenticationTypes.Item(AV53GXV5));
            if ( StringUtil.StrCmp(AV6AuthenticationType.gxTpr_Name, AV25LogOnTo) == 0 )
            {
               /* Execute user subroutine: 'VALIDLOGONTOOTP' */
               S152 ();
      ...
      protected void E130E2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "gamrecoverpasswordstep1.aspx"+UrlEncode(StringUtil.RTrim(AV16IDP_State));
      ...
      protected void S112( )
      {
         ...
         {
            AV18isConnectionOK = new GeneXus.Programs.genexussecurity.SdtGAM(context).setconnectionbyrepositoryid(AV13GAMRepository.gxTpr_Authenticationmasterrepositoryid, out  AV36Errors);
            AssignAttri("", false, "AV18isConnectionOK", AV18isConnectionOK);
         }
         if ( ! AV18isConnectionOK )
         {
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV40Repository.gxTpr_Userremembermetype, "Login") == 0 )
         {
            chkavKeepmeloggedin.Visible = 0;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
         ...
         else if ( StringUtil.StrCmp(AV40Repository.gxTpr_Userremembermetype, "Auth") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 0;
         ...
         else if ( StringUtil.StrCmp(AV40Repository.gxTpr_Userremembermetype, "Both") == 0 )
         {
            chkavKeepmeloggedin.Visible = 1;
            AssignProp("", false, chkavKeepmeloggedin_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavKeepmeloggedin.Visible), 5, 0), true);
            chkavRememberme.Visible = 1;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV54GXV6 = 1;
         while ( AV54GXV6 <= AV36Errors.Count )
         {
            AV35Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV36Errors.Item(AV54GXV6));
            if ( AV35Error.gxTpr_Code != 13 )
            {
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV35Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV35Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
            }
            AV54GXV6 = (int)(AV54GXV6+1);
         }
      }

      protected void wb_table1_50_0E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            if ( tblTablenoaccount_Visible == 0 )
            {
               sStyleString += "display:none;";
            }
            GxWebStd.gx_table_start( context, tblTablenoaccount_Internalname, tblTablenoaccount_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_50_0E2e( true) ;
         }
         else
         {
            wb_table1_50_0E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828181373", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("login.js", "?2023828181376", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      {
         edtavImageauthtype_Internalname = "vIMAGEAUTHTYPE_"+sGXsfl_62_idx;
         cmbavTypeauthtype_Internalname = "vTYPEAUTHTYPE_"+sGXsfl_62_idx;
         edtavNameauthtype_Internalname = "vNAMEAUTHTYPE_"+sGXsfl_62_idx;
      }

      protected void SubsflControlProps_fel_622( )
      {
         edtavImageauthtype_Internalname = "vIMAGEAUTHTYPE_"+sGXsfl_62_fel_idx;
         cmbavTypeauthtype_Internalname = "vTYPEAUTHTYPE_"+sGXsfl_62_fel_idx;
      ...
      protected void sendrow_622( )
      {
         ...
         /* Table start */
         GridauthtypesRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblUnnamedtablefsgridauthtypes_Internalname+"_"+sGXsfl_62_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
         ...
         TempTags = " " + ((edtavImageauthtype_Enabled!=0)&&(edtavImageauthtype_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 67,'',false,'',62)\"" : " ");
         ClassString = "AttributeImage30" + " " + ((StringUtil.StrCmp(edtavImageauthtype_gximage, "")==0) ? "" : "GX_Image_"+edtavImageauthtype_gximage+"_Class");
         StyleString = "";
         AV17ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV49Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV17ImageAuthType)) ? AV49Imageauthtype_GXI : context.PathToRelativeUrl( AV17ImageAuthType));
         GridauthtypesRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtavImageauthtype_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)1,(short)1,(string)"",(string)edtavImageauthtype_Tooltiptext,(short)0,(short)-1,(short)0,(string)"",(short)0,(string)"",(short)0,(short)0,(short)5,(string)edtavImageauthtype_Jsonclick,"'"+""+"'"+",false,"+"'"+"EVIMAGEAUTHTYPE.CLICK."+sGXsfl_62_idx+"'",(string)StyleString,(string)ClassString,(string)"",(string)"",(string)"",(string)"",(string)""+TempTags,(string)"",(string)"",(short)1,(bool)AV17ImageAuthType_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         ...
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         /* Table start */
         GridauthtypesRow.AddColumnProperties("table", -1, isAjaxCallMode( ), new Object[] {(string)tblUnnamedtablecontentfsgridauthtypes_Internalname+"_"+sGXsfl_62_idx,(short)1,(string)"Table",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(short)2,(string)"",(string)"",(string)"",(string)"px",(string)"px",(string)""});
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         GridauthtypesRow.AddColumnProperties("row", -1, isAjaxCallMode( ), new Object[] {(string)"",(string)"",(string)""});
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         GridauthtypesRow.AddRenderProperties(GridauthtypesColumn);
         TempTags = " " + ((cmbavTypeauthtype.Enabled!=0)&&(cmbavTypeauthtype.Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 74,'',false,'"+sGXsfl_62_idx+"',62)\"" : " ");
         if ( ( cmbavTypeauthtype.ItemCount == 0 ) && isAjaxCallMode( ) )
         {
            GXCCtl = "vTYPEAUTHTYPE_" + sGXsfl_62_idx;
      ...
      protected void StartGridControl62( )
      {
         if ( GridauthtypesContainer.GetWrapped() == 1 )
         {
            context.WriteHtmlText( "<div id=\""+"GridauthtypesContainer"+"DivS\" data-gxgridid=\"62\">") ;
            sStyleString = "";
            if ( subGridauthtypes_Visible == 0 )
            {
               sStyleString += "display:none;";
         ...
         else
         {
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", context.convertURL( AV17ImageAuthType));
            ...
            GridauthtypesContainer.AddColumnProperties(GridauthtypesColumn);
            GridauthtypesColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridauthtypesColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV29TypeAuthType)));
      ...
      protected void init_default_properties( )
      {
         ...
         tblTablenoaccount_Internalname = "TABLENOACCOUNT";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDAUTHTYPES_nFirstRecordOnPage'},{av:'GRIDAUTHTYPES_nEOF'},{av:'cmbavTypeauthtype'},{av:'edtavNameauthtype_Visible',ctrl:'vNAMEAUTHTYPE',prop:'Visible'},{av:'AV22KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV27RememberMe',fld:'vREMEMBERME',pic:''},{av:'AV23Language',fld:'vLANGUAGE',pic:'',hsh:true},{av:'AV8AuxUserName',fld:'vAUXUSERNAME',pic:'',hsh:true},{av:'AV33UserRememberMe',fld:'vUSERREMEMBERME',pic:'Z9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV30URL',fld:'vURL',pic:''},{av:'cmbavLogonto'},{av:'AV25LogOnTo',fld:'vLOGONTO',pic:''},{av:'subGridauthtypes_Visible',ctrl:'GRIDAUTHTYPES',prop:'Visible'},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV27RememberMe',fld:'vREMEMBERME',pic:''},{av:'chkavKeepmeloggedin.Visible',ctrl:'vKEEPMELOGGEDIN',prop:'Visible'},{av:'chkavRememberme.Visible',ctrl:'vREMEMBERME',prop:'Visible'},{av:'edtavUserpassword_Visible',ctrl:'vUSERPASSWORD',prop:'Visible'},{ctrl:'BTNENTER',prop:'Caption'},{av:'lblForgotpassword_Visible',ctrl:'FORGOTPASSWORD',prop:'Visible'}]}");
         setEventMetadata("GRIDAUTHTYPES.LOAD","{handler:'E150E2',iparms:[{av:'divTablebuttons_Visible',ctrl:'TABLEBUTTONS',prop:'Visible'}]");
         setEventMetadata("GRIDAUTHTYPES.LOAD",",oparms:[{av:'AV17ImageAuthType',fld:'vIMAGEAUTHTYPE',pic:''},{av:'cmbavTypeauthtype'},{av:'AV29TypeAuthType',fld:'vTYPEAUTHTYPE',pic:''},{av:'AV26NameAuthType',fld:'vNAMEAUTHTYPE',pic:''},{av:'edtavImageauthtype_Tooltiptext',ctrl:'vIMAGEAUTHTYPE',prop:'Tooltiptext'},{av:'divTablebuttons_Visible',ctrl:'TABLEBUTTONS',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E110E2',iparms:[{av:'AV22KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV27RememberMe',fld:'vREMEMBERME',pic:''},{av:'cmbavLogonto'},{av:'AV25LogOnTo',fld:'vLOGONTO',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV30URL',fld:'vURL',pic:''},{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]}");
         setEventMetadata("VIMAGEAUTHTYPE.CLICK","{handler:'E170E2',iparms:[{av:'AV26NameAuthType',fld:'vNAMEAUTHTYPE',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]");
         setEventMetadata("VIMAGEAUTHTYPE.CLICK",",oparms:[]}");
         setEventMetadata("VLOGONTO.CLICK","{handler:'E120E2',iparms:[{av:'AV23Language',fld:'vLANGUAGE',pic:'',hsh:true},{av:'cmbavLogonto'},{av:'AV25LogOnTo',fld:'vLOGONTO',pic:''}]");
         ...
         setEventMetadata("FORGOTPASSWORD.CLICK","{handler:'E130E2',iparms:[{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("FORGOTPASSWORD.CLICK",",oparms:[{av:'AV16IDP_State',fld:'vIDP_STATE',pic:''}]}");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","{handler:'E180E2',iparms:[{av:'AV26NameAuthType',fld:'vNAMEAUTHTYPE',pic:''},{av:'AV31UserName',fld:'vUSERNAME',pic:''},{av:'AV32UserPassword',fld:'vUSERPASSWORD',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV45GAMApplicationCollection = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
         AV46GAMApplicationFilter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter(context);
         AV47GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMApplication(context);
      ...
      private int tblTablenoaccount_Visible ;
      ...
      private string tblTablenoaccount_Internalname ;
      ...
      private bool AV38isRedirect ;
      private bool AV42SessionValid ;
      private bool AV20isOK ;
      private bool AV19isModeOTP ;
      private bool AV17ImageAuthType_IsBlob ;
      private string AV8AuxUserName ;
      private string AV25LogOnTo ;
      private string AV31UserName ;
      private string AV30URL ;
      private string AV49Imageauthtype_GXI ;
      private string AV17ImageAuthType ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV37ErrorsLogin ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV45GAMApplicationCollection ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMError AV35Error ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV40Repository ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV13GAMRepository ;
      private GeneXus.Programs.genexussecurity.SdtGAMSession AV41Session ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplication AV47GAMApplication ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV46GAMApplicationFilter ;
   }
