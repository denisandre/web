...
namespace GeneXus.Programs {
   public class gamwwusers : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV80ManageFiltersExecutionStep, AV18ColumnsSelector, AV109Pgmname, AV41FilUserGender, AV36FilAutType, AV92Search, AV37FilRol, AV42FirstIndex, AV70IsAuthorized_Display, AV75IsAuthorized_Update, AV66IsAuthorized_BtnRole, AV65IsAuthorized_BtnPermissions, AV67IsAuthorized_BtnSetPwd, AV63IsAuthorized_Authenticator, AV74IsAuthorized_UDelete, AV73IsAuthorized_Name, AV71IsAuthorized_Email, AV72IsAuthorized_Insert) ;
      ...
      protected void WB1X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(55), 2, 0)+","+"null"+");", "Incluir", bttBtninsert_Jsonclick, 5, "Incluir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWUsers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(55), 2, 0)+","+"null"+");", "Selecionar colunas", bttBtneditcolumns_Jsonclick, 0, "Selecionar colunas", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWUsers.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_24_1X2( true) ;
         }
         else
         {
            wb_table1_24_1X2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_1X2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      {
         /* GeneXus formulas. */
         AV109Pgmname = "GAMWWUsers";
         edtavDisplay_Enabled = 0;
         AssignProp("", false, edtavDisplay_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDisplay_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavUpdate_Enabled = 0;
         AssignProp("", false, edtavUpdate_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavUpdate_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavBtnrole_Enabled = 0;
         AssignProp("", false, edtavBtnrole_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavBtnrole_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavName_Enabled = 0;
         ...
         AssignProp("", false, edtavEmail_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavEmail_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavFirstname_Enabled = 0;
         AssignProp("", false, edtavFirstname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavFirstname_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavLastname_Enabled = 0;
         AssignProp("", false, edtavLastname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavLastname_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavAuthenticationtypename_Enabled = 0;
         AssignProp("", false, edtavAuthenticationtypename_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavAuthenticationtypename_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavGuid_Enabled = 0;
         AssignProp("", false, edtavGuid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavGuid_Enabled), 5, 0), !bGXsfl_55_Refreshing);
         edtavStatus_Enabled = 0;
         AssignProp("", false, edtavStatus_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavStatus_Enabled), 5, 0), !bGXsfl_55_Refreshing);
      }
      ...
      protected void E161X2( )
      {
         ...
         AV107GXV1 = 1;
         while ( AV107GXV1 <= AV10AuthenticationTypes.Count )
         {
            AV8AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationType)AV10AuthenticationTypes.Item(AV107GXV1));
         ...
         AV108GXV2 = 1;
         while ( AV108GXV2 <= AV91Roles.Count )
         {
            AV90Role = ((GeneXus.Programs.genexussecurity.SdtGAMRole)AV91Roles.Item(AV108GXV2));
      ...
      protected void E171X2( )
      {
         ...
         edtavName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavName_Visible), 5, 0), !bGXsfl_55_Refreshing);
         edtavEmail_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(2)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtavEmail_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavEmail_Visible), 5, 0), !bGXsfl_55_Refreshing);
         edtavFirstname_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(3)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavLastname_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(4)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavAuthenticationtypename_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(5)).gxTpr_Isvisible ? 1 : 0);
         ...
         edtavStatus_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV18ColumnsSelector.gxTpr_Columns.Item(6)).gxTpr_Isvisible ? 1 : 0);
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV109Pgmname, out  GXt_char3) ;
      ...
      private void E181X2( )
      {
         ...
         AV110GXV3 = 1;
         while ( AV110GXV3 <= AV47GAMUsers.Count )
         {
            AV101User = ((GeneXus.Programs.genexussecurity.SdtGAMUser)AV47GAMUsers.Item(AV110GXV3));
            ...
            if ( AV70IsAuthorized_Display )
            {
               ...
               GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
               GXEncryptionTmp = "gamuserentry.aspx"+UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
            ...
            if ( AV75IsAuthorized_Update )
            {
               if ( ! ( StringUtil.StrCmp(StringUtil.Trim( AV101User.gxTpr_Guid), StringUtil.Trim( AV89Repository.gxTpr_Anonymoususerguid)) == 0 ) && ! AV101User.gxTpr_Isautoregistereduser )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "gamuserentry.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
            ...
            if ( AV66IsAuthorized_BtnRole )
            {
               if ( ! ( StringUtil.StrCmp(StringUtil.Trim( AV101User.gxTpr_Guid), StringUtil.Trim( AV89Repository.gxTpr_Anonymoususerguid)) == 0 ) && ! AV101User.gxTpr_Isautoregistereduser )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  GXEncryptionTmp = "gamwwuserroles.aspx"+UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
            ...
            if ( AV65IsAuthorized_BtnPermissions )
            {
               if ( ! ( StringUtil.StrCmp(StringUtil.Trim( AV101User.gxTpr_Guid), StringUtil.Trim( AV89Repository.gxTpr_Anonymoususerguid)) == 0 ) && ! AV101User.gxTpr_Isautoregistereduser )
               {
                  cmbavGridactiongroup1.addItem("1", "Editar permissões", 0);
               }
            }
            if ( ! AV105GAMUser.gxTpr_Isactive && AV89Repository.gxTpr_Email.gxTpr_Sendemailwhenuseractivateaccount )
            {
               cmbavGridactiongroup1.addItem("2", "Envie e-mail de ativação", 0);
            }
            if ( AV67IsAuthorized_BtnSetPwd )
            {
               ...
               {
                  cmbavGridactiongroup1.addItem("3", "Alterar sua senha", 0);
               }
            }
            if ( AV63IsAuthorized_Authenticator )
            {
               ...
               {
                  cmbavGridactiongroup1.addItem("4", "Ativar autenticador", 0);
               }
            }
            ...
            {
               cmbavGridactiongroup1.addItem("5", "Desbloquear códigos OTP.", 0);
            }
            if ( AV101User.gxTpr_Isactive || ! AV89Repository.gxTpr_Email.gxTpr_Sendemailwhenuseractivateaccount )
            {
               cmbavGridactiongroup1.addItem("6", "Bloquear usuário", 0);
            }
            if ( AV74IsAuthorized_UDelete )
            {
               cmbavGridactiongroup1.addItem("7", "Deletar usuário", 0);
            }
            cmbavGridactiongroup1.addItem("8", "Ativar no repositório", 0);
            ...
            if ( AV63IsAuthorized_Authenticator )
            {
               if ( ( AV89Repository.istotpauthenticatorenabled() && AV101User.gxTpr_Enabletwofactorauthentication && ( AV101User.gxTpr_Isactive || ! AV89Repository.gxTpr_Email.gxTpr_Sendemailwhenuseractivateaccount ) ) && AV101User.gxTpr_Totpenable )
               {
                  ...
                  cmbavGridactiongroup1.addItem("4", "Desative o autenticador", 0);
               }
            }
            if ( AV101User.gxTpr_Isblocked )
            {
               cmbavGridactiongroup1.removeItem(StringUtil.Str( (decimal)(6), 1, 0));
               cmbavGridactiongroup1.addItem("6", "Usuário desbloqueie", 0);
            }
            if ( AV101User.gxTpr_Isenabledinrepository )
            {
               cmbavGridactiongroup1.removeItem(StringUtil.Str( (decimal)(8), 1, 0));
               cmbavGridactiongroup1.addItem("8", "Desativar no repositório", 0);
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void E141X2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMWWUsersColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV20ColumnsSelectorXML)) ? "" : AV18ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E111X2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWUsersFilters")) + "," + UrlEncode(StringUtil.RTrim(AV109Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV109Pgmname+"GridState",  AV83ManageFiltersXml) ;
      ...
      protected void S152( )
      {
         ...
         {
            new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&Name",  "",  "WWP_GAM_Name",  true,  "") ;
         }
         else
         {
            new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "",  "",  "",  false,  "") ;
         }
         if ( StringUtil.StrCmp(AV89Repository.gxTpr_Useridentification, "name") != 0 )
         {
            new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&Email",  "",  "WWP_GAM_Email",  true,  "") ;
         }
         else
         {
            new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "",  "",  "",  false,  "") ;
         }
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&FirstName",  "",  "WWP_GAM_FirstName",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&LastName",  "",  "WWP_GAM_LastName",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&AuthenticationTypeName",  "",  "WWP_GAM_Authentication",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV18ColumnsSelector,  "&Status",  "",  "Status",  true,  "") ;
      ...
      protected void S182( )
      {
         ...
         if ( AV65IsAuthorized_BtnPermissions )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "gamwwuserpermissions.aspx"+UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID))) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0));
      ...
      protected void S202( )
      {
         ...
         if ( AV67IsAuthorized_BtnSetPwd )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "gamsetpassword.aspx"+UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
      ...
      protected void S212( )
      {
         ...
         if ( AV63IsAuthorized_Authenticator )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "gamusertotpactivation.aspx"+UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
      ...
      protected void S222( )
      {
         ...
         {
            AV111GXV4 = 1;
            while ( AV111GXV4 <= AV34Errors.Count )
            {
               AV32Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV34Errors.Item(AV111GXV4));
      ...
      protected void S242( )
      {
         ...
         if ( AV74IsAuthorized_UDelete )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "gamuserentry.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.RTrim(StringUtil.Trim( AV59GUID)));
            CallWebObject(formatLink("gamuserentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV94Session.Get(AV109Pgmname+"GridState"), "") == 0 )
         {
            AV57GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV109Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV57GridState.FromXml(AV94Session.Get(AV109Pgmname+"GridState"), null, "", "");
         }
         /* Execute user subroutine: 'LOADREGFILTERSSTATE' */
         S172 ();
         if (returnInSub) return;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV112GXV5 = 1;
         while ( AV112GXV5 <= AV57GridState.gxTpr_Filtervalues.Count )
         {
            AV58GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV57GridState.gxTpr_Filtervalues.Item(AV112GXV5));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV57GridState,  "SEARCH",  "Procurar",  !String.IsNullOrEmpty(StringUtil.RTrim( AV92Search)),  0,  AV92Search,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV57GridState,  "FILUSERGENDER",  "Sexo",  !String.IsNullOrEmpty(StringUtil.RTrim( AV41FilUserGender)),  0,  AV41FilUserGender,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV57GridState,  "FILAUTTYPE",  "Autenticação",  !String.IsNullOrEmpty(StringUtil.RTrim( AV36FilAutType)),  0,  AV36FilAutType,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV57GridState,  "FILROL",  "Perfil",  !(0==AV37FilRol),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV37FilRol), 12, 0)),  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV109Pgmname+"GridState",  AV57GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_24_1X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_1X2e( true) ;
         }
         else
         {
            wb_table1_24_1X2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382821734", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwusers.js", "?202382821738", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_552( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_55_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavUpdate_Enabled!=0)&&(edtavUpdate_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 57,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ROClassString = edtavUpdate_Class;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavUpdate_Internalname,StringUtil.RTrim( AV100Update),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavUpdate_Enabled!=0)&&(edtavUpdate_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,57);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtavUpdate_Link,(string)"",(string)"Alterar",(string)"",(string)edtavUpdate_Jsonclick,(short)0,(string)edtavUpdate_Class,(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(int)edtavUpdate_Visible,(int)edtavUpdate_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)55,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavFirstname_Enabled!=0)&&(edtavFirstname_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 62,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ...
            /* Single line edit */
            TempTags = " " + ((edtavLastname_Enabled!=0)&&(edtavLastname_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 63,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ...
            /* Single line edit */
            TempTags = " " + ((edtavAuthenticationtypename_Enabled!=0)&&(edtavAuthenticationtypename_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 64,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ...
            /* Single line edit */
            TempTags = " " + ((edtavGuid_Enabled!=0)&&(edtavGuid_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 65,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavGuid_Internalname,StringUtil.RTrim( AV59GUID),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+((edtavGuid_Enabled!=0)&&(edtavGuid_Visible!=0) ? " onblur=\""+""+";gx.evt.onblur(this,65);\"" : " "),(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavGuid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavGuid_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)55,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMGUID",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavStatus_Enabled!=0)&&(edtavStatus_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 66,'',false,'"+sGXsfl_55_idx+"',55)\"" : " ");
            ROClassString = "Attribute";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtavName_Visible',ctrl:'vNAME',prop:'Visible'},{av:'edtavEmail_Visible',ctrl:'vEMAIL',prop:'Visible'},{av:'edtavFirstname_Visible',ctrl:'vFIRSTNAME',prop:'Visible'},{av:'edtavLastname_Visible',ctrl:'vLASTNAME',prop:'Visible'},{av:'edtavAuthenticationtypename_Visible',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Visible'},{av:'edtavStatus_Visible',ctrl:'vSTATUS',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'edtavStatus_Columnheaderclass',ctrl:'vSTATUS',prop:'Columnheaderclass'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV78ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E121X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E131X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E181X2',iparms:[{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV9AuthenticationTypeName',fld:'vAUTHENTICATIONTYPENAME',pic:''},{av:'AV59GUID',fld:'vGUID',pic:''},{av:'AV84Name',fld:'vNAME',pic:''},{av:'AV43FirstName',fld:'vFIRSTNAME',pic:''},{av:'AV76LastName',fld:'vLASTNAME',pic:''},{av:'AV95Status',fld:'vSTATUS',pic:''},{av:'AV31Email',fld:'vEMAIL',pic:''},{av:'edtavName_Class',ctrl:'vNAME',prop:'Class'},{av:'edtavFirstname_Class',ctrl:'vFIRSTNAME',prop:'Class'},{av:'edtavLastname_Class',ctrl:'vLASTNAME',prop:'Class'},{av:'edtavAuthenticationtypename_Class',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Class'},{av:'edtavEmail_Class',ctrl:'vEMAIL',prop:'Class'},{av:'AV30Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV100Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavUpdate_Class',ctrl:'vUPDATE',prop:'Class'},{av:'AV13BtnRole',fld:'vBTNROLE',pic:''},{av:'edtavBtnrole_Link',ctrl:'vBTNROLE',prop:'Link'},{av:'edtavBtnrole_Class',ctrl:'vBTNROLE',prop:'Class'},{av:'cmbavGridactiongroup1'},{av:'AV49GridActionGroup1',fld:'vGRIDACTIONGROUP1',pic:'ZZZ9'},{av:'edtavName_Link',ctrl:'vNAME',prop:'Link'},{av:'edtavEmail_Link',ctrl:'vEMAIL',prop:'Link'},{av:'edtavStatus_Columnclass',ctrl:'vSTATUS',prop:'Columnclass'}]}");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","{handler:'E141X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_gridcolumnsselector_Columnsselectorvalues',ctrl:'DDO_GRIDCOLUMNSSELECTOR',prop:'ColumnsSelectorValues'}]");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",",oparms:[{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'edtavName_Visible',ctrl:'vNAME',prop:'Visible'},{av:'edtavEmail_Visible',ctrl:'vEMAIL',prop:'Visible'},{av:'edtavFirstname_Visible',ctrl:'vFIRSTNAME',prop:'Visible'},{av:'edtavLastname_Visible',ctrl:'vLASTNAME',prop:'Visible'},{av:'edtavAuthenticationtypename_Visible',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Visible'},{av:'edtavStatus_Visible',ctrl:'vSTATUS',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'edtavStatus_Columnheaderclass',ctrl:'vSTATUS',prop:'Columnheaderclass'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV78ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E111X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''}]");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",",oparms:[{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtavName_Visible',ctrl:'vNAME',prop:'Visible'},{av:'edtavEmail_Visible',ctrl:'vEMAIL',prop:'Visible'},{av:'edtavFirstname_Visible',ctrl:'vFIRSTNAME',prop:'Visible'},{av:'edtavLastname_Visible',ctrl:'vLASTNAME',prop:'Visible'},{av:'edtavAuthenticationtypename_Visible',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Visible'},{av:'edtavStatus_Visible',ctrl:'vSTATUS',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'edtavStatus_Columnheaderclass',ctrl:'vSTATUS',prop:'Columnheaderclass'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV78ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''}]}");
         setEventMetadata("VGRIDACTIONGROUP1.CLICK","{handler:'E191X2',iparms:[{av:'cmbavGridactiongroup1'},{av:'AV49GridActionGroup1',fld:'vGRIDACTIONGROUP1',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'AV59GUID',fld:'vGUID',pic:''}]");
         setEventMetadata("VGRIDACTIONGROUP1.CLICK",",oparms:[{av:'cmbavGridactiongroup1'},{av:'AV49GridActionGroup1',fld:'vGRIDACTIONGROUP1',pic:'ZZZ9'},{av:'AV59GUID',fld:'vGUID',pic:''},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtavName_Visible',ctrl:'vNAME',prop:'Visible'},{av:'edtavEmail_Visible',ctrl:'vEMAIL',prop:'Visible'},{av:'edtavFirstname_Visible',ctrl:'vFIRSTNAME',prop:'Visible'},{av:'edtavLastname_Visible',ctrl:'vLASTNAME',prop:'Visible'},{av:'edtavAuthenticationtypename_Visible',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Visible'},{av:'edtavStatus_Visible',ctrl:'vSTATUS',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'edtavStatus_Columnheaderclass',ctrl:'vSTATUS',prop:'Columnheaderclass'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV78ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("'DOINSERT'","{handler:'E151X2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV109Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'cmbavFilusergender'},{av:'AV41FilUserGender',fld:'vFILUSERGENDER',pic:''},{av:'cmbavFilauttype'},{av:'AV36FilAutType',fld:'vFILAUTTYPE',pic:''},{av:'AV92Search',fld:'vSEARCH',pic:''},{av:'cmbavFilrol'},{av:'AV37FilRol',fld:'vFILROL',pic:'ZZZZZZZZZZZ9'},{av:'edtavBtnrole_Title',ctrl:'vBTNROLE',prop:'Title'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV73IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true},{av:'AV71IsAuthorized_Email',fld:'vISAUTHORIZED_EMAIL',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[{av:'AV80ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV18ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'edtavName_Visible',ctrl:'vNAME',prop:'Visible'},{av:'edtavEmail_Visible',ctrl:'vEMAIL',prop:'Visible'},{av:'edtavFirstname_Visible',ctrl:'vFIRSTNAME',prop:'Visible'},{av:'edtavLastname_Visible',ctrl:'vLASTNAME',prop:'Visible'},{av:'edtavAuthenticationtypename_Visible',ctrl:'vAUTHENTICATIONTYPENAME',prop:'Visible'},{av:'edtavStatus_Visible',ctrl:'vSTATUS',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV51GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'edtavStatus_Columnheaderclass',ctrl:'vSTATUS',prop:'Columnheaderclass'},{av:'AV42FirstIndex',fld:'vFIRSTINDEX',pic:'ZZZ9',hsh:true},{av:'AV54GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV70IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV75IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'AV66IsAuthorized_BtnRole',fld:'vISAUTHORIZED_BTNROLE',pic:'',hsh:true},{av:'edtavBtnrole_Visible',ctrl:'vBTNROLE',prop:'Visible'},{av:'AV65IsAuthorized_BtnPermissions',fld:'vISAUTHORIZED_BTNPERMISSIONS',pic:'',hsh:true},{av:'AV67IsAuthorized_BtnSetPwd',fld:'vISAUTHORIZED_BTNSETPWD',pic:'',hsh:true},{av:'AV63IsAuthorized_Authenticator',fld:'vISAUTHORIZED_AUTHENTICATOR',pic:'',hsh:true},{av:'AV74IsAuthorized_UDelete',fld:'vISAUTHORIZED_UDELETE',pic:'',hsh:true},{av:'AV72IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{ctrl:'BTNINSERT',prop:'Visible'},{av:'AV78ManageFiltersData',fld:'vMANAGEFILTERSDATA',pic:''},{av:'AV57GridState',fld:'vGRIDSTATE',pic:''}]}");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV78ManageFiltersData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV78ManageFiltersData ;
