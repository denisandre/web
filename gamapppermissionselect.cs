   ...
   public class gamapppermissionselect : GXDataArea
   {
      ...
      protected void WB1D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_14_1D2( true) ;
         }
         else
         {
            wb_table1_14_1D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_1D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 33 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnadd_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(33), 2, 0)+","+"null"+");", "Adicionar selecionados", bttBtnadd_Jsonclick, 5, "Adicionar selecionados", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOADD\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMAppPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
      ...
      protected void initialize_formulas( )
      {
         ...
         AssignProp("", false, edtavAppid_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavAppid_Enabled), 5, 0), !bGXsfl_33_Refreshing);
      }
      ...
      protected void wb_table1_14_1D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table2_19_1D2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_1D2e( true) ;
         }
         else
         {
            wb_table1_14_1D2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828183998", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionselect.js", "?202382818400", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E171D2',iparms:[{av:'AV9ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV15FilName',fld:'vFILNAME',pic:''},{av:'AV23PermissionId',fld:'vPERMISSIONID',pic:'',hsh:true},{av:'AV19IsAuthorized_Name',fld:'vISAUTHORIZED_NAME',pic:'',hsh:true}]");
         ...
         setEventMetadata("'DOADD'","{handler:'E141D2',iparms:[{av:'AV9ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV24Select',fld:'vSELECT',grid:33,pic:''},{av:'GRID_nFirstRecordOnPage'},{av:'nRC_GXsfl_33',ctrl:'GRID',grid:33,prop:'GridRC',grid:33},{av:'AV23PermissionId',fld:'vPERMISSIONID',pic:'',hsh:true},{av:'AV18ID',fld:'vID',grid:33,pic:'',hsh:true},{av:'AV20isOK',fld:'vISOK',pic:''}]");
