   ...
   public class gamotpauthentication : GXHttpHandler
   {
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavUserpassword_Internalname, StringUtil.RTrim( AV15UserPassword), StringUtil.RTrim( context.localUtil.Format( AV15UserPassword, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Código", edtavUserpassword_Jsonclick, 0, "AttributeLoginImageLeft", "", "", "", "", edtavUserpassword_Visible, edtavUserpassword_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, -1, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMPassword", "start", true, "", "HLP_GAMOTPAuthentication.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void E110J2( )
      {
         ...
         AV13User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getusertootpauthentication(out  AV7AuthenticationTypeName, out  AV16UseTwoFactorAuthentication, out  AV18Errors);
         ...
         {
            AV18Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
            AV23GXV1 = 1;
            while ( AV23GXV1 <= AV18Errors.Count )
            {
               AV17Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV18Errors.Item(AV23GXV1));
               GX_msglist.addItem(AV17Error.gxTpr_Message);
      ...
      protected void E120J2( )
      {
         ...
         if ( AV18Errors.Count == 0 )
         {
            ...
            AV11LoginOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).login(AV14UserName, AV15UserPassword, AV6AdditionalParameter, out  AV18Errors);
            if ( AV11LoginOK )
            {
            ...
            else
            {
               if ( AV18Errors.Count > 0 )
               {
                  if ( ((GeneXus.Programs.genexussecurity.SdtGAMError)AV18Errors.Item(1)).gxTpr_Code == 161 )
                  {
                     if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
                     {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV24GXV2 = 1;
         while ( AV24GXV2 <= AV18Errors.Count )
         {
            AV17Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV18Errors.Item(AV24GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828165568", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamotpauthentication.js", "?2023828165571", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Mask/jquery.mask.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/BootstrapSelect.js", "", false, true);
         context.AddJavascriptSource("DVelop/WorkWithPlusUtilities/WorkWithPlusUtilitiesRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV7AuthenticationTypeName',fld:'vAUTHENTICATIONTYPENAME',pic:'',hsh:true},{av:'AV16UseTwoFactorAuthentication',fld:'vUSETWOFACTORAUTHENTICATION',pic:'',hsh:true},{av:'AV14UserName',fld:'vUSERNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E120J2',iparms:[{av:'AV7AuthenticationTypeName',fld:'vAUTHENTICATIONTYPENAME',pic:'',hsh:true},{av:'AV16UseTwoFactorAuthentication',fld:'vUSETWOFACTORAUTHENTICATION',pic:'',hsh:true},{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV14UserName',fld:'vUSERNAME',pic:'',hsh:true},{av:'AV15UserPassword',fld:'vUSERPASSWORD',pic:''}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV12URL',fld:'vURL',pic:''},{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''},{av:'AV15UserPassword',fld:'vUSERPASSWORD',pic:''}]}");
         setEventMetadata("BACKTOLOGIN.CLICK","{handler:'E130J2',iparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''}]");
         setEventMetadata("BACKTOLOGIN.CLICK",",oparms:[{av:'AV10IDP_State',fld:'vIDP_STATE',pic:''}]}");
         return  ;
      }
