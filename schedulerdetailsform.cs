...
namespace GeneXus.Programs {
   public class schedulerdetailsform : GXHttpHandler
   {
      ...
      {
         get {
            return "schedulerdetailsform_Execute" ;
         }
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( nGXWrapped != 1 )
         {
            ...
            GXEncryptionTmp = "schedulerdetailsform.aspx"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.RTrim(AV8eventId)) + "," + UrlEncode(DateTimeUtil.FormatDateTimeParm(AV9eventStartTime)) + "," + UrlEncode(DateTimeUtil.FormatDateTimeParm(AV7eventEndTime));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("schedulerdetailsform.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void WB540( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            context.WriteHtmlText( "</p>") ;
            wb_table1_5_542( true) ;
         }
         else
         {
            wb_table1_5_542( false) ;
         }
         return  ;
      }

      protected void wb_table1_5_542e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void PA542( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "schedulerdetailsform.aspx")), "schedulerdetailsform.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "schedulerdetailsform.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
               ...
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        ...
                        AssignAttri("", false, "AV9eventStartTime", context.localUtil.TToC( AV9eventStartTime, 8, 5, 0, 3, "/", ":", " "));
                        AV7eventEndTime = context.localUtil.ParseDTimeParm( GetPar( "eventEndTime"));
                        AssignAttri("", false, "AV7eventEndTime", context.localUtil.TToC( AV7eventEndTime, 8, 5, 0, 3, "/", ":", " "));
                     }
                  }
                  if ( toggleJsOutput )
                  {
      ...
      protected void wb_table1_5_542( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "event Id", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_SchedulerDetailsForm.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavEventid_Internalname, StringUtil.RTrim( AV8eventId), StringUtil.RTrim( context.localUtil.Format( AV8eventId, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEventid_Jsonclick, 0, "Attribute", "", "", "", "", 1, 0, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_SchedulerDetailsForm.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "event Start Time", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_SchedulerDetailsForm.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavEventstarttime_Internalname, context.localUtil.TToC( AV9eventStartTime, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV9eventStartTime, "99/99/99 99:99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEventstarttime_Jsonclick, 0, "Attribute", "", "", "", "", 1, 0, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, false, "", "end", false, "", "HLP_SchedulerDetailsForm.htm");
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "event End Time", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_SchedulerDetailsForm.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavEventendtime_Internalname, context.localUtil.TToC( AV7eventEndTime, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV7eventEndTime, "99/99/99 99:99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEventendtime_Jsonclick, 0, "Attribute", "", "", "", "", 1, 0, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 0, -1, 0, false, "", "end", false, "", "HLP_SchedulerDetailsForm.htm");
            ...
            wb_table1_5_542e( true) ;
         }
         else
         {
            wb_table1_5_542e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828224718", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("schedulerdetailsform.js", "?2023828224718", false, true);
         }
