...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void Reorganizetb_documento_arquivo( )
      {
         string cmdBuffer = "";
         /* Indices for table tb_documento_arquivo */
         cmdBuffer=" ALTER TABLE tb_documento_arquivo ADD DocArqArmExterno BOOLEAN NOT NULL DEFAULT FALSE, ADD DocArqArmExternoPath VARCHAR(2000)  "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE tb_documento_arquivo ALTER COLUMN DocArqArmExterno DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE tb_documento_arquivo ALTER COLUMN DocArqConteudo DROP NOT NULL "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            tb_documento_arquivoCount = P00012_Atb_documento_arquivoCount[0];
            pr_default.close(0);
            PrintRecordCount ( "tb_documento_arquivo" ,  tb_documento_arquivoCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("tb_documento_arquivo",sSchemaVar,"DocArqArmExterno") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DocArqArmExterno", "tb_documento_arquivo"}) ) ;
            return false ;
         }
         if ( ColumnExist("tb_documento_arquivo",sSchemaVar,"DocArqArmExternoPath") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DocArqArmExternoPath", "tb_documento_arquivo"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "Reorganizetb_documento_arquivo" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"tb_documento_arquivo", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_Atb_documento_arquivoCount = new int[1] ;
         sSchemaVar = "";
         sTableName = "";
         sMySchemaName = "";
         sMyColumnName = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.reorg__default(),
            new Object[][] {
                new Object[] {
               P00012_Atb_documento_arquivoCount
               }
               , new Object[] {
      ...
      protected int tb_documento_arquivoCount ;
      ...
      protected int[] P00012_Atb_documento_arquivoCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM tb_documento_arquivo ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
