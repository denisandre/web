...
namespace GeneXus.Programs.core {
   public class visitaview : GXDataArea
   {
      public visitaview( )
      {
      ...
      public visitaview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.visitaview.aspx"+UrlEncode(AV10VisID.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.visitaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVISPAIID", AV22Vispaiid.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vVISPAIID", GetSecureSignedToken( "", AV22Vispaiid, context));
         GxWebStd.gx_hidden_field( context, "vVISID", AV10VisID.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vVISID", GetSecureSignedToken( "", AV10VisID, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Visitaorigemwc == null ) )
         {
            WebComp_Visitaorigemwc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.visitaview.aspx"+UrlEncode(AV10VisID.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.visitaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.VisitaView" ;
      }
      ...
      protected void WB550( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Visitas", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\VisitaView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes da Visita", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\VisitaView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblVisitaorigem_title_Internalname, "Detalhes da Visita Original", "", "", lblVisitaorigem_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\VisitaView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "VisitaOrigem") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablevisitaorigem_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Visitaorigemwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Visitaorigemwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldVisitaorigemwc), StringUtil.Lower( WebComp_Visitaorigemwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Visitaorigemwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldVisitaorigemwc), StringUtil.Lower( WebComp_Visitaorigemwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START552( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Visita View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldVisitaorigemwc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldVisitaorigemwc) == 0 ) || ( StringUtil.StrCmp(OldVisitaorigemwc, WebComp_Visitaorigemwc_Component) != 0 ) )
                           {
                              WebComp_Visitaorigemwc = getWebComponent(GetType(), "GeneXus.Programs", OldVisitaorigemwc, new Object[] {context} );
                              WebComp_Visitaorigemwc.ComponentInit();
                              WebComp_Visitaorigemwc.Name = "OldVisitaorigemwc";
                              WebComp_Visitaorigemwc_Component = OldVisitaorigemwc;
                           }
                           if ( StringUtil.Len( WebComp_Visitaorigemwc_Component) != 0 )
                           {
                              WebComp_Visitaorigemwc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Visitaorigemwc_Component = OldVisitaorigemwc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PA552( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.visitaview.aspx")), "core.visitaview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.visitaview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10VisID = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10VisID", AV10VisID.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vVISID", GetSecureSignedToken( "", AV10VisID, context));
      ...
      protected void RF552( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Visitaorigemwc_Component) != 0 )
               {
                  WebComp_Visitaorigemwc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H00552 */
            pr_default.execute(0, new Object[] {AV10VisID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A398VisID = H00552_A398VisID[0];
               /* Execute user event: Load */
               E16552 ();
      ...
      protected void E14552( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.visitaww.aspx"+UrlEncode(AV18Visnegid.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(AV19Visngfseq,8,0));
         lblWorkwithlink_Link = formatLink("core.visitaww.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV20GXLvl9 = 0;
         /* Using cursor H00553 */
         pr_default.execute(1, new Object[] {AV10VisID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A398VisID = H00553_A398VisID[0];
            A399VisInsData = H00553_A399VisInsData[0];
            AV20GXLvl9 = 1;
            Form.Caption = context.localUtil.DToC( A399VisInsData, 2, "/");
      ...
      protected void E15552( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Visita",  StringUtil.Trim( A398VisID.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Visita",  2) )
         {
      ...
      protected void E11552( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Visita",(short)2,StringUtil.Trim( A398VisID.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12552( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "core.visitaview.aspx"+UrlEncode(A398VisID.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Visita",StringUtil.Trim( A398VisID.ToString()),(string)AV14RecordDescription,formatLink("core.visitaview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         /* Using cursor H00554 */
         pr_default.execute(2, new Object[] {AV10VisID});
         while ( (pr_default.getStatus(2) != 101) )
         {
            A398VisID = H00554_A398VisID[0];
            if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
            {
               ...
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.VisitaGeneral")) != 0 )
               {
                  WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.visitageneral", new Object[] {context} );
                  WebComp_Generalwc.ComponentInit();
                  WebComp_Generalwc.Name = "core.VisitaGeneral";
                  WebComp_Generalwc_Component = "core.VisitaGeneral";
               }
               if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
               {
                  WebComp_Generalwc.setjustcreated();
                  WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(Guid)AV10VisID});
            ...
            if ( A398VisID == AV22Vispaiid )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "VisitaOrigem") == 0 ) )
               {
                  /* Object Property */
                  if ( true )
                  {
                     bDynCreated_Visitaorigemwc = true;
                  }
                  if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Visitaorigemwc_Component), StringUtil.Lower( "core.VisitaOrigem")) != 0 )
                  {
                     WebComp_Visitaorigemwc = getWebComponent(GetType(), "GeneXus.Programs", "core.visitaorigem", new Object[] {context} );
                     WebComp_Visitaorigemwc.ComponentInit();
                     WebComp_Visitaorigemwc.Name = "core.VisitaOrigem";
                     WebComp_Visitaorigemwc_Component = "core.VisitaOrigem";
                  }
                  if ( StringUtil.Len( WebComp_Visitaorigemwc_Component) != 0 )
                  {
                     WebComp_Visitaorigemwc.setjustcreated();
                     WebComp_Visitaorigemwc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10VisID});
                     WebComp_Visitaorigemwc.componentbind(new Object[] {(string)""});
                  }
                  if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Visitaorigemwc )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                     WebComp_Visitaorigemwc.componentdraw();
                     context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Visitaorigemwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Visitaorigemwc_Component) != 0 )
            {
               WebComp_Visitaorigemwc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828224790", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/visitaview.js", "?2023828224791", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblVisitaorigem_title_Internalname = "VISITAORIGEM_TITLE";
         divUnnamedtablevisitaorigem_Internalname = "UNNAMEDTABLEVISITAORIGEM";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A398VisID',fld:'VISID',pic:''},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10VisID',fld:'vVISID',pic:'',hsh:true},{av:'AV22Vispaiid',fld:'vVISPAIID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11552',iparms:[{av:'A398VisID',fld:'VISID',pic:''},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12552',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A398VisID',fld:'VISID',pic:''}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13552',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A398VisID',fld:'VISID',pic:''},{av:'AV10VisID',fld:'vVISID',pic:'',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV22Vispaiid',fld:'vVISPAIID',pic:'',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'},{ctrl:'VISITAORIGEMWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblVisitaorigem_title_Jsonclick = "";
         WebComp_Visitaorigemwc_Component = "";
         OldVisitaorigemwc = "";
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00552_A398VisID = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         AV18Visnegid = Guid.Empty;
         H00553_A398VisID = new Guid[] {Guid.Empty} ;
         H00553_A399VisInsData = new DateTime[] {DateTime.MinValue} ;
         A399VisInsData = DateTime.MinValue;
         AV15Session = context.GetSession();
         H00554_A398VisID = new Guid[] {Guid.Empty} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.visitaview__default(),
            new Object[][] {
                new Object[] {
               H00552_A398VisID
               }
               , new Object[] {
               H00553_A398VisID, H00553_A399VisInsData
               }
               , new Object[] {
               H00554_A398VisID
               }
         ...
         WebComp_Visitaorigemwc = new GeneXus.Http.GXNullWebComponent();
      ...
      private short AV20GXLvl9 ;
      private short nGXWrapped ;
      private int Tabs_Pagecount ;
      private int AV19Visngfseq ;
      private int idxLst ;
      ...
      private string lblVisitaorigem_title_Internalname ;
      private string lblVisitaorigem_title_Jsonclick ;
      private string divUnnamedtablevisitaorigem_Internalname ;
      private string WebComp_Visitaorigemwc_Component ;
      private string OldVisitaorigemwc ;
      ...
      private bool bDynCreated_Visitaorigemwc ;
      private string AV14RecordDescription ;
      private Guid AV10VisID ;
      private Guid wcpOAV10VisID ;
      private Guid AV22Vispaiid ;
      private Guid A398VisID ;
      private Guid AV18Visnegid ;
      private IGxSession AV15Session ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Visitaorigemwc ;
      ...
      private Guid[] H00552_A398VisID ;
      private Guid[] H00553_A398VisID ;
      private DateTime[] H00553_A399VisInsData ;
      private Guid[] H00554_A398VisID ;
   ...
   public class visitaview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10VisID",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00553;
          ...
          Object[] prmH00554;
          prmH00554 = new Object[] {
          new ParDef("AV10VisID",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H00552", "SELECT VisID FROM tb_visita WHERE VisID = :AV10VisID ORDER BY VisID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00552,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00553", "SELECT VisID, VisInsData FROM tb_visita WHERE VisID = :AV10VisID ORDER BY VisID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00553,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00554", "SELECT VisID FROM tb_visita WHERE VisID = :AV10VisID ORDER BY VisID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00554,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
