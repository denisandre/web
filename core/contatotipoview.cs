...
namespace GeneXus.Programs.core {
   public class contatotipoview : GXDataArea
   {
      public contatotipoview( )
      {
      ...
      public contatotipoview( IGxContext context )
      {
      ...
      {
         get {
            return "contatotipoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.contatotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16CotID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.contatotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCOTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16CotID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16CotID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.contatotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16CotID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.contatotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.ContatoTipoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Contato Tipo View" ;
      }
      ...
      protected void WB300( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo de Contato", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\ContatoTipoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhe", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ContatoTipoView.htm");
            /* Div Control */
      ...
      protected void START302( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Contato Tipo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA302( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.contatotipoview.aspx")), "core.contatotipoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.contatotipoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV16CotID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV16CotID", StringUtil.LTrimStr( (decimal)(AV16CotID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCOTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16CotID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF302( )
      {
         ...
         {
            /* Using cursor H00302 */
            pr_default.execute(0, new Object[] {AV16CotID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A149CotID = H00302_A149CotID[0];
               /* Execute user event: Load */
               E16302 ();
      ...
      protected void E14302( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.contatotipoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00303 */
         pr_default.execute(1, new Object[] {AV16CotID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A149CotID = H00303_A149CotID[0];
            A151CotNome = H00303_A151CotNome[0];
            AV17GXLvl9 = 1;
            Form.Caption = A151CotNome;
      ...
      protected void E15302( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "ContatoTipo",  StringUtil.Trim( StringUtil.Str( (decimal)(A149CotID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "ContatoTipo",  2) )
         {
      ...
      protected void E11302( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"ContatoTipo",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A149CotID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E12302( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"ContatoTipo",StringUtil.Trim( StringUtil.Str( (decimal)(A149CotID), 9, 0)),(string)AV14RecordDescription,formatLink("core.contatotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ContatoTipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.contatotipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ContatoTipoGeneral";
               WebComp_Generalwc_Component = "core.ContatoTipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV16CotID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV16CotID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV16CotID", StringUtil.LTrimStr( (decimal)(AV16CotID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCOTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16CotID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828211838", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/contatotipoview.js", "?2023828211838", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Contato Tipo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A149CotID',fld:'COTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV16CotID',fld:'vCOTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11302',iparms:[{av:'A149CotID',fld:'COTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12302',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A149CotID',fld:'COTID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13302',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV16CotID',fld:'vCOTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00302_A149CotID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00303_A149CotID = new int[1] ;
         H00303_A151CotNome = new string[] {""} ;
         A151CotNome = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.contatotipoview__default(),
            new Object[][] {
                new Object[] {
               H00302_A149CotID
               }
               , new Object[] {
               H00303_A149CotID, H00303_A151CotNome
               }
            }
         );
      ...
      private int AV16CotID ;
      private int wcpOAV16CotID ;
      ...
      private int[] H00302_A149CotID ;
      private int[] H00303_A149CotID ;
      private string[] H00303_A151CotNome ;
   ...
   public class contatotipoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV16CotID",GXType.Int32,9,0)
          };
          Object[] prmH00303;
          ...
          def= new CursorDef[] {
              new CursorDef("H00302", "SELECT CotID FROM tb_contatotipo WHERE CotID = :AV16CotID ORDER BY CotID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00302,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00303", "SELECT CotID, CotNome FROM tb_contatotipo WHERE CotID = :AV16CotID ORDER BY CotID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00303,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
