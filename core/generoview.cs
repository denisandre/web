...
namespace GeneXus.Programs.core {
   public class generoview : GXDataArea
   {
      public generoview( )
      {
      ...
      public generoview( IGxContext context )
      {
      ...
      public void execute( int aP0_GenID ,
                           string aP1_TabCode )
      {
         this.AV16GenID = aP0_GenID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "GenID");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.generoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16GenID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.generoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16GenID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vGENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16GenID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.generoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16GenID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.generoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.GeneroView" ;
      }
      ...
      protected void WB330( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Genero da Pessoa", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\GeneroView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\GeneroView.htm");
            /* Div Control */
      ...
      protected void START332( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Genero View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA332( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.generoview.aspx")), "core.generoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.generoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV16GenID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV16GenID", StringUtil.LTrimStr( (decimal)(AV16GenID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vGENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16GenID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF332( )
      {
         ...
         {
            /* Using cursor H00332 */
            pr_default.execute(0, new Object[] {AV16GenID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A152GenID = H00332_A152GenID[0];
               /* Execute user event: Load */
               E16332 ();
      ...
      protected void E14332( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.generoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00333 */
         pr_default.execute(1, new Object[] {AV16GenID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A152GenID = H00333_A152GenID[0];
            A153GenSigla = H00333_A153GenSigla[0];
            AV17GXLvl9 = 1;
            Form.Caption = A153GenSigla;
      ...
      protected void E15332( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Genero",  StringUtil.Trim( StringUtil.Str( (decimal)(A152GenID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Genero",  2) )
         {
      ...
      protected void E11332( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"Genero",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A152GenID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E12332( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"Genero",StringUtil.Trim( StringUtil.Str( (decimal)(A152GenID), 9, 0)),(string)AV14RecordDescription,formatLink("core.generoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.GeneroGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.generogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.GeneroGeneral";
               WebComp_Generalwc_Component = "core.GeneroGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV16GenID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV16GenID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV16GenID", StringUtil.LTrimStr( (decimal)(AV16GenID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vGENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16GenID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828211760", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/generoview.js", "?2023828211760", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A152GenID',fld:'GENID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV16GenID',fld:'vGENID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11332',iparms:[{av:'A152GenID',fld:'GENID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12332',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A152GenID',fld:'GENID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13332',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV16GenID',fld:'vGENID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00332_A152GenID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00333_A152GenID = new int[1] ;
         H00333_A153GenSigla = new string[] {""} ;
         A153GenSigla = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.generoview__default(),
            new Object[][] {
                new Object[] {
               H00332_A152GenID
               }
               , new Object[] {
               H00333_A152GenID, H00333_A153GenSigla
               }
            }
         );
      ...
      private int AV16GenID ;
      private int wcpOAV16GenID ;
      ...
      private int[] H00332_A152GenID ;
      private int[] H00333_A152GenID ;
      private string[] H00333_A153GenSigla ;
   ...
   public class generoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV16GenID",GXType.Int32,9,0)
          };
          Object[] prmH00333;
          ...
          def= new CursorDef[] {
              new CursorDef("H00332", "SELECT GenID FROM tb_genero WHERE GenID = :AV16GenID ORDER BY GenID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00332,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00333", "SELECT GenID, GenSigla FROM tb_genero WHERE GenID = :AV16GenID ORDER BY GenID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00333,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
