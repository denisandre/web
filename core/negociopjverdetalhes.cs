...
namespace GeneXus.Programs.core {
   public class negociopjverdetalhes : GXWebComponent
   {
      public negociopjverdetalhes( )
      {
      ...
      public negociopjverdetalhes( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV13Pgmname = "core.NegocioPJVerDetalhes";
               WS5A2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Negocio PJVer Detalhes") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "core.negociopjverdetalhes.aspx"+UrlEncode(A345NegID.ToString());
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.negociopjverdetalhes.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "core.NegocioPJVerDetalhes" ;
      }

      public override string GetPgmdesc( )
      {
         return "Negocio PJVer Detalhes" ;
      }
      ...
      protected void WB5A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.negociopjverdetalhes.aspx");
               context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
               context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
            }
            ...
            ClassString = "AttributeFL";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtNegCpjEndCompleto_Internalname, A641NegCpjEndCompleto, "", "", 0, 1, edtNegCpjEndCompleto_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "1000", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_core\\NegocioPJVerDetalhes.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtNegAssunto_Internalname, A362NegAssunto, StringUtil.RTrim( context.localUtil.Format( A362NegAssunto, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtNegAssunto_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtNegAssunto_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_core\\NegocioPJVerDetalhes.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void START5A2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Negocio PJVer Detalhes", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.negociopjverdetalhes.aspx")), "core.negociopjverdetalhes.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.negociopjverdetalhes.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF5A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A350NegCliID = H005A2_A350NegCliID[0];
               A352NegCpjID = H005A2_A352NegCpjID[0];
               A369NegCpjEndSeq = H005A2_A369NegCpjEndSeq[0];
               A363NegDescricao = H005A2_A363NegDescricao[0];
               A380NegValorEstimado = H005A2_A380NegValorEstimado[0];
               AssignAttri(sPrefix, false, "A380NegValorEstimado", StringUtil.LTrimStr( A380NegValorEstimado, 16, 2));
               A362NegAssunto = H005A2_A362NegAssunto[0];
               AssignAttri(sPrefix, false, "A362NegAssunto", A362NegAssunto);
               A353NegCpjNomFan = H005A2_A353NegCpjNomFan[0];
               AssignAttri(sPrefix, false, "A353NegCpjNomFan", A353NegCpjNomFan);
               A351NegCliNomeFamiliar = H005A2_A351NegCliNomeFamiliar[0];
               AssignAttri(sPrefix, false, "A351NegCliNomeFamiliar", A351NegCliNomeFamiliar);
               A356NegCodigo = H005A2_A356NegCodigo[0];
               AssignAttri(sPrefix, false, "A356NegCodigo", StringUtil.LTrimStr( (decimal)(A356NegCodigo), 12, 0));
               A373NegCpjEndComplem = H005A2_A373NegCpjEndComplem[0];
               n373NegCpjEndComplem = H005A2_n373NegCpjEndComplem[0];
               A372NegCpjEndNumero = H005A2_A372NegCpjEndNumero[0];
               A378NegCpjEndUFSigla = H005A2_A378NegCpjEndUFSigla[0];
               A376NegCpjEndMunNome = H005A2_A376NegCpjEndMunNome[0];
               A643NegCpjEndCepFormat = H005A2_A643NegCpjEndCepFormat[0];
               A374NegCpjEndBairro = H005A2_A374NegCpjEndBairro[0];
               A371NegCpjEndEndereco = H005A2_A371NegCpjEndEndereco[0];
               A373NegCpjEndComplem = H005A2_A373NegCpjEndComplem[0];
               n373NegCpjEndComplem = H005A2_n373NegCpjEndComplem[0];
               A372NegCpjEndNumero = H005A2_A372NegCpjEndNumero[0];
               A378NegCpjEndUFSigla = H005A2_A378NegCpjEndUFSigla[0];
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\negociopjverdetalhes", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382894444", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("core/negociopjverdetalhes.js", "?202382894444", false, true);
            context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
            context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A345NegID',fld:'NEGID',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H005A2_A350NegCliID = new Guid[] {Guid.Empty} ;
         H005A2_A352NegCpjID = new Guid[] {Guid.Empty} ;
         H005A2_A369NegCpjEndSeq = new short[1] ;
         H005A2_A345NegID = new Guid[] {Guid.Empty} ;
         H005A2_A363NegDescricao = new string[] {""} ;
         H005A2_A380NegValorEstimado = new decimal[1] ;
         H005A2_A362NegAssunto = new string[] {""} ;
         H005A2_A353NegCpjNomFan = new string[] {""} ;
         H005A2_A351NegCliNomeFamiliar = new string[] {""} ;
         H005A2_A356NegCodigo = new long[1] ;
         H005A2_A373NegCpjEndComplem = new string[] {""} ;
         H005A2_n373NegCpjEndComplem = new bool[] {false} ;
         H005A2_A372NegCpjEndNumero = new string[] {""} ;
         H005A2_A378NegCpjEndUFSigla = new string[] {""} ;
         H005A2_A376NegCpjEndMunNome = new string[] {""} ;
         H005A2_A643NegCpjEndCepFormat = new string[] {""} ;
         H005A2_A374NegCpjEndBairro = new string[] {""} ;
         H005A2_A371NegCpjEndEndereco = new string[] {""} ;
         ...
         sCtrlA345NegID = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.negociopjverdetalhes__default(),
            new Object[][] {
                new Object[] {
               H005A2_A350NegCliID, H005A2_A352NegCpjID, H005A2_A369NegCpjEndSeq, H005A2_A345NegID, H005A2_A363NegDescricao, H005A2_A380NegValorEstimado, H005A2_A362NegAssunto, H005A2_A353NegCpjNomFan, H005A2_A351NegCliNomeFamiliar, H005A2_A356NegCodigo,
               H005A2_A373NegCpjEndComplem, H005A2_n373NegCpjEndComplem, H005A2_A372NegCpjEndNumero, H005A2_A378NegCpjEndUFSigla, H005A2_A376NegCpjEndMunNome, H005A2_A643NegCpjEndCepFormat, H005A2_A374NegCpjEndBairro, H005A2_A371NegCpjEndEndereco
               }
            }
         );
         AV13Pgmname = "core.NegocioPJVerDetalhes";
      ...
      private Guid[] H005A2_A350NegCliID ;
      private Guid[] H005A2_A352NegCpjID ;
      private short[] H005A2_A369NegCpjEndSeq ;
      private Guid[] H005A2_A345NegID ;
      private string[] H005A2_A363NegDescricao ;
      private decimal[] H005A2_A380NegValorEstimado ;
      private string[] H005A2_A362NegAssunto ;
      private string[] H005A2_A353NegCpjNomFan ;
      private string[] H005A2_A351NegCliNomeFamiliar ;
      private long[] H005A2_A356NegCodigo ;
      private string[] H005A2_A373NegCpjEndComplem ;
      private bool[] H005A2_n373NegCpjEndComplem ;
      private string[] H005A2_A372NegCpjEndNumero ;
      private string[] H005A2_A378NegCpjEndUFSigla ;
      private string[] H005A2_A376NegCpjEndMunNome ;
      private string[] H005A2_A643NegCpjEndCepFormat ;
      private string[] H005A2_A374NegCpjEndBairro ;
      private string[] H005A2_A371NegCpjEndEndereco ;
   ...
   public class negociopjverdetalhes__default : DataStoreHelperBase, IDataStoreHelper
   {
