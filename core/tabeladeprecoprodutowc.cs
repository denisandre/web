...
namespace GeneXus.Programs.core {
   public class tabeladeprecoprodutowc : GXWebComponent
   {
      public tabeladeprecoprodutowc( )
      {
      ...
      public tabeladeprecoprodutowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8TppID = StringUtil.StrToGuid( GetPar( "TppID"));
                  AssignAttri(sPrefix, false, "AV8TppID", AV8TppID.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8TppID});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV23IsAuthorized_PrdCodigo = StringUtil.StrToBool( GetPar( "IsAuthorized_PrdCodigo"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV8TppID, AV24Pgmname, AV14OrderedBy, AV15OrderedDsc, AV23IsAuthorized_PrdCodigo, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV24Pgmname = "core.TabelaDePrecoProdutoWC";
               WS3L2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Tabela De Preco Produto WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "core.tabeladeprecoprodutowc.aspx"+UrlEncode(AV8TppID.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.tabeladeprecoprodutowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_PRDCODIGO", AV23IsAuthorized_PrdCodigo);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRDCODIGO", GetSecureSignedToken( sPrefix, AV23IsAuthorized_PrdCodigo, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8TppID", wcpOAV8TppID.ToString());
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV24Pgmname));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vPGMNAME", GetSecureSignedToken( sPrefix, StringUtil.RTrim( context.localUtil.Format( AV24Pgmname, "")), context));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_PRDCODIGO", AV23IsAuthorized_PrdCodigo);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRDCODIGO", GetSecureSignedToken( sPrefix, AV23IsAuthorized_PrdCodigo, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTPPID", AV8TppID.ToString());
      ...
      {
         return "core.TabelaDePrecoProdutoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tabela De Preco Produto WC" ;
      }
      ...
      protected void WB3L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.tabeladeprecoprodutowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTppID_Internalname, A235TppID.ToString(), A235TppID.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTppID_Jsonclick, 0, "Attribute", "", "", "", "", edtTppID_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_core\\TabelaDePrecoProdutoWC.htm");
            /* User Defined Control */
      ...
      protected void START3L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Tabela De Preco Produto WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.tabeladeprecoprodutowc.aspx")), "core.tabeladeprecoprodutowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.tabeladeprecoprodutowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV14OrderedBy ,
                                       bool AV15OrderedDsc ,
                                       bool AV23IsAuthorized_PrdCodigo ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF3L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H003L2 */
            pr_default.execute(0, new Object[] {AV8TppID, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A235TppID = H003L2_A235TppID[0];
               AssignAttri(sPrefix, false, "A235TppID", A235TppID.ToString());
               A247Tpp1Preco = H003L2_A247Tpp1Preco[0];
               A231PrdAtivo = H003L2_A231PrdAtivo[0];
               A232PrdTipoID = H003L2_A232PrdTipoID[0];
               A222PrdNome = H003L2_A222PrdNome[0];
               A221PrdCodigo = H003L2_A221PrdCodigo[0];
               A220PrdID = H003L2_A220PrdID[0];
               A231PrdAtivo = H003L2_A231PrdAtivo[0];
               E163L2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         /* Using cursor H003L3 */
         pr_default.execute(1, new Object[] {AV8TppID});
      ...
      protected void STRUP3L0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8TppID = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8TppID"));
      ...
      protected void E143L2( )
      {
         ...
         GXt_boolean1 = AV23IsAuthorized_PrdCodigo;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "produtoview_Execute", out  GXt_boolean1) ;
         AV23IsAuthorized_PrdCodigo = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV23IsAuthorized_PrdCodigo", AV23IsAuthorized_PrdCodigo);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRDCODIGO", GetSecureSignedToken( sPrefix, AV23IsAuthorized_PrdCodigo, context));
      ...
      protected void E153L2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV24Pgmname, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "core.TabelaDePreco";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "TppID";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8TppID.ToString();
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8TppID = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\tabeladeprecoprodutowc", GetJustCreated( ));
         ...
         {
            AV8TppID = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8TppID", AV8TppID.ToString());
         }
         wcpOAV8TppID = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8TppID"));
         if ( ! GetJustCreated( ) && ( ( AV8TppID != wcpOAV8TppID ) ) )
         {
            setjustcreated();
         }
         wcpOAV8TppID = AV8TppID;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8TppID = cgiGet( sPrefix+"AV8TppID_CTRL");
         if ( StringUtil.Len( sCtrlAV8TppID) > 0 )
         {
            AV8TppID = StringUtil.StrToGuid( cgiGet( sCtrlAV8TppID));
            AssignAttri(sPrefix, false, "AV8TppID", AV8TppID.ToString());
         }
         else
         {
            AV8TppID = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8TppID_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8TppID_PARM", AV8TppID.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8TppID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8TppID_CTRL", StringUtil.RTrim( sCtrlAV8TppID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828134256", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("core/tabeladeprecoprodutowc.js", "?2023828134256", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtPrdID_Internalname = sPrefix+"PRDID_"+sGXsfl_15_idx;
         edtPrdCodigo_Internalname = sPrefix+"PRDCODIGO_"+sGXsfl_15_idx;
         edtPrdNome_Internalname = sPrefix+"PRDNOME_"+sGXsfl_15_idx;
         edtPrdTipoID_Internalname = sPrefix+"PRDTIPOID_"+sGXsfl_15_idx;
         chkPrdAtivo_Internalname = sPrefix+"PRDATIVO_"+sGXsfl_15_idx;
         edtTpp1Preco_Internalname = sPrefix+"TPP1PRECO_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtPrdID_Internalname = sPrefix+"PRDID_"+sGXsfl_15_fel_idx;
         edtPrdCodigo_Internalname = sPrefix+"PRDCODIGO_"+sGXsfl_15_fel_idx;
         edtPrdNome_Internalname = sPrefix+"PRDNOME_"+sGXsfl_15_fel_idx;
         edtPrdTipoID_Internalname = sPrefix+"PRDTIPOID_"+sGXsfl_15_fel_idx;
         chkPrdAtivo_Internalname = sPrefix+"PRDATIVO_"+sGXsfl_15_fel_idx;
         edtTpp1Preco_Internalname = sPrefix+"TPP1PRECO_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "PRDATIVO_" + sGXsfl_15_idx;
            chkPrdAtivo.Name = GXCCtl;
            chkPrdAtivo.WebTags = "";
            chkPrdAtivo.Caption = "";
            AssignProp(sPrefix, false, chkPrdAtivo_Internalname, "TitleCaption", chkPrdAtivo.Caption, !bGXsfl_15_Refreshing);
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtTpp1Preco_Internalname,StringUtil.LTrim( StringUtil.NToC( A247Tpp1Preco, 23, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A247Tpp1Preco, "R$ Z,ZZZ,ZZZ,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtTpp1Preco_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)23,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)0,(bool)true,(string)"core\\Monetario",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl15( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Tipo Produto/Serviço") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A247Tpp1Preco, 23, 2, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtTpp1Preco_Internalname = sPrefix+"TPP1PRECO";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:PrdID|1:PrdCodigo|2:PrdNome|3:PrdTipoID|5:Tpp1Preco";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8TppID',fld:'vTPPID',pic:''},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV24Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_PrdCodigo',fld:'vISAUTHORIZED_PRDCODIGO',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E113L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8TppID',fld:'vTPPID',pic:''},{av:'AV24Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_PrdCodigo',fld:'vISAUTHORIZED_PRDCODIGO',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E123L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8TppID',fld:'vTPPID',pic:''},{av:'AV24Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_PrdCodigo',fld:'vISAUTHORIZED_PRDCODIGO',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E133L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV8TppID',fld:'vTPPID',pic:''},{av:'AV24Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV23IsAuthorized_PrdCodigo',fld:'vISAUTHORIZED_PRDCODIGO',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E163L2',iparms:[{av:'AV23IsAuthorized_PrdCodigo',fld:'vISAUTHORIZED_PRDCODIGO',pic:'',hsh:true},{av:'A220PrdID',fld:'PRDID',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtPrdCodigo_Link',ctrl:'PRDCODIGO',prop:'Link'}]}");
         setEventMetadata("VALID_PRDID","{handler:'Valid_Prdid',iparms:[]");
         setEventMetadata("VALID_PRDID",",oparms:[]}");
         setEventMetadata("NULL","{handler:'Valid_Tpp1preco',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H003L2_A235TppID = new Guid[] {Guid.Empty} ;
         H003L2_A247Tpp1Preco = new decimal[1] ;
         H003L2_A231PrdAtivo = new bool[] {false} ;
         H003L2_A232PrdTipoID = new int[1] ;
         H003L2_A222PrdNome = new string[] {""} ;
         H003L2_A221PrdCodigo = new string[] {""} ;
         H003L2_A220PrdID = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.tabeladeprecoprodutowc__default(),
            new Object[][] {
                new Object[] {
               H003L2_A235TppID, H003L2_A247Tpp1Preco, H003L2_A231PrdAtivo, H003L2_A232PrdTipoID, H003L2_A222PrdNome, H003L2_A221PrdCodigo, H003L2_A220PrdID
               }
               , new Object[] {
      ...
      private bool AV23IsAuthorized_PrdCodigo ;
      ...
      private Guid AV8TppID ;
      private Guid wcpOAV8TppID ;
      ...
      private Guid[] H003L2_A235TppID ;
      private decimal[] H003L2_A247Tpp1Preco ;
      private bool[] H003L2_A231PrdAtivo ;
      private int[] H003L2_A232PrdTipoID ;
      private string[] H003L2_A222PrdNome ;
      private string[] H003L2_A221PrdCodigo ;
      private Guid[] H003L2_A220PrdID ;
   ...
   public class tabeladeprecoprodutowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid A235TppID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.TppID, T1.Tpp1Preco, T2.PrdAtivo, T1.PrdTipoID, T1.PrdNome, T1.PrdCodigo, T1.PrdID";
         sFromString = " FROM (tb_tabeladepreco_produto T1 INNER JOIN tb_produto T2 ON T2.PrdID = T1.PrdID)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.TppID = :AV8TppID)");
         if ( ( AV14OrderedBy == 1 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.TppID, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.TppID DESC, T1.PrdID DESC";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.TppID, T1.PrdCodigo, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.TppID DESC, T1.PrdCodigo DESC, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.TppID, T1.PrdNome, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.TppID DESC, T1.PrdNome DESC, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.TppID, T1.PrdTipoID, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.TppID DESC, T1.PrdTipoID DESC, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.TppID, T1.Tpp1Preco, T1.PrdID";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.TppID DESC, T1.Tpp1Preco DESC, T1.PrdID";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.TppID, T1.PrdID";
                                             ...
                                             Guid A235TppID )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (tb_tabeladepreco_produto T1 INNER JOIN tb_produto T2 ON T2.PrdID = T1.PrdID)";
         AddWhere(sWhereString, "(T1.TppID = :AV8TppID)");
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8TppID",GXType.UniqueIdentifier,36,0) ,
