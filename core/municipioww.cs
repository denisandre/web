...
namespace GeneXus.Programs.core {
   public class municipioww : GXDataArea
   {
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "MunicipioMicroNome",  "",  "Microrregião",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "MunicipioMicroMesoNome",  "",  "Mesorregião",  true,  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV21ColumnsSelector,  "MunicipioMicroMesoUFRegNome",  "",  "Região",  true,  "") ;
      ...
      protected void StartGridControl41( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Microrregião") ;
            context.WriteHtmlTextNl( "</th>") ;
            ...
            context.SendWebValue( "Mesorregião") ;
            context.WriteHtmlTextNl( "</th>") ;
