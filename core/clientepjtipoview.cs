...
namespace GeneXus.Programs.core {
   public class clientepjtipoview : GXDataArea
   {
      public clientepjtipoview( )
      {
      ...
      public clientepjtipoview( IGxContext context )
      {
      ...
      public void execute( int aP0_PjtID ,
                           string aP1_TabCode )
      {
         this.AV16PjtID = aP0_PjtID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "PjtID");
      ...
      {
         get {
            return "clientepjtipoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.clientepjtipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16PjtID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.clientepjtipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPJTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16PjtID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPJTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16PjtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "PJTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A155PjtID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.clientepjtipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV16PjtID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.clientepjtipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.ClientePJTipoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente PJTipo View" ;
      }
      ...
      protected void WB360( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo de Cliente PJ", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\ClientePJTipoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ClientePJTipoView.htm");
            /* Div Control */
      ...
      protected void START362( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Cliente PJTipo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA362( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.clientepjtipoview.aspx")), "core.clientepjtipoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.clientepjtipoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV16PjtID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV16PjtID", StringUtil.LTrimStr( (decimal)(AV16PjtID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPJTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16PjtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF362( )
      {
         ...
         {
            /* Using cursor H00362 */
            pr_default.execute(0, new Object[] {AV16PjtID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A155PjtID = H00362_A155PjtID[0];
               /* Execute user event: Load */
               E16362 ();
      ...
      protected void E14362( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.clientepjtipoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00363 */
         pr_default.execute(1, new Object[] {AV16PjtID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A155PjtID = H00363_A155PjtID[0];
            A157PjtNome = H00363_A157PjtNome[0];
            AV17GXLvl9 = 1;
            Form.Caption = A157PjtNome;
      ...
      protected void E15362( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "ClientePJTipo",  StringUtil.Trim( StringUtil.Str( (decimal)(A155PjtID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "ClientePJTipo",  2) )
         {
      ...
      protected void E11362( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"ClientePJTipo",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A155PjtID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E12362( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"ClientePJTipo",StringUtil.Trim( StringUtil.Str( (decimal)(A155PjtID), 9, 0)),(string)AV14RecordDescription,formatLink("core.clientepjtipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ClientePJTipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.clientepjtipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ClientePJTipoGeneral";
               WebComp_Generalwc_Component = "core.ClientePJTipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV16PjtID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV16PjtID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV16PjtID", StringUtil.LTrimStr( (decimal)(AV16PjtID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPJTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV16PjtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828212046", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/clientepjtipoview.js", "?2023828212046", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Cliente PJTipo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A155PjtID',fld:'PJTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV16PjtID',fld:'vPJTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11362',iparms:[{av:'A155PjtID',fld:'PJTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12362',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A155PjtID',fld:'PJTID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13362',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV16PjtID',fld:'vPJTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00362_A155PjtID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00363_A155PjtID = new int[1] ;
         H00363_A157PjtNome = new string[] {""} ;
         A157PjtNome = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.clientepjtipoview__default(),
            new Object[][] {
                new Object[] {
               H00362_A155PjtID
               }
               , new Object[] {
               H00363_A155PjtID, H00363_A157PjtNome
               }
            }
         );
      ...
      private int AV16PjtID ;
      private int wcpOAV16PjtID ;
      ...
      private int[] H00362_A155PjtID ;
      private int[] H00363_A155PjtID ;
      private string[] H00363_A157PjtNome ;
   ...
   public class clientepjtipoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV16PjtID",GXType.Int32,9,0)
          };
          Object[] prmH00363;
          ...
          def= new CursorDef[] {
              new CursorDef("H00362", "SELECT PjtID FROM tb_clientepjtipo WHERE PjtID = :AV16PjtID ORDER BY PjtID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00362,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00363", "SELECT PjtID, PjtNome FROM tb_clientepjtipo WHERE PjtID = :AV16PjtID ORDER BY PjtID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00363,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
