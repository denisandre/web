   ...
   public class iteracao : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Iteração", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void CheckExtendedTable1238( )
      {
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 é obrigatório.", "Descrição da Iteração", "", "", "", "", "", "", "", ""), 1, "ITENOME");
            AnyError = 1;
            GX_FocusControl = edtIteNome_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Title = "Iteração";
