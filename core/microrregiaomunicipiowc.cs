...
namespace GeneXus.Programs.core {
   public class microrregiaomunicipiowc : GXWebComponent
   {
      public microrregiaomunicipiowc( )
      {
      ...
      public microrregiaomunicipiowc( IGxContext context )
      {
      ...
      public void execute( int aP0_MunicipioMicroID )
      {
         this.AV8MunicipioMicroID = aP0_MunicipioMicroID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "MunicipioMicroID");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8MunicipioMicroID = (int)(Math.Round(NumberUtil.Val( GetPar( "MunicipioMicroID"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8MunicipioMicroID", StringUtil.LTrimStr( (decimal)(AV8MunicipioMicroID), 9, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8MunicipioMicroID});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27IsAuthorized_MunicipioNome = StringUtil.StrToBool( GetPar( "IsAuthorized_MunicipioNome"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8MunicipioMicroID, AV20ManageFiltersExecutionStep, AV28Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_MunicipioNome, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV28Pgmname = "core.microrregiaomunicipioWC";
               WS4K2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "microrregiaomunicipio WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "core.microrregiaomunicipiowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8MunicipioMicroID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.microrregiaomunicipiowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_MUNICIPIONOME", AV27IsAuthorized_MunicipioNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MUNICIPIONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MunicipioNome, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8MunicipioMicroID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8MunicipioMicroID), 9, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMUNICIPIOMICROID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MunicipioMicroID), 9, 0, ",", "")));
      ...
      {
         return "core.microrregiaomunicipioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "microrregiaomunicipio WC" ;
      }
      ...
      protected void WB4K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.microrregiaomunicipiowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            wb_table1_16_4K2( true) ;
         }
         else
         {
            wb_table1_16_4K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_4K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 31 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMunicipioMicroID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A37MunicipioMicroID), 11, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A37MunicipioMicroID), "ZZZ,ZZZ,ZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMunicipioMicroID_Jsonclick, 0, "Attribute", "", "", "", "", edtMunicipioMicroID_Visible, 0, 0, "text", "", 11, "chr", 1, "row", 11, 0, 0, 0, 0, -1, 0, true, "core\\ID", "end", false, "", "HLP_core\\microrregiaomunicipioWC.htm");
            /* User Defined Control */
      ...
      protected void START4K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "microrregiaomunicipio WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.microrregiaomunicipiowc.aspx")), "core.microrregiaomunicipiowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.microrregiaomunicipiowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV8MunicipioMicroID ,
                                       short AV20ManageFiltersExecutionStep ,
                                       string AV28Pgmname ,
                                       short AV14OrderedBy ,
                                       bool AV15OrderedDsc ,
                                       bool AV27IsAuthorized_MunicipioNome ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF4K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H004K2 */
            pr_default.execute(0, new Object[] {AV8MunicipioMicroID, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_31_idx = 1;
            sGXsfl_31_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_31_idx), 4, 0), 4, "0");
            SubsflControlProps_312( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A37MunicipioMicroID = H004K2_A37MunicipioMicroID[0];
               AssignAttri(sPrefix, false, "A37MunicipioMicroID", StringUtil.LTrimStr( (decimal)(A37MunicipioMicroID), 9, 0));
               A36MunicipioNome = H004K2_A36MunicipioNome[0];
               A35MunicipioID = H004K2_A35MunicipioID[0];
               E174K2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H004K3 */
         pr_default.execute(1, new Object[] {AV8MunicipioMicroID, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP4K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8MunicipioMicroID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MunicipioMicroID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E154K2( )
      {
         ...
         GXt_boolean1 = AV27IsAuthorized_MunicipioNome;
         ...
         AV27IsAuthorized_MunicipioNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV27IsAuthorized_MunicipioNome", AV27IsAuthorized_MunicipioNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MUNICIPIONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MunicipioNome, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtMunicipioMicroID_Visible = 0;
         AssignProp(sPrefix, false, edtMunicipioMicroID_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMunicipioMicroID_Visible), 5, 0), true);
      ...
      private void E174K2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         if ( AV27IsAuthorized_MunicipioNome )
         {
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
      ...
      protected void E114K2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("core.microrregiaomunicipioWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV28Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("core.microrregiaomunicipioWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "core.microrregiaomunicipioWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "core.microrregiaomunicipioWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "core.municipio";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "MunicipioMicroID";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8MunicipioMicroID), 9, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_16_4K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_4K2( true) ;
         }
         else
         {
            wb_table2_21_4K2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_4K2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_4K2e( true) ;
         }
         else
         {
            wb_table1_16_4K2e( false) ;
         }
      }

      protected void wb_table2_21_4K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8MunicipioMicroID = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8MunicipioMicroID", StringUtil.LTrimStr( (decimal)(AV8MunicipioMicroID), 9, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8MunicipioMicroID = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\microrregiaomunicipiowc", GetJustCreated( ));
         ...
         {
            AV8MunicipioMicroID = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8MunicipioMicroID", StringUtil.LTrimStr( (decimal)(AV8MunicipioMicroID), 9, 0));
         }
         wcpOAV8MunicipioMicroID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MunicipioMicroID"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8MunicipioMicroID != wcpOAV8MunicipioMicroID ) ) )
         {
            setjustcreated();
         }
         wcpOAV8MunicipioMicroID = AV8MunicipioMicroID;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8MunicipioMicroID = cgiGet( sPrefix+"AV8MunicipioMicroID_CTRL");
         if ( StringUtil.Len( sCtrlAV8MunicipioMicroID) > 0 )
         {
            AV8MunicipioMicroID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8MunicipioMicroID), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8MunicipioMicroID", StringUtil.LTrimStr( (decimal)(AV8MunicipioMicroID), 9, 0));
         }
         else
         {
            AV8MunicipioMicroID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8MunicipioMicroID_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8MunicipioMicroID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MunicipioMicroID), 9, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8MunicipioMicroID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8MunicipioMicroID_CTRL", StringUtil.RTrim( sCtrlAV8MunicipioMicroID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382811589", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("core/microrregiaomunicipiowc.js", "?202382811589", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtMunicipioID_Internalname = sPrefix+"MUNICIPIOID_"+sGXsfl_31_idx;
         edtMunicipioNome_Internalname = sPrefix+"MUNICIPIONOME_"+sGXsfl_31_idx;
      }

      protected void SubsflControlProps_fel_312( )
      {
         edtMunicipioID_Internalname = sPrefix+"MUNICIPIOID_"+sGXsfl_31_fel_idx;
         edtMunicipioNome_Internalname = sPrefix+"MUNICIPIONOME_"+sGXsfl_31_fel_idx;
      }
      ...
      protected void init_default_properties( )
      {
         ...
         edtMunicipioMicroID_Internalname = sPrefix+"MUNICIPIOMICROID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:MunicipioID|1:MunicipioNome";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E124K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MunicipioMicroID',fld:'vMUNICIPIOMICROID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MunicipioNome',fld:'vISAUTHORIZED_MUNICIPIONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E134K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MunicipioMicroID',fld:'vMUNICIPIOMICROID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MunicipioNome',fld:'vISAUTHORIZED_MUNICIPIONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E144K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MunicipioMicroID',fld:'vMUNICIPIOMICROID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MunicipioNome',fld:'vISAUTHORIZED_MUNICIPIONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174K2',iparms:[{av:'AV27IsAuthorized_MunicipioNome',fld:'vISAUTHORIZED_MUNICIPIONOME',pic:'',hsh:true},{av:'A35MunicipioID',fld:'MUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtMunicipioNome_Link',ctrl:'MUNICIPIONOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E114K2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MunicipioMicroID',fld:'vMUNICIPIOMICROID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MunicipioNome',fld:'vISAUTHORIZED_MUNICIPIONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Municipionome',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H004K2_A37MunicipioMicroID = new int[1] ;
         H004K2_A36MunicipioNome = new string[] {""} ;
         H004K2_A35MunicipioID = new int[1] ;
         ...
         sCtrlAV8MunicipioMicroID = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.microrregiaomunicipiowc__default(),
            new Object[][] {
                new Object[] {
               H004K2_A37MunicipioMicroID, H004K2_A36MunicipioNome, H004K2_A35MunicipioID
               }
               , new Object[] {
      ...
      private int AV8MunicipioMicroID ;
      private int wcpOAV8MunicipioMicroID ;
      ...
      private string sCtrlAV8MunicipioMicroID ;
      ...
      private bool AV27IsAuthorized_MunicipioNome ;
      ...
      private int[] H004K2_A37MunicipioMicroID ;
      private string[] H004K2_A36MunicipioNome ;
      private int[] H004K2_A35MunicipioID ;
   ...
   public class microrregiaomunicipiowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8MunicipioMicroID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " MunicipioMicroID, MunicipioNome, MunicipioID";
         sFromString = " FROM tbibge_municipio";
         sOrderString = "";
         AddWhere(sWhereString, "(MunicipioMicroID = :AV8MunicipioMicroID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(MunicipioID,'999999999'), 2) like '%' || :lV16FilterFullText) or ( MunicipioNome like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY MunicipioMicroID, MunicipioNome, MunicipioID";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MunicipioMicroID DESC, MunicipioNome DESC, MunicipioID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY MunicipioMicroID, MunicipioID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MunicipioMicroID DESC, MunicipioID DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004K2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H004K3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8MunicipioMicroID",GXType.Int32,9,0) ,
