...
namespace GeneXus.Programs.core {
   public class municipioview : GXDataArea
   {
      ...
      public municipioview( IGxContext context )
      {
      ...
      public void execute( int aP0_MunicipioID ,
                           string aP1_TabCode )
      {
         this.AV10MunicipioID = aP0_MunicipioID;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.municipioview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MunicipioID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.municipioview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMUNICIPIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10MunicipioID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vMUNICIPIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MunicipioID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "MUNICIPIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A35MunicipioID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV14RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV14RecordDescription, "")), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.municipioview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10MunicipioID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.municipioview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.municipioView" ;
      }

      public override string GetPgmdesc( )
      {
         return "municipio View" ;
      }
      ...
      protected void WB4L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Municípios", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\municipioView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\municipioView.htm");
            /* Div Control */
      ...
      protected void START4L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "municipio View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4L2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.municipioview.aspx")), "core.municipioview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.municipioview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10MunicipioID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10MunicipioID", StringUtil.LTrimStr( (decimal)(AV10MunicipioID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vMUNICIPIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MunicipioID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF4L2( )
      {
         ...
         {
            /* Using cursor H004L2 */
            pr_default.execute(0, new Object[] {AV10MunicipioID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A35MunicipioID = H004L2_A35MunicipioID[0];
               /* Execute user event: Load */
               E164L2 ();
      ...
      protected void E144L2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.municipioww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004L3 */
         pr_default.execute(1, new Object[] {AV10MunicipioID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A35MunicipioID = H004L3_A35MunicipioID[0];
            A36MunicipioNome = H004L3_A36MunicipioNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A36MunicipioNome;
      ...
      protected void E154L2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "municipio",  StringUtil.Trim( StringUtil.Str( (decimal)(A35MunicipioID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "municipio",  2) )
         {
      ...
      protected void E114L2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"municipio",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A35MunicipioID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E124L2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"municipio",StringUtil.Trim( StringUtil.Str( (decimal)(A35MunicipioID), 9, 0)),(string)AV14RecordDescription,formatLink("core.municipioview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.municipioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.municipiogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.municipioGeneral";
               WebComp_Generalwc_Component = "core.municipioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10MunicipioID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10MunicipioID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10MunicipioID", StringUtil.LTrimStr( (decimal)(AV10MunicipioID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vMUNICIPIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10MunicipioID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828223025", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/municipioview.js", "?2023828223026", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A35MunicipioID',fld:'MUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10MunicipioID',fld:'vMUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E114L2',iparms:[{av:'A35MunicipioID',fld:'MUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E124L2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A35MunicipioID',fld:'MUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E134L2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10MunicipioID',fld:'vMUNICIPIOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H004L2_A35MunicipioID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004L3_A35MunicipioID = new int[1] ;
         H004L3_A36MunicipioNome = new string[] {""} ;
         A36MunicipioNome = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.municipioview__default(),
            new Object[][] {
                new Object[] {
               H004L2_A35MunicipioID
               }
               , new Object[] {
               H004L3_A35MunicipioID, H004L3_A36MunicipioNome
               }
            }
         );
      ...
      private int AV10MunicipioID ;
      private int wcpOAV10MunicipioID ;
      ...
      private int[] H004L2_A35MunicipioID ;
      private int[] H004L3_A35MunicipioID ;
      private string[] H004L3_A36MunicipioNome ;
   ...
   public class municipioview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10MunicipioID",GXType.Int32,9,0)
          };
          Object[] prmH004L3;
          ...
          def= new CursorDef[] {
              new CursorDef("H004L2", "SELECT MunicipioID FROM tbibge_municipio WHERE MunicipioID = :AV10MunicipioID ORDER BY MunicipioID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004L2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004L3", "SELECT MunicipioID, MunicipioNome FROM tbibge_municipio WHERE MunicipioID = :AV10MunicipioID ORDER BY MunicipioID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004L3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
