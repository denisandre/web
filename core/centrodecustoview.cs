...
namespace GeneXus.Programs.core {
   public class centrodecustoview : GXDataArea
   {
      ...
      public centrodecustoview( IGxContext context )
      {
      ...
      {
         get {
            return "centrodecustoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.centrodecustoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CcuID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.centrodecustoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCCUID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CcuID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCCUID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CcuID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.centrodecustoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10CcuID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.centrodecustoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.CentroDeCustoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Centro De Custo View" ;
      }
      ...
      protected void WB3C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Centro De Custo", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\CentroDeCustoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\CentroDeCustoView.htm");
            /* Div Control */
      ...
      protected void START3C2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Centro De Custo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA3C2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.centrodecustoview.aspx")), "core.centrodecustoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.centrodecustoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10CcuID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10CcuID", StringUtil.LTrimStr( (decimal)(AV10CcuID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vCCUID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CcuID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF3C2( )
      {
         ...
         {
            /* Using cursor H003C2 */
            pr_default.execute(0, new Object[] {AV10CcuID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A208CcuID = H003C2_A208CcuID[0];
               /* Execute user event: Load */
               E163C2 ();
      ...
      protected void E143C2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.centrodecustoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003C3 */
         pr_default.execute(1, new Object[] {AV10CcuID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A208CcuID = H003C3_A208CcuID[0];
            A210CcuNome = H003C3_A210CcuNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A210CcuNome;
      ...
      protected void E153C2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "CentroDeCusto",  StringUtil.Trim( StringUtil.Str( (decimal)(A208CcuID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "CentroDeCusto",  2) )
         {
      ...
      protected void E113C2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"CentroDeCusto",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A208CcuID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E123C2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"CentroDeCusto",StringUtil.Trim( StringUtil.Str( (decimal)(A208CcuID), 9, 0)),(string)AV14RecordDescription,formatLink("core.centrodecustoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.CentroDeCustoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.centrodecustogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.CentroDeCustoGeneral";
               WebComp_Generalwc_Component = "core.CentroDeCustoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10CcuID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10CcuID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10CcuID", StringUtil.LTrimStr( (decimal)(AV10CcuID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCCUID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10CcuID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828212687", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/centrodecustoview.js", "?2023828212687", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Centro De Custo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A208CcuID',fld:'CCUID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10CcuID',fld:'vCCUID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E113C2',iparms:[{av:'A208CcuID',fld:'CCUID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E123C2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A208CcuID',fld:'CCUID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E133C2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10CcuID',fld:'vCCUID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H003C2_A208CcuID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H003C3_A208CcuID = new int[1] ;
         H003C3_A210CcuNome = new string[] {""} ;
         A210CcuNome = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.centrodecustoview__default(),
            new Object[][] {
                new Object[] {
               H003C2_A208CcuID
               }
               , new Object[] {
               H003C3_A208CcuID, H003C3_A210CcuNome
               }
            }
         );
      ...
      private int AV10CcuID ;
      private int wcpOAV10CcuID ;
      ...
      private int[] H003C2_A208CcuID ;
      private int[] H003C3_A208CcuID ;
      private string[] H003C3_A210CcuNome ;
   ...
   public class centrodecustoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10CcuID",GXType.Int32,9,0)
          };
          Object[] prmH003C3;
          ...
          def= new CursorDef[] {
              new CursorDef("H003C2", "SELECT CcuID FROM tb_centrodecusto WHERE CcuID = :AV10CcuID ORDER BY CcuID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003C3", "SELECT CcuID, CcuNome FROM tb_centrodecusto WHERE CcuID = :AV10CcuID ORDER BY CcuID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
