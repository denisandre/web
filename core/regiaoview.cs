...
namespace GeneXus.Programs.core {
   public class regiaoview : GXDataArea
   {
      public regiaoview( )
      {
      ...
      public regiaoview( IGxContext context )
      {
      ...
      public void execute( int aP0_RegiaoID ,
                           string aP1_TabCode )
      {
         this.AV10RegiaoID = aP0_RegiaoID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "RegiaoID");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.regiaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10RegiaoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.regiaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vREGIAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10RegiaoID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vREGIAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RegiaoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "REGIAOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A1RegiaoID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV15RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV15RecordDescription, "")), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Ufwc == null ) )
         {
            WebComp_Ufwc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.regiaoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10RegiaoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.regiaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.regiaoView" ;
      }
      ...
      protected void WB450( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Regiões", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\regiaoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\regiaoView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUf_title_Internalname, "UF", "", "", lblUf_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\regiaoView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "uf") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableuf_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Ufwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Ufwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldUfwc), StringUtil.Lower( WebComp_Ufwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Ufwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldUfwc), StringUtil.Lower( WebComp_Ufwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START452( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "regiao View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldUfwc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldUfwc) == 0 ) || ( StringUtil.StrCmp(OldUfwc, WebComp_Ufwc_Component) != 0 ) )
                           {
                              WebComp_Ufwc = getWebComponent(GetType(), "GeneXus.Programs", OldUfwc, new Object[] {context} );
                              WebComp_Ufwc.ComponentInit();
                              WebComp_Ufwc.Name = "OldUfwc";
                              WebComp_Ufwc_Component = OldUfwc;
                           }
                           if ( StringUtil.Len( WebComp_Ufwc_Component) != 0 )
                           {
                              WebComp_Ufwc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Ufwc_Component = OldUfwc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PA452( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.regiaoview.aspx")), "core.regiaoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.regiaoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10RegiaoID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10RegiaoID", StringUtil.LTrimStr( (decimal)(AV10RegiaoID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vREGIAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RegiaoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF452( )
      {
         ...
         {
            /* Using cursor H00452 */
            pr_default.execute(0, new Object[] {AV10RegiaoID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1RegiaoID = H00452_A1RegiaoID[0];
               /* Execute user event: Load */
               E16452 ();
      ...
      protected void E14452( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.regiaoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00453 */
         pr_default.execute(1, new Object[] {AV10RegiaoID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A1RegiaoID = H00453_A1RegiaoID[0];
            A2RegiaoSigla = H00453_A2RegiaoSigla[0];
            AV17GXLvl9 = 1;
            Form.Caption = A2RegiaoSigla;
      ...
      protected void E15452( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "regiao",  StringUtil.Trim( StringUtil.Str( (decimal)(A1RegiaoID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "regiao",  2) )
         {
      ...
      protected void E11452( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"regiao",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A1RegiaoID), 9, 0)),(string)AV15RecordDescription});
      ...
      protected void E12452( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "core.regiaoview.aspx"+UrlEncode(StringUtil.LTrimStr(A1RegiaoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(""));
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"regiao",StringUtil.Trim( StringUtil.Str( (decimal)(A1RegiaoID), 9, 0)),(string)AV15RecordDescription,formatLink("core.regiaoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.regiaoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.regiaogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.regiaoGeneral";
               WebComp_Generalwc_Component = "core.regiaoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10RegiaoID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "uf") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Ufwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Ufwc_Component), StringUtil.Lower( "core.regiaoufWC")) != 0 )
            {
               WebComp_Ufwc = getWebComponent(GetType(), "GeneXus.Programs", "core.regiaoufwc", new Object[] {context} );
               WebComp_Ufwc.ComponentInit();
               WebComp_Ufwc.Name = "core.regiaoufWC";
               WebComp_Ufwc_Component = "core.regiaoufWC";
            }
            if ( StringUtil.Len( WebComp_Ufwc_Component) != 0 )
            {
               WebComp_Ufwc.setjustcreated();
               WebComp_Ufwc.componentprepare(new Object[] {(string)"W0037",(string)"",(int)AV10RegiaoID});
               WebComp_Ufwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Ufwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Ufwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void S122( )
      {
         ...
         /* Optimized group. */
         /* Using cursor H00454 */
         pr_default.execute(2, new Object[] {AV10RegiaoID});
         cV13TabRecordsCount = H00454_AV13TabRecordsCount[0];
         pr_default.close(2);
         AV13TabRecordsCount = (long)(AV13TabRecordsCount+cV13TabRecordsCount*1);
         /* End optimized group. */
         this.executeExternalObjectMethod("", false, "WWPActions", "Tabs_EditCaption", new Object[] {(string)divLayoutmaintable_Internalname,(string)"Tabs",(string)"uf",StringUtil.Format( "%1 (%2)", "UF", StringUtil.Trim( context.localUtil.Format( (decimal)(AV13TabRecordsCount), "Z,ZZZ,ZZZ,ZZ9")), "", "", "", "", "", "", ""),(bool)false,(string)""}, false);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10RegiaoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10RegiaoID", StringUtil.LTrimStr( (decimal)(AV10RegiaoID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vREGIAOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10RegiaoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828221739", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/regiaoview.js", "?2023828221739", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblUf_title_Internalname = "UF_TITLE";
         divUnnamedtableuf_Internalname = "UNNAMEDTABLEUF";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A1RegiaoID',fld:'REGIAOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10RegiaoID',fld:'vREGIAOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11452',iparms:[{av:'A1RegiaoID',fld:'REGIAOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12452',iparms:[{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A1RegiaoID',fld:'REGIAOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13452',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10RegiaoID',fld:'vREGIAOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'},{ctrl:'UFWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblUf_title_Jsonclick = "";
         WebComp_Ufwc_Component = "";
         OldUfwc = "";
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00452_A1RegiaoID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00453_A1RegiaoID = new int[1] ;
         H00453_A2RegiaoSigla = new string[] {""} ;
         A2RegiaoSigla = "";
         AV16Session = context.GetSession();
         H00454_AV13TabRecordsCount = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.regiaoview__default(),
            new Object[][] {
                new Object[] {
               H00452_A1RegiaoID
               }
               , new Object[] {
               H00453_A1RegiaoID, H00453_A2RegiaoSigla
               }
               , new Object[] {
               H00454_AV13TabRecordsCount
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Ufwc = new GeneXus.Http.GXNullWebComponent();
      ...
      private int AV10RegiaoID ;
      private int wcpOAV10RegiaoID ;
      ...
      private string lblUf_title_Internalname ;
      private string lblUf_title_Jsonclick ;
      private string divUnnamedtableuf_Internalname ;
      private string WebComp_Ufwc_Component ;
      private string OldUfwc ;
      ...
      private int[] H00452_A1RegiaoID ;
      private int[] H00453_A1RegiaoID ;
      private string[] H00453_A2RegiaoSigla ;
      private long[] H00454_AV13TabRecordsCount ;
   ...
   public class regiaoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10RegiaoID",GXType.Int32,9,0)
          };
          Object[] prmH00453;
          ...
          def= new CursorDef[] {
              new CursorDef("H00452", "SELECT RegiaoID FROM tbibge_regiao WHERE RegiaoID = :AV10RegiaoID ORDER BY RegiaoID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00452,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00453", "SELECT RegiaoID, RegiaoSigla FROM tbibge_regiao WHERE RegiaoID = :AV10RegiaoID ORDER BY RegiaoID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00453,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00454", "SELECT COUNT(*) FROM tbibge_uf WHERE UFRegID = :AV10RegiaoID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00454,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
