...
namespace GeneXus.Programs.core {
   public class contatotipoww : GXDataArea
   {
      ...
      protected void S202( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV35ColumnsSelector,  "CotNome",  "",  "Descrição",  true,  "") ;
      ...
      protected void S192( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "COTDEL_FILTRO",  "Excluído",  !(false==AV73CotDel_Filtro),  0,  StringUtil.Trim( StringUtil.BoolToStr( AV73CotDel_Filtro)),  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFCOTNOME",  "Descrição",  !String.IsNullOrEmpty(StringUtil.RTrim( AV70TFCotNome)),  0,  AV70TFCotNome,  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV71TFCotNome_Sel)),  AV71TFCotNome_Sel,  "") ;
         /* Execute user subroutine: 'SAVEDYNFILTERSSTATE' */
         S212 ();
         if ( returnInSub )
         {
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavDynamicfiltersselector1.addItem("COTNOME", "Descrição", 0);
         if ( cmbavDynamicfiltersselector1.ItemCount > 0 )
         {
            AV18DynamicFiltersSelector1 = cmbavDynamicfiltersselector1.getValidValue(AV18DynamicFiltersSelector1);
            AssignAttri("", false, "AV18DynamicFiltersSelector1", AV18DynamicFiltersSelector1);
         ...
         cmbavDynamicfiltersselector2.addItem("COTNOME", "Descrição", 0);
         if ( cmbavDynamicfiltersselector2.ItemCount > 0 )
         {
            AV22DynamicFiltersSelector2 = cmbavDynamicfiltersselector2.getValidValue(AV22DynamicFiltersSelector2);
            AssignAttri("", false, "AV22DynamicFiltersSelector2", AV22DynamicFiltersSelector2);
         ...
         cmbavDynamicfiltersselector3.addItem("COTNOME", "Descrição", 0);
         if ( cmbavDynamicfiltersselector3.ItemCount > 0 )
         {
            AV26DynamicFiltersSelector3 = cmbavDynamicfiltersselector3.getValidValue(AV26DynamicFiltersSelector3);
            AssignAttri("", false, "AV26DynamicFiltersSelector3", AV26DynamicFiltersSelector3);
