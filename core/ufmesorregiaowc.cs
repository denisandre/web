...
namespace GeneXus.Programs.core {
   public class ufmesorregiaowc : GXWebComponent
   {
      public ufmesorregiaowc( )
      {
      ...
      public ufmesorregiaowc( IGxContext context )
      {
      ...
      public void execute( int aP0_MesorregiaoUFID )
      {
         this.AV8MesorregiaoUFID = aP0_MesorregiaoUFID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "MesorregiaoUFID");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8MesorregiaoUFID = (int)(Math.Round(NumberUtil.Val( GetPar( "MesorregiaoUFID"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8MesorregiaoUFID", StringUtil.LTrimStr( (decimal)(AV8MesorregiaoUFID), 9, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8MesorregiaoUFID});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27IsAuthorized_MesorregiaoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_MesorregiaoNome"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8MesorregiaoUFID, AV20ManageFiltersExecutionStep, AV28Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_MesorregiaoNome, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV28Pgmname = "core.ufmesorregiaoWC";
               WS4C2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "ufmesorregiao WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "core.ufmesorregiaowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8MesorregiaoUFID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.ufmesorregiaowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_MESORREGIAONOME", AV27IsAuthorized_MesorregiaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MESORREGIAONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MesorregiaoNome, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8MesorregiaoUFID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8MesorregiaoUFID), 9, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMESORREGIAOUFID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MesorregiaoUFID), 9, 0, ",", "")));
      ...
      {
         return "core.ufmesorregiaoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "ufmesorregiao WC" ;
      }
      ...
      protected void WB4C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.ufmesorregiaowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            wb_table1_16_4C2( true) ;
         }
         else
         {
            wb_table1_16_4C2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_4C2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 31 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMesorregiaoUFID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A15MesorregiaoUFID), 11, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A15MesorregiaoUFID), "ZZZ,ZZZ,ZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMesorregiaoUFID_Jsonclick, 0, "Attribute", "", "", "", "", edtMesorregiaoUFID_Visible, 0, 0, "text", "", 11, "chr", 1, "row", 11, 0, 0, 0, 0, -1, 0, true, "core\\ID", "end", false, "", "HLP_core\\ufmesorregiaoWC.htm");
            /* User Defined Control */
      ...
      protected void START4C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "ufmesorregiao WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.ufmesorregiaowc.aspx")), "core.ufmesorregiaowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.ufmesorregiaowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV8MesorregiaoUFID ,
                                       short AV20ManageFiltersExecutionStep ,
                                       string AV28Pgmname ,
                                       short AV14OrderedBy ,
                                       bool AV15OrderedDsc ,
                                       bool AV27IsAuthorized_MesorregiaoNome ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF4C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H004C2 */
            pr_default.execute(0, new Object[] {AV8MesorregiaoUFID, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_31_idx = 1;
            sGXsfl_31_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_31_idx), 4, 0), 4, "0");
            SubsflControlProps_312( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A15MesorregiaoUFID = H004C2_A15MesorregiaoUFID[0];
               AssignAttri(sPrefix, false, "A15MesorregiaoUFID", StringUtil.LTrimStr( (decimal)(A15MesorregiaoUFID), 9, 0));
               A13MesorregiaoID = H004C2_A13MesorregiaoID[0];
               A14MesorregiaoNome = H004C2_A14MesorregiaoNome[0];
               E174C2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H004C3 */
         pr_default.execute(1, new Object[] {AV8MesorregiaoUFID, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP4C0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8MesorregiaoUFID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MesorregiaoUFID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E154C2( )
      {
         ...
         GXt_boolean1 = AV27IsAuthorized_MesorregiaoNome;
         ...
         AV27IsAuthorized_MesorregiaoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV27IsAuthorized_MesorregiaoNome", AV27IsAuthorized_MesorregiaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MESORREGIAONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MesorregiaoNome, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtMesorregiaoUFID_Visible = 0;
         AssignProp(sPrefix, false, edtMesorregiaoUFID_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMesorregiaoUFID_Visible), 5, 0), true);
      ...
      private void E174C2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         if ( AV27IsAuthorized_MesorregiaoNome )
         {
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
      ...
      protected void E114C2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("core.ufmesorregiaoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV28Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("core.ufmesorregiaoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "core.ufmesorregiaoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "core.ufmesorregiaoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "core.mesorregiao";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "MesorregiaoUFID";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8MesorregiaoUFID), 9, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_16_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_4C2( true) ;
         }
         else
         {
            wb_table2_21_4C2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_4C2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_4C2e( true) ;
         }
         else
         {
            wb_table1_16_4C2e( false) ;
         }
      }

      protected void wb_table2_21_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_21_4C2e( true) ;
         }
         else
         {
            wb_table2_21_4C2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8MesorregiaoUFID = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8MesorregiaoUFID", StringUtil.LTrimStr( (decimal)(AV8MesorregiaoUFID), 9, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8MesorregiaoUFID = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\ufmesorregiaowc", GetJustCreated( ));
         ...
         {
            AV8MesorregiaoUFID = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8MesorregiaoUFID", StringUtil.LTrimStr( (decimal)(AV8MesorregiaoUFID), 9, 0));
         }
         wcpOAV8MesorregiaoUFID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MesorregiaoUFID"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8MesorregiaoUFID != wcpOAV8MesorregiaoUFID ) ) )
         {
            setjustcreated();
         }
         wcpOAV8MesorregiaoUFID = AV8MesorregiaoUFID;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8MesorregiaoUFID = cgiGet( sPrefix+"AV8MesorregiaoUFID_CTRL");
         if ( StringUtil.Len( sCtrlAV8MesorregiaoUFID) > 0 )
         {
            AV8MesorregiaoUFID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8MesorregiaoUFID), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8MesorregiaoUFID", StringUtil.LTrimStr( (decimal)(AV8MesorregiaoUFID), 9, 0));
         }
         else
         {
            AV8MesorregiaoUFID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8MesorregiaoUFID_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8MesorregiaoUFID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MesorregiaoUFID), 9, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8MesorregiaoUFID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8MesorregiaoUFID_CTRL", StringUtil.RTrim( sCtrlAV8MesorregiaoUFID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828105679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("core/ufmesorregiaowc.js", "?2023828105679", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtMesorregiaoNome_Internalname = sPrefix+"MESORREGIAONOME_"+sGXsfl_31_idx;
         edtMesorregiaoID_Internalname = sPrefix+"MESORREGIAOID_"+sGXsfl_31_idx;
      }

      protected void SubsflControlProps_fel_312( )
      {
         edtMesorregiaoNome_Internalname = sPrefix+"MESORREGIAONOME_"+sGXsfl_31_fel_idx;
         edtMesorregiaoID_Internalname = sPrefix+"MESORREGIAOID_"+sGXsfl_31_fel_idx;
      }
      ...
      protected void init_default_properties( )
      {
         ...
         edtMesorregiaoUFID_Internalname = sPrefix+"MESORREGIAOUFID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:MesorregiaoNome|1:MesorregiaoID";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E144C2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MesorregiaoUFID',fld:'vMESORREGIAOUFID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MesorregiaoNome',fld:'vISAUTHORIZED_MESORREGIAONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174C2',iparms:[{av:'AV27IsAuthorized_MesorregiaoNome',fld:'vISAUTHORIZED_MESORREGIAONOME',pic:'',hsh:true},{av:'A13MesorregiaoID',fld:'MESORREGIAOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtMesorregiaoNome_Link',ctrl:'MESORREGIAONOME',prop:'Link'}]}");
         ...
         setEventMetadata("NULL","{handler:'Valid_Mesorregiaoid',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H004C2_A15MesorregiaoUFID = new int[1] ;
         H004C2_A13MesorregiaoID = new int[1] ;
         H004C2_A14MesorregiaoNome = new string[] {""} ;
         ...
         sCtrlAV8MesorregiaoUFID = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.ufmesorregiaowc__default(),
            new Object[][] {
                new Object[] {
               H004C2_A15MesorregiaoUFID, H004C2_A13MesorregiaoID, H004C2_A14MesorregiaoNome
               }
               , new Object[] {
      ...
      private int AV8MesorregiaoUFID ;
      private int wcpOAV8MesorregiaoUFID ;
      ...
      private string sCtrlAV8MesorregiaoUFID ;
      ...
      private bool AV27IsAuthorized_MesorregiaoNome ;
      ...
      private int[] H004C2_A15MesorregiaoUFID ;
      private int[] H004C2_A13MesorregiaoID ;
      private string[] H004C2_A14MesorregiaoNome ;
   ...
   public class ufmesorregiaowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8MesorregiaoUFID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " MesorregiaoUFID, MesorregiaoID, MesorregiaoNome";
         sFromString = " FROM tbibge_mesorregiao";
         sOrderString = "";
         AddWhere(sWhereString, "(MesorregiaoUFID = :AV8MesorregiaoUFID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( MesorregiaoNome like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(MesorregiaoID,'999999999'), 2) like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY MesorregiaoUFID, MesorregiaoNome, MesorregiaoID";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MesorregiaoUFID DESC, MesorregiaoNome DESC, MesorregiaoID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY MesorregiaoUFID, MesorregiaoID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MesorregiaoUFID DESC, MesorregiaoID DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004C2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H004C3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8MesorregiaoUFID",GXType.Int32,9,0) ,
