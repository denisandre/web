   ...
   public class mesorregiaoview : GXDataArea
   {
      ...
      protected void WB4D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Mesorregiões", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\mesorregiaoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMicrorregiao_title_Internalname, "Microrregiões", "", "", lblMicrorregiao_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\mesorregiaoView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
      ...
      protected void S122( )
      {
         ...
         /* End optimized group. */
         this.executeExternalObjectMethod("", false, "WWPActions", "Tabs_EditCaption", new Object[] {(string)divLayoutmaintable_Internalname,(string)"Tabs",(string)"microrregiao",StringUtil.Format( "%1 (%2)", "Microrregiões", StringUtil.Trim( context.localUtil.Format( (decimal)(AV13TabRecordsCount), "Z,ZZZ,ZZZ,ZZ9")), "", "", "", "", "", "", ""),(bool)false,(string)""}, false);
      }
