...
namespace GeneXus.Programs.core {
   public class documentoarquivoview : GXDataArea
   {
      public documentoarquivoview( )
      {
      ...
      public documentoarquivoview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_DocID ,
                           ...
                           string aP2_TabCode )
      {
         this.AV10DocID = aP0_DocID;
         this.AV11DocArqSeq = aP1_DocArqSeq;
      ...
      {
         get {
            return "documentoarquivoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.documentoarquivoview.aspx"+UrlEncode(AV10DocID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocArqSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.documentoarquivoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDOCID", AV10DocID.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCID", GetSecureSignedToken( "", AV10DocID, context));
         GxWebStd.gx_hidden_field( context, "vDOCARQSEQ", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11DocArqSeq), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCARQSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocArqSeq), "ZZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.documentoarquivoview.aspx"+UrlEncode(AV10DocID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(AV11DocArqSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.documentoarquivoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.DocumentoArquivoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Documento Arquivo View" ;
      }
      ...
      protected void WB5J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Arquivo do Documento", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\DocumentoArquivoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\DocumentoArquivoView.htm");
            /* Div Control */
      ...
      protected void START5J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Documento Arquivo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA5J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.documentoarquivoview.aspx")), "core.documentoarquivoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.documentoarquivoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DocID = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10DocID", AV10DocID.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vDOCID", GetSecureSignedToken( "", AV10DocID, context));
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        AV11DocArqSeq = (short)(Math.Round(NumberUtil.Val( GetPar( "DocArqSeq"), "."), 18, MidpointRounding.ToEven));
                        AssignAttri("", false, "AV11DocArqSeq", StringUtil.LTrimStr( (decimal)(AV11DocArqSeq), 4, 0));
                        GxWebStd.gx_hidden_field( context, "gxhash_vDOCARQSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocArqSeq), "ZZZ9"), context));
      ...
      protected void RF5J2( )
      {
         ...
         {
            /* Using cursor H005J2 */
            pr_default.execute(0, new Object[] {AV10DocID, AV11DocArqSeq});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A307DocArqSeq = H005J2_A307DocArqSeq[0];
               A289DocID = H005J2_A289DocID[0];
               /* Execute user event: Load */
               E165J2 ();
      ...
      protected void E145J2( )
      {
         ...
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.documentoarquivoww.aspx"+UrlEncode(AV10DocID.ToString());
         lblWorkwithlink_Link = formatLink("core.documentoarquivoww.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H005J3 */
         pr_default.execute(1, new Object[] {AV10DocID, AV11DocArqSeq});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A307DocArqSeq = H005J3_A307DocArqSeq[0];
            A289DocID = H005J3_A289DocID[0];
            A308DocArqInsData = H005J3_A308DocArqInsData[0];
            AV17GXLvl9 = 1;
            Form.Caption = context.localUtil.DToC( A308DocArqInsData, 2, "/");
      ...
      protected void E155J2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "DocumentoArquivo",  StringUtil.Trim( A289DocID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A307DocArqSeq), 4, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "DocumentoArquivo",  2) )
         {
      ...
      protected void E115J2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"DocumentoArquivo",(short)2,StringUtil.Trim( A289DocID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A307DocArqSeq), 4, 0)),(string)AV15RecordDescription});
      ...
      protected void E125J2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "core.documentoarquivoview.aspx"+UrlEncode(A289DocID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(A307DocArqSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(""));
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"DocumentoArquivo",StringUtil.Trim( A289DocID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A307DocArqSeq), 4, 0)),(string)AV15RecordDescription,formatLink("core.documentoarquivoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
            WebComp_Wwpaux_wc.componentbind(new Object[] {(string)"",(string)""+""+""+""+""+""+""+""+""+""+"",(string)"",(string)""+""+"",(string)"",(string)""+"",(string)"",(string)"",(string)""+""});
         }
         if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Wwpaux_wc )
         {
            context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0034"+"");
      ...
      protected void S112( )
      {
         ...
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV13SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.DocumentoArquivoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.documentoarquivogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.DocumentoArquivoGeneral";
               WebComp_Generalwc_Component = "core.DocumentoArquivoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(Guid)AV10DocID,(short)AV11DocArqSeq});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DocID = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10DocID", AV10DocID.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCID", GetSecureSignedToken( "", AV10DocID, context));
         AV11DocArqSeq = Convert.ToInt16(getParm(obj,1));
         AssignAttri("", false, "AV11DocArqSeq", StringUtil.LTrimStr( (decimal)(AV11DocArqSeq), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCARQSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11DocArqSeq), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023710125811", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/documentoarquivoview.js", "?2023710125811", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Documento Arquivo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A289DocID',fld:'DOCID',pic:''},{av:'A307DocArqSeq',fld:'DOCARQSEQ',pic:'ZZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10DocID',fld:'vDOCID',pic:'',hsh:true},{av:'AV11DocArqSeq',fld:'vDOCARQSEQ',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E115J2',iparms:[{av:'A289DocID',fld:'DOCID',pic:''},{av:'A307DocArqSeq',fld:'DOCARQSEQ',pic:'ZZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E125J2',iparms:[{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A289DocID',fld:'DOCID',pic:''},{av:'A307DocArqSeq',fld:'DOCARQSEQ',pic:'ZZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E135J2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV12LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV13SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10DocID',fld:'vDOCID',pic:'',hsh:true},{av:'AV11DocArqSeq',fld:'vDOCARQSEQ',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV13SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV12LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H005J2_A307DocArqSeq = new short[1] ;
         H005J2_A289DocID = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H005J3_A307DocArqSeq = new short[1] ;
         H005J3_A289DocID = new Guid[] {Guid.Empty} ;
         H005J3_A308DocArqInsData = new DateTime[] {DateTime.MinValue} ;
         A308DocArqInsData = DateTime.MinValue;
         AV16Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.documentoarquivoview__default(),
            new Object[][] {
                new Object[] {
               H005J2_A307DocArqSeq, H005J2_A289DocID
               }
               , new Object[] {
               H005J3_A307DocArqSeq, H005J3_A289DocID, H005J3_A308DocArqInsData
               }
            }
         );
      ...
      private short AV11DocArqSeq ;
      private short wcpOAV11DocArqSeq ;
      ...
      private Guid AV10DocID ;
      private Guid wcpOAV10DocID ;
      ...
      private short[] H005J2_A307DocArqSeq ;
      private Guid[] H005J2_A289DocID ;
      private short[] H005J3_A307DocArqSeq ;
      private Guid[] H005J3_A289DocID ;
      private DateTime[] H005J3_A308DocArqInsData ;
   ...
   public class documentoarquivoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10DocID",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV11DocArqSeq",GXType.Int16,4,0)
          };
          Object[] prmH005J3;
          ...
          def= new CursorDef[] {
              new CursorDef("H005J2", "SELECT DocArqSeq, DocID FROM tb_documento_arquivo WHERE DocID = :AV10DocID and DocArqSeq = :AV11DocArqSeq ORDER BY DocID, DocArqSeq ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005J2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H005J3", "SELECT DocArqSeq, DocID, DocArqInsData FROM tb_documento_arquivo WHERE (DocID = :AV10DocID and DocArqSeq = :AV11DocArqSeq) AND (DocID = :AV10DocID and DocArqSeq = :AV11DocArqSeq) ORDER BY DocID, DocArqSeq ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005J3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
