...
namespace GeneXus.Programs.core {
   public class clienteww : GXDataArea
   {
      ...
      protected void S202( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV35ColumnsSelector,  "CliMatricula",  "",  "Matrícula",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV35ColumnsSelector,  "CliTipo",  "",  "Tipo",  true,  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV35ColumnsSelector,  "CliInsData",  "",  "Incluído em",  true,  "") ;
      ...
      protected void S192( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFCLIMATRICULA",  "Matrícula",  !((0==AV43TFCliMatricula)&&(0==AV44TFCliMatricula_To)),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV43TFCliMatricula), 12, 0)),  StringUtil.Trim( StringUtil.Str( (decimal)(AV44TFCliMatricula_To), 12, 0))) ;
      ...
      protected void S212( )
      {
         ...
         if ( ! AV30DynamicFiltersIgnoreFirst )
         {
            ...
            {
               AV13GridStateDynamicFilter.gxTpr_Dsc = "Matrícula";
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavDynamicfiltersselector1.addItem("CLIMATRICULA", "Matrícula", 0);
         if ( cmbavDynamicfiltersselector1.ItemCount > 0 )
         {
            AV18DynamicFiltersSelector1 = cmbavDynamicfiltersselector1.getValidValue(AV18DynamicFiltersSelector1);
            AssignAttri("", false, "AV18DynamicFiltersSelector1", AV18DynamicFiltersSelector1);
         ...
         cmbavDynamicfiltersselector2.addItem("CLIMATRICULA", "Matrícula", 0);
         if ( cmbavDynamicfiltersselector2.ItemCount > 0 )
         {
            AV22DynamicFiltersSelector2 = cmbavDynamicfiltersselector2.getValidValue(AV22DynamicFiltersSelector2);
            AssignAttri("", false, "AV22DynamicFiltersSelector2", AV22DynamicFiltersSelector2);
         ...
         cmbavDynamicfiltersselector3.addItem("CLIMATRICULA", "Matrícula", 0);
         if ( cmbavDynamicfiltersselector3.ItemCount > 0 )
         {
            AV26DynamicFiltersSelector3 = cmbavDynamicfiltersselector3.getValidValue(AV26DynamicFiltersSelector3);
            AssignAttri("", false, "AV26DynamicFiltersSelector3", AV26DynamicFiltersSelector3);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistfixedvalues = "||1:Pessoa Física,2:Pessoa Jurídica|";
