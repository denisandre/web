...
namespace GeneXus.Programs.core {
   public class ufview : GXDataArea
   {
      public ufview( )
      {
      ...
      public ufview( IGxContext context )
      {
      ...
      public void execute( int aP0_UFID ,
                           string aP1_TabCode )
      {
         this.AV10UFID = aP0_UFID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "UFID");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.ufview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10UFID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.ufview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vUFID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10UFID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vUFID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10UFID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "UFID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4UFID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV15RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV15RecordDescription, "")), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Mesorregiaowc == null ) )
         {
            WebComp_Mesorregiaowc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.ufview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10UFID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.ufview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      protected void WB490( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a UFs", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\ufView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ufView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMesorregiao_title_Internalname, "Mesorregiões", "", "", lblMesorregiao_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ufView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "mesorregiao") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablemesorregiao_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Mesorregiaowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Mesorregiaowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldMesorregiaowc), StringUtil.Lower( WebComp_Mesorregiaowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Mesorregiaowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldMesorregiaowc), StringUtil.Lower( WebComp_Mesorregiaowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START492( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "uf View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldMesorregiaowc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldMesorregiaowc) == 0 ) || ( StringUtil.StrCmp(OldMesorregiaowc, WebComp_Mesorregiaowc_Component) != 0 ) )
                           {
                              WebComp_Mesorregiaowc = getWebComponent(GetType(), "GeneXus.Programs", OldMesorregiaowc, new Object[] {context} );
                              WebComp_Mesorregiaowc.ComponentInit();
                              WebComp_Mesorregiaowc.Name = "OldMesorregiaowc";
                              WebComp_Mesorregiaowc_Component = OldMesorregiaowc;
                           }
                           if ( StringUtil.Len( WebComp_Mesorregiaowc_Component) != 0 )
                           {
                              WebComp_Mesorregiaowc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Mesorregiaowc_Component = OldMesorregiaowc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PA492( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.ufview.aspx")), "core.ufview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.ufview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10UFID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10UFID", StringUtil.LTrimStr( (decimal)(AV10UFID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vUFID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10UFID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF492( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Mesorregiaowc_Component) != 0 )
               {
                  WebComp_Mesorregiaowc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H00492 */
            pr_default.execute(0, new Object[] {AV10UFID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A4UFID = H00492_A4UFID[0];
               /* Execute user event: Load */
               E16492 ();
      ...
      protected void E14492( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.ufww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H00493 */
         pr_default.execute(1, new Object[] {AV10UFID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A4UFID = H00493_A4UFID[0];
            A5UFSigla = H00493_A5UFSigla[0];
            AV17GXLvl9 = 1;
            Form.Caption = A5UFSigla;
      ...
      protected void E15492( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "uf",  StringUtil.Trim( StringUtil.Str( (decimal)(A4UFID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "uf",  2) )
         {
      ...
      protected void E11492( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"uf",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A4UFID), 9, 0)),(string)AV15RecordDescription});
      ...
      protected void E12492( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"uf",StringUtil.Trim( StringUtil.Str( (decimal)(A4UFID), 9, 0)),(string)AV15RecordDescription,formatLink("core.ufview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ufGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.ufgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ufGeneral";
               WebComp_Generalwc_Component = "core.ufGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10UFID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "mesorregiao") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Mesorregiaowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Mesorregiaowc_Component), StringUtil.Lower( "core.ufmesorregiaoWC")) != 0 )
            {
               WebComp_Mesorregiaowc = getWebComponent(GetType(), "GeneXus.Programs", "core.ufmesorregiaowc", new Object[] {context} );
               WebComp_Mesorregiaowc.ComponentInit();
               WebComp_Mesorregiaowc.Name = "core.ufmesorregiaoWC";
               WebComp_Mesorregiaowc_Component = "core.ufmesorregiaoWC";
            }
            if ( StringUtil.Len( WebComp_Mesorregiaowc_Component) != 0 )
            {
               WebComp_Mesorregiaowc.setjustcreated();
               WebComp_Mesorregiaowc.componentprepare(new Object[] {(string)"W0037",(string)"",(int)AV10UFID});
               WebComp_Mesorregiaowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Mesorregiaowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Mesorregiaowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void S122( )
      {
         ...
         /* Optimized group. */
         /* Using cursor H00494 */
         pr_default.execute(2, new Object[] {AV10UFID});
         cV13TabRecordsCount = H00494_AV13TabRecordsCount[0];
         pr_default.close(2);
         AV13TabRecordsCount = (long)(AV13TabRecordsCount+cV13TabRecordsCount*1);
         /* End optimized group. */
         this.executeExternalObjectMethod("", false, "WWPActions", "Tabs_EditCaption", new Object[] {(string)divLayoutmaintable_Internalname,(string)"Tabs",(string)"mesorregiao",StringUtil.Format( "%1 (%2)", "Mesorregiões", StringUtil.Trim( context.localUtil.Format( (decimal)(AV13TabRecordsCount), "Z,ZZZ,ZZZ,ZZ9")), "", "", "", "", "", "", ""),(bool)false,(string)""}, false);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10UFID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10UFID", StringUtil.LTrimStr( (decimal)(AV10UFID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vUFID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10UFID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Mesorregiaowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Mesorregiaowc_Component) != 0 )
            {
               WebComp_Mesorregiaowc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828221829", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/ufview.js", "?2023828221829", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblMesorregiao_title_Internalname = "MESORREGIAO_TITLE";
         divUnnamedtablemesorregiao_Internalname = "UNNAMEDTABLEMESORREGIAO";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A4UFID',fld:'UFID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10UFID',fld:'vUFID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11492',iparms:[{av:'A4UFID',fld:'UFID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12492',iparms:[{av:'AV15RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A4UFID',fld:'UFID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13492',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10UFID',fld:'vUFID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'},{ctrl:'MESORREGIAOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblMesorregiao_title_Jsonclick = "";
         WebComp_Mesorregiaowc_Component = "";
         OldMesorregiaowc = "";
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00492_A4UFID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00493_A4UFID = new int[1] ;
         H00493_A5UFSigla = new string[] {""} ;
         A5UFSigla = "";
         AV16Session = context.GetSession();
         H00494_AV13TabRecordsCount = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.ufview__default(),
            new Object[][] {
                new Object[] {
               H00492_A4UFID
               }
               , new Object[] {
               H00493_A4UFID, H00493_A5UFSigla
               }
               , new Object[] {
               H00494_AV13TabRecordsCount
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Mesorregiaowc = new GeneXus.Http.GXNullWebComponent();
      ...
      private int AV10UFID ;
      private int wcpOAV10UFID ;
      private int A4UFID ;
      ...
      private string lblMesorregiao_title_Internalname ;
      private string lblMesorregiao_title_Jsonclick ;
      private string divUnnamedtablemesorregiao_Internalname ;
      private string WebComp_Mesorregiaowc_Component ;
      private string OldMesorregiaowc ;
      ...
      private bool bDynCreated_Mesorregiaowc ;
      private string AV15RecordDescription ;
      private string A5UFSigla ;
      private IGxSession AV16Session ;
      private GXWebComponent WebComp_Generalwc ;
      private GXWebComponent WebComp_Mesorregiaowc ;
      ...
      private int[] H00492_A4UFID ;
      private int[] H00493_A4UFID ;
      private string[] H00493_A5UFSigla ;
      private long[] H00494_AV13TabRecordsCount ;
   ...
   public class ufview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10UFID",GXType.Int32,9,0)
          };
          Object[] prmH00493;
          ...
          def= new CursorDef[] {
              new CursorDef("H00492", "SELECT UFID FROM tbibge_uf WHERE UFID = :AV10UFID ORDER BY UFID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00492,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00493", "SELECT UFID, UFSigla FROM tbibge_uf WHERE UFID = :AV10UFID ORDER BY UFID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00493,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("H00494", "SELECT COUNT(*) FROM tbibge_mesorregiao WHERE MesorregiaoUFID = :AV10UFID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00494,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
