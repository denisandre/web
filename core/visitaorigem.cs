...
namespace GeneXus.Programs.core {
   public class visitaorigem : GXWebComponent
   {
      public visitaorigem( )
      {
      ...
      public visitaorigem( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Visita Origem") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "core.visitaorigem.aspx"+UrlEncode(AV8VisPaiID.ToString());
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.visitaorigem.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", sPrefix+"hsh"+"VisitaOrigem");
         forbiddenHiddens.Add("VisLink", StringUtil.RTrim( context.localUtil.Format( A417VisLink, "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("core\\visitaorigem:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      {
         return "core.VisitaOrigem" ;
      }

      public override string GetPgmdesc( )
      {
         return "Visita Origem" ;
      }
      ...
      protected void WB590( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.visitaorigem.aspx");
               context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
               context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
            }
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisNegAssunto_Internalname, A467VisNegAssunto, StringUtil.RTrim( context.localUtil.Format( A467VisNegAssunto, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtVisNegAssunto_Link, "", "", "", edtVisNegAssunto_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisNegAssunto_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisNegCliNomeFamiliar_Internalname, A469VisNegCliNomeFamiliar, StringUtil.RTrim( context.localUtil.Format( A469VisNegCliNomeFamiliar, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisNegCliNomeFamiliar_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisNegCliNomeFamiliar_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, false, "core\\Nome", "start", true, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisNegCpjNomFan_Internalname, A470VisNegCpjNomFan, StringUtil.RTrim( context.localUtil.Format( A470VisNegCpjNomFan, "@!")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisNegCpjNomFan_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisNegCpjNomFan_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, false, "core\\Nome", "start", true, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisNegValor_Internalname, StringUtil.LTrim( StringUtil.NToC( A468VisNegValor, 23, 2, ",", "")), StringUtil.LTrim( ((edtVisNegValor_Enabled!=0) ? context.localUtil.Format( A468VisNegValor, "R$ Z,ZZZ,ZZZ,ZZZ,ZZ9.99") : context.localUtil.Format( A468VisNegValor, "R$ Z,ZZZ,ZZZ,ZZZ,ZZ9.99"))), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisNegValor_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisNegValor_Enabled, 0, "text", "", 23, "chr", 1, "row", 23, 0, 0, 0, 0, -1, 0, false, "core\\Monetario", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTransactiondetail_txtesp01_Internalname, "&nbsp;", "", "", lblTransactiondetail_txtesp01_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 2, "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpTransactiondetail_tablegroupvisitaorigem_Internalname, "Visita origem", 1, 0, "px", 0, "px", grpTransactiondetail_tablegroupvisitaorigem_Class, "", "HLP_core\\VisitaOrigem.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtVisPaiDataHora_Internalname, context.localUtil.TToC( A462VisPaiDataHora, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A462VisPaiDataHora, "99/99/9999 99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisPaiDataHora_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisPaiDataHora_Enabled, 0, "text", "", 16, "chr", 1, "row", 16, 0, 0, 0, 0, -1, 0, false, "core\\DataHora", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisPaiDataHora_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVisPaiDataHora_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            ...
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Início", 1, 0, "px", 0, "px", "Group", "", "HLP_core\\VisitaOrigem.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtVisData_Internalname, context.localUtil.Format(A404VisData, "99/99/99"), context.localUtil.Format( A404VisData, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisData_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisData_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, false, "core\\Data", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisData_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVisData_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtVisHora_Internalname, context.localUtil.TToC( A405VisHora, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A405VisHora, "99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisHora_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisHora_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, 0, false, "core\\HoraMinuto", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisHora_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVisHora_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup3_Internalname, "Término", 1, 0, "px", 0, "px", "Group", "", "HLP_core\\VisitaOrigem.htm");
            /* Div Control */
            ...
            GxWebStd.gx_bitmap( context, edtVisDataFim_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVisDataFim_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtVisHoraFim_Internalname, context.localUtil.TToC( A476VisHoraFim, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A476VisHoraFim, "99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisHoraFim_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisHoraFim_Enabled, 0, "text", "", 5, "chr", 1, "row", 5, 0, 0, 0, 0, -1, 0, false, "core\\HoraMinuto", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisHoraFim_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtVisHoraFim_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisAssunto_Internalname, A409VisAssunto, StringUtil.RTrim( context.localUtil.Format( A409VisAssunto, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisAssunto_Jsonclick, 0, "AttributeFL", "", "", "", "", 1, edtVisAssunto_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 0, -1, -1, false, "", "start", true, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "start", "top", "", "", "div");
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbVisSituacao, cmbVisSituacao_Internalname, StringUtil.RTrim( A472VisSituacao), 1, cmbVisSituacao_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbVisSituacao.Enabled, 0, 0, 0, "em", 0, "", "", "AttributeFL", "", "", "", "", false, 0, "HLP_core\\VisitaOrigem.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavVispaiid_Internalname, AV8VisPaiID.ToString(), AV8VisPaiID.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVispaiid_Jsonclick, 0, "Attribute", "", "", "", "", edtavVispaiid_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, false, "", "", false, "", "HLP_core\\VisitaOrigem.htm");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtVisDataHoraFim_Internalname, context.localUtil.TToC( A477VisDataHoraFim, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A477VisDataHoraFim, "99/99/9999 99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisDataHoraFim_Jsonclick, 0, "Attribute", "", "", "", "", edtVisDataHoraFim_Visible, 0, 0, "text", "", 16, "chr", 1, "row", 16, 0, 0, 0, 0, -1, 0, false, "core\\DataHora", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisDataHoraFim_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((edtVisDataHoraFim_Visible==0)||(0==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtVisDataHora_Internalname, context.localUtil.TToC( A406VisDataHora, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( A406VisDataHora, "99/99/9999 99:99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisDataHora_Jsonclick, 0, "Attribute", "", "", "", "", edtVisDataHora_Visible, 0, 0, "text", "", 16, "chr", 1, "row", 16, 0, 0, 0, 0, -1, 0, false, "core\\DataHora", "end", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_bitmap( context, edtVisDataHora_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((edtVisDataHora_Visible==0)||(0==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_core\\VisitaOrigem.htm");
            context.WriteHtmlTextNl( "</div>") ;
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtVisPaiID_Internalname, A419VisPaiID.ToString(), A419VisPaiID.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVisPaiID_Jsonclick, 0, "Attribute", "", "", "", "", edtVisPaiID_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, false, "", "", false, "", "HLP_core\\VisitaOrigem.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START592( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Visita Origem", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.visitaorigem.aspx")), "core.visitaorigem.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.visitaorigem.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF592( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A414VisTipoID = H00592_A414VisTipoID[0];
               A422VisNgfSeq = H00592_A422VisNgfSeq[0];
               n422VisNgfSeq = H00592_n422VisNgfSeq[0];
               A418VisNegID = H00592_A418VisNegID[0];
               n418VisNegID = H00592_n418VisNegID[0];
               A419VisPaiID = H00592_A419VisPaiID[0];
               n419VisPaiID = H00592_n419VisPaiID[0];
               AssignAttri(sPrefix, false, "A419VisPaiID", A419VisPaiID.ToString());
               A406VisDataHora = H00592_A406VisDataHora[0];
               AssignAttri(sPrefix, false, "A406VisDataHora", context.localUtil.TToC( A406VisDataHora, 10, 5, 0, 3, "/", ":", " "));
               A477VisDataHoraFim = H00592_A477VisDataHoraFim[0];
               n477VisDataHoraFim = H00592_n477VisDataHoraFim[0];
               AssignAttri(sPrefix, false, "A477VisDataHoraFim", context.localUtil.TToC( A477VisDataHoraFim, 10, 5, 0, 3, "/", ":", " "));
               A410VisDescricao = H00592_A410VisDescricao[0];
               n410VisDescricao = H00592_n410VisDescricao[0];
               A417VisLink = H00592_A417VisLink[0];
               n417VisLink = H00592_n417VisLink[0];
               AssignAttri(sPrefix, false, "A417VisLink", A417VisLink);
               A472VisSituacao = H00592_A472VisSituacao[0];
               AssignAttri(sPrefix, false, "A472VisSituacao", A472VisSituacao);
               A409VisAssunto = H00592_A409VisAssunto[0];
               AssignAttri(sPrefix, false, "A409VisAssunto", A409VisAssunto);
               A476VisHoraFim = H00592_A476VisHoraFim[0];
               n476VisHoraFim = H00592_n476VisHoraFim[0];
               AssignAttri(sPrefix, false, "A476VisHoraFim", context.localUtil.TToC( A476VisHoraFim, 0, 5, 0, 3, "/", ":", " "));
               A475VisDataFim = H00592_A475VisDataFim[0];
               n475VisDataFim = H00592_n475VisDataFim[0];
               AssignAttri(sPrefix, false, "A475VisDataFim", context.localUtil.Format(A475VisDataFim, "99/99/99"));
               A405VisHora = H00592_A405VisHora[0];
               AssignAttri(sPrefix, false, "A405VisHora", context.localUtil.TToC( A405VisHora, 0, 5, 0, 3, "/", ":", " "));
               A404VisData = H00592_A404VisData[0];
               AssignAttri(sPrefix, false, "A404VisData", context.localUtil.Format(A404VisData, "99/99/99"));
               A416VisTipoNome = H00592_A416VisTipoNome[0];
               AssignAttri(sPrefix, false, "A416VisTipoNome", A416VisTipoNome);
               A462VisPaiDataHora = H00592_A462VisPaiDataHora[0];
               AssignAttri(sPrefix, false, "A462VisPaiDataHora", context.localUtil.TToC( A462VisPaiDataHora, 10, 5, 0, 3, "/", ":", " "));
               A465VisPaiAssunto = H00592_A465VisPaiAssunto[0];
               AssignAttri(sPrefix, false, "A465VisPaiAssunto", A465VisPaiAssunto);
               A424VisNgfIteNome = H00592_A424VisNgfIteNome[0];
               n424VisNgfIteNome = H00592_n424VisNgfIteNome[0];
               AssignAttri(sPrefix, false, "A424VisNgfIteNome", A424VisNgfIteNome);
               A468VisNegValor = H00592_A468VisNegValor[0];
               AssignAttri(sPrefix, false, "A468VisNegValor", StringUtil.LTrimStr( A468VisNegValor, 16, 2));
               A470VisNegCpjNomFan = H00592_A470VisNegCpjNomFan[0];
               n470VisNegCpjNomFan = H00592_n470VisNegCpjNomFan[0];
               AssignAttri(sPrefix, false, "A470VisNegCpjNomFan", A470VisNegCpjNomFan);
               A469VisNegCliNomeFamiliar = H00592_A469VisNegCliNomeFamiliar[0];
               n469VisNegCliNomeFamiliar = H00592_n469VisNegCliNomeFamiliar[0];
               AssignAttri(sPrefix, false, "A469VisNegCliNomeFamiliar", A469VisNegCliNomeFamiliar);
               A467VisNegAssunto = H00592_A467VisNegAssunto[0];
               AssignAttri(sPrefix, false, "A467VisNegAssunto", A467VisNegAssunto);
               A466VisNegCodigo = H00592_A466VisNegCodigo[0];
      ...
      protected void STRUP590( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLogError("core\\visitaorigem:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
               context.HttpContext.Response.StatusCode = 403;
               context.WriteHtmlText( "<title>403 Forbidden</title>") ;
               context.WriteHtmlText( "<h1>403 Forbidden</h1>") ;
      ...
      protected void E12592( )
      {
         ...
         AssignProp(sPrefix, false, edtavVispaiid_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtavVispaiid_Visible), 5, 0), true);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\visitaorigem", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382894438", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("core/visitaorigem.js", "?202382894439", false, true);
            context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false, true);
            context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavVispaiid_Internalname = sPrefix+"vVISPAIID";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A417VisLink',fld:'VISLINK',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00592_A398VisID = new Guid[] {Guid.Empty} ;
         H00592_A414VisTipoID = new int[1] ;
         H00592_A422VisNgfSeq = new int[1] ;
         H00592_n422VisNgfSeq = new bool[] {false} ;
         H00592_A418VisNegID = new Guid[] {Guid.Empty} ;
         H00592_n418VisNegID = new bool[] {false} ;
         H00592_A419VisPaiID = new Guid[] {Guid.Empty} ;
         H00592_n419VisPaiID = new bool[] {false} ;
         H00592_A406VisDataHora = new DateTime[] {DateTime.MinValue} ;
         H00592_A477VisDataHoraFim = new DateTime[] {DateTime.MinValue} ;
         H00592_n477VisDataHoraFim = new bool[] {false} ;
         H00592_A410VisDescricao = new string[] {""} ;
         H00592_n410VisDescricao = new bool[] {false} ;
         H00592_A417VisLink = new string[] {""} ;
         H00592_n417VisLink = new bool[] {false} ;
         H00592_A472VisSituacao = new string[] {""} ;
         H00592_A409VisAssunto = new string[] {""} ;
         H00592_A476VisHoraFim = new DateTime[] {DateTime.MinValue} ;
         H00592_n476VisHoraFim = new bool[] {false} ;
         H00592_A475VisDataFim = new DateTime[] {DateTime.MinValue} ;
         H00592_n475VisDataFim = new bool[] {false} ;
         H00592_A405VisHora = new DateTime[] {DateTime.MinValue} ;
         H00592_A404VisData = new DateTime[] {DateTime.MinValue} ;
         H00592_A416VisTipoNome = new string[] {""} ;
         H00592_A462VisPaiDataHora = new DateTime[] {DateTime.MinValue} ;
         H00592_A465VisPaiAssunto = new string[] {""} ;
         H00592_A424VisNgfIteNome = new string[] {""} ;
         H00592_n424VisNgfIteNome = new bool[] {false} ;
         H00592_A468VisNegValor = new decimal[1] ;
         H00592_A470VisNegCpjNomFan = new string[] {""} ;
         H00592_n470VisNegCpjNomFan = new bool[] {false} ;
         H00592_A469VisNegCliNomeFamiliar = new string[] {""} ;
         H00592_n469VisNegCliNomeFamiliar = new bool[] {false} ;
         H00592_A467VisNegAssunto = new string[] {""} ;
         H00592_A466VisNegCodigo = new long[1] ;
         ...
         sCtrlAV8VisPaiID = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.visitaorigem__default(),
            new Object[][] {
                new Object[] {
               H00592_A398VisID, H00592_A414VisTipoID, H00592_A422VisNgfSeq, H00592_n422VisNgfSeq, H00592_A418VisNegID, H00592_n418VisNegID, H00592_A419VisPaiID, H00592_n419VisPaiID, H00592_A406VisDataHora, H00592_A477VisDataHoraFim,
               H00592_n477VisDataHoraFim, H00592_A410VisDescricao, H00592_n410VisDescricao, H00592_A417VisLink, H00592_n417VisLink, H00592_A472VisSituacao, H00592_A409VisAssunto, H00592_A476VisHoraFim, H00592_n476VisHoraFim, H00592_A475VisDataFim,
               H00592_n475VisDataFim, H00592_A405VisHora, H00592_A404VisData, H00592_A416VisTipoNome, H00592_A462VisPaiDataHora, H00592_A465VisPaiAssunto, H00592_A424VisNgfIteNome, H00592_n424VisNgfIteNome, H00592_A468VisNegValor, H00592_A470VisNegCpjNomFan,
               H00592_n470VisNegCpjNomFan, H00592_A469VisNegCliNomeFamiliar, H00592_n469VisNegCliNomeFamiliar, H00592_A467VisNegAssunto, H00592_A466VisNegCodigo
               }
            }
         );
         AV14Pgmname = "core.VisitaOrigem";
      ...
      private Guid[] H00592_A398VisID ;
      private int[] H00592_A414VisTipoID ;
      private int[] H00592_A422VisNgfSeq ;
      private bool[] H00592_n422VisNgfSeq ;
      private Guid[] H00592_A418VisNegID ;
      private bool[] H00592_n418VisNegID ;
      private Guid[] H00592_A419VisPaiID ;
      private bool[] H00592_n419VisPaiID ;
      private DateTime[] H00592_A406VisDataHora ;
      private DateTime[] H00592_A477VisDataHoraFim ;
      private bool[] H00592_n477VisDataHoraFim ;
      private string[] H00592_A410VisDescricao ;
      private bool[] H00592_n410VisDescricao ;
      private string[] H00592_A417VisLink ;
      private bool[] H00592_n417VisLink ;
      private string[] H00592_A472VisSituacao ;
      private string[] H00592_A409VisAssunto ;
      private DateTime[] H00592_A476VisHoraFim ;
      private bool[] H00592_n476VisHoraFim ;
      private DateTime[] H00592_A475VisDataFim ;
      private bool[] H00592_n475VisDataFim ;
      private DateTime[] H00592_A405VisHora ;
      private DateTime[] H00592_A404VisData ;
      private string[] H00592_A416VisTipoNome ;
      private DateTime[] H00592_A462VisPaiDataHora ;
      private string[] H00592_A465VisPaiAssunto ;
      private string[] H00592_A424VisNgfIteNome ;
      private bool[] H00592_n424VisNgfIteNome ;
      private decimal[] H00592_A468VisNegValor ;
      private string[] H00592_A470VisNegCpjNomFan ;
      private bool[] H00592_n470VisNegCpjNomFan ;
      private string[] H00592_A469VisNegCliNomeFamiliar ;
      private bool[] H00592_n469VisNegCliNomeFamiliar ;
      private string[] H00592_A467VisNegAssunto ;
      private long[] H00592_A466VisNegCodigo ;
   ...
   public class visitaorigem__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00592", "SELECT T1.VisID, T1.VisTipoID AS VisTipoID, T1.VisNgfSeq AS VisNgfSeq, T1.VisNegID AS VisNegID, T1.VisPaiID AS VisPaiID, T1.VisDataHora, T1.VisDataHoraFim, T1.VisDescricao, T1.VisLink, T1.VisSituacao, T1.VisAssunto, T1.VisHoraFim, T1.VisDataFim, T1.VisHora, T1.VisData, T2.VitNome AS VisTipoNome, T5.VisDataHora AS VisPaiDataHora, T5.VisAssunto AS VisPaiAssunto, T4.NgfIteNome AS VisNgfIteNome, T3.NegValorAtualizado AS VisNegValor, T3.NegCpjNomFan AS VisNegCpjNomFan, T3.NegCliNomeFamiliar AS VisNegCliNomeFamiliar, T3.NegAssunto AS VisNegAssunto, T3.NegCodigo AS VisNegCodigo FROM ((((tb_visita T1 INNER JOIN tb_visitatipo T2 ON T2.VitID = T1.VisTipoID) LEFT JOIN tb_negociopj T3 ON T3.NegID = T1.VisNegID) LEFT JOIN tb_negociopj_fase T4 ON T4.NegID = T1.VisNegID AND T4.NgfSeq = T1.VisNgfSeq) LEFT JOIN tb_visita T5 ON T5.VisID = T1.VisPaiID) ORDER BY T1.VisID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00592,100, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
