...
namespace GeneXus.Programs.core {
   public class clientepjenderecoview : GXDataArea
   {
      public clientepjenderecoview( )
      {
      ...
      public clientepjenderecoview( IGxContext context )
      {
                           ...
                           string aP3_TabCode )
      {
         ...
         this.AV12CpjEndSeq = aP2_CpjEndSeq;
      ...
      {
         get {
            return "clientepjenderecoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.clientepjenderecoview.aspx"+UrlEncode(AV10CliID.ToString()) + "," + UrlEncode(AV11CpjID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(AV12CpjEndSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.clientepjenderecoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCPJENDSEQ", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CpjEndSeq), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCPJENDSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CpjEndSeq), "ZZZ9"), context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "CPJENDSEQ", StringUtil.LTrim( StringUtil.NToC( (decimal)(A248CpjEndSeq), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vRECORDDESCRIPTION", AV16RecordDescription);
         GxWebStd.gx_hidden_field( context, "gxhash_vRECORDDESCRIPTION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV16RecordDescription, "")), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.clientepjenderecoview.aspx"+UrlEncode(AV10CliID.ToString()) + "," + UrlEncode(AV11CpjID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(AV12CpjEndSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.clientepjenderecoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.ClientePJEnderecoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Cliente PJEndereco View" ;
      }
      ...
      protected void WB400( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ClientePJEnderecoView.htm");
            /* Div Control */
      ...
      protected void START402( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Cliente PJEndereco View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA402( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.clientepjenderecoview.aspx")), "core.clientepjenderecoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.clientepjenderecoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
               ...
               if ( nGotPars == 0 )
               {
                  ...
                  if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
                  {
                     ...
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        ...
                        GxWebStd.gx_hidden_field( context, "gxhash_vCPJID", GetSecureSignedToken( "", AV11CpjID, context));
                        AV12CpjEndSeq = (short)(Math.Round(NumberUtil.Val( GetPar( "CpjEndSeq"), "."), 18, MidpointRounding.ToEven));
                        AssignAttri("", false, "AV12CpjEndSeq", StringUtil.LTrimStr( (decimal)(AV12CpjEndSeq), 4, 0));
                        GxWebStd.gx_hidden_field( context, "gxhash_vCPJENDSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CpjEndSeq), "ZZZ9"), context));
      ...
      protected void RF402( )
      {
         ...
         {
            /* Using cursor H00402 */
            pr_default.execute(0, new Object[] {AV10CliID, AV11CpjID, AV12CpjEndSeq});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A248CpjEndSeq = H00402_A248CpjEndSeq[0];
               A166CpjID = H00402_A166CpjID[0];
               A158CliID = H00402_A158CliID[0];
               /* Execute user event: Load */
               E16402 ();
      ...
      protected void E14402( )
      {
         ...
         AV18GXLvl8 = 0;
         /* Using cursor H00403 */
         pr_default.execute(1, new Object[] {AV10CliID, AV11CpjID, AV12CpjEndSeq});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A248CpjEndSeq = H00403_A248CpjEndSeq[0];
            A166CpjID = H00403_A166CpjID[0];
            A158CliID = H00403_A158CliID[0];
            A249CpjEndNome = H00403_A249CpjEndNome[0];
            AV18GXLvl8 = 1;
            Form.Caption = A249CpjEndNome;
      ...
      protected void E15402( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "ClientePJEndereco",  StringUtil.Trim( A158CliID.ToString())+";"+StringUtil.Trim( A166CpjID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A248CpjEndSeq), 4, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "ClientePJEndereco",  2) )
         {
      ...
      protected void E11402( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"ClientePJEndereco",(short)2,StringUtil.Trim( A158CliID.ToString())+";"+StringUtil.Trim( A166CpjID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A248CpjEndSeq), 4, 0)),(string)AV16RecordDescription});
      ...
      protected void E12402( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "core.clientepjenderecoview.aspx"+UrlEncode(A158CliID.ToString()) + "," + UrlEncode(A166CpjID.ToString()) + "," + UrlEncode(StringUtil.LTrimStr(A248CpjEndSeq,4,0)) + "," + UrlEncode(StringUtil.RTrim(""));
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0032",(string)"",(string)"ClientePJEndereco",StringUtil.Trim( A158CliID.ToString())+";"+StringUtil.Trim( A166CpjID.ToString())+";"+StringUtil.Trim( StringUtil.Str( (decimal)(A248CpjEndSeq), 4, 0)),(string)AV16RecordDescription,formatLink("core.clientepjenderecoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ClientePJEnderecoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.clientepjenderecogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ClientePJEnderecoGeneral";
               WebComp_Generalwc_Component = "core.ClientePJEnderecoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0027",(string)"",(Guid)AV10CliID,(Guid)AV11CpjID,(short)AV12CpjEndSeq});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri("", false, "AV11CpjID", AV11CpjID.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vCPJID", GetSecureSignedToken( "", AV11CpjID, context));
         AV12CpjEndSeq = Convert.ToInt16(getParm(obj,2));
         AssignAttri("", false, "AV12CpjEndSeq", StringUtil.LTrimStr( (decimal)(AV12CpjEndSeq), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vCPJENDSEQ", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CpjEndSeq), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828215975", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/clientepjenderecoview.js", "?2023828215975", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Cliente PJEndereco View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A158CliID',fld:'CLIID',pic:''},{av:'A166CpjID',fld:'CPJID',pic:''},{av:'A248CpjEndSeq',fld:'CPJENDSEQ',pic:'ZZZ9'},{av:'AV16RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10CliID',fld:'vCLIID',pic:'',hsh:true},{av:'AV11CpjID',fld:'vCPJID',pic:'',hsh:true},{av:'AV12CpjEndSeq',fld:'vCPJENDSEQ',pic:'ZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E11402',iparms:[{av:'A158CliID',fld:'CLIID',pic:''},{av:'A166CpjID',fld:'CPJID',pic:''},{av:'A248CpjEndSeq',fld:'CPJENDSEQ',pic:'ZZZ9'},{av:'AV16RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E12402',iparms:[{av:'AV16RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A158CliID',fld:'CLIID',pic:''},{av:'A166CpjID',fld:'CPJID',pic:''},{av:'A248CpjEndSeq',fld:'CPJENDSEQ',pic:'ZZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E13402',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV13LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV14SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10CliID',fld:'vCLIID',pic:'',hsh:true},{av:'AV11CpjID',fld:'vCPJID',pic:'',hsh:true},{av:'AV12CpjEndSeq',fld:'vCPJENDSEQ',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H00402_A248CpjEndSeq = new short[1] ;
         H00402_A166CpjID = new Guid[] {Guid.Empty} ;
         H00402_A158CliID = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00403_A248CpjEndSeq = new short[1] ;
         H00403_A166CpjID = new Guid[] {Guid.Empty} ;
         H00403_A158CliID = new Guid[] {Guid.Empty} ;
         H00403_A249CpjEndNome = new string[] {""} ;
         A249CpjEndNome = "";
         AV17Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.clientepjenderecoview__default(),
            new Object[][] {
                new Object[] {
               H00402_A248CpjEndSeq, H00402_A166CpjID, H00402_A158CliID
               }
               , new Object[] {
               H00403_A248CpjEndSeq, H00403_A166CpjID, H00403_A158CliID, H00403_A249CpjEndNome
               }
            }
         );
      ...
      private short AV12CpjEndSeq ;
      private short wcpOAV12CpjEndSeq ;
      ...
      private short[] H00402_A248CpjEndSeq ;
      private Guid[] H00402_A166CpjID ;
      private Guid[] H00402_A158CliID ;
      private short[] H00403_A248CpjEndSeq ;
      private Guid[] H00403_A166CpjID ;
      private Guid[] H00403_A158CliID ;
      private string[] H00403_A249CpjEndNome ;
   ...
   public class clientepjenderecoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV12CpjEndSeq",GXType.Int16,4,0)
          };
          Object[] prmH00403;
          ...
          def= new CursorDef[] {
              new CursorDef("H00402", "SELECT CpjEndSeq, CpjID, CliID FROM tb_clientepj_endereco WHERE CliID = :AV10CliID and CpjID = :AV11CpjID and CpjEndSeq = :AV12CpjEndSeq ORDER BY CliID, CpjID, CpjEndSeq ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00402,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00403", "SELECT CpjEndSeq, CpjID, CliID, CpjEndNome FROM tb_clientepj_endereco WHERE (CliID = :AV10CliID and CpjID = :AV11CpjID and CpjEndSeq = :AV12CpjEndSeq) AND (CliID = :AV10CliID and CpjID = :AV11CpjID and CpjEndSeq = :AV12CpjEndSeq) ORDER BY CliID, CpjID, CpjEndSeq ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00403,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
