...
namespace GeneXus.Programs.core {
   public class visitatipoview : GXDataArea
   {
      public visitatipoview( )
      {
      ...
      public visitatipoview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.visitatipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10VitID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.visitatipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVITID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10VitID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10VitID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.visitatipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10VitID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.visitatipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.VisitaTipoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Visita Tipo View" ;
      }
      ...
      protected void WB4O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipos de Visita", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\VisitaTipoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\VisitaTipoView.htm");
            /* Div Control */
      ...
      protected void START4O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Visita Tipo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA4O2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.visitatipoview.aspx")), "core.visitatipoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.visitatipoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10VitID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10VitID", StringUtil.LTrimStr( (decimal)(AV10VitID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vVITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10VitID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF4O2( )
      {
         ...
         {
            /* Using cursor H004O2 */
            pr_default.execute(0, new Object[] {AV10VitID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A411VitID = H004O2_A411VitID[0];
               /* Execute user event: Load */
               E164O2 ();
      ...
      protected void E144O2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.visitatipoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H004O3 */
         pr_default.execute(1, new Object[] {AV10VitID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A411VitID = H004O3_A411VitID[0];
            A412VitSigla = H004O3_A412VitSigla[0];
            AV16GXLvl9 = 1;
            Form.Caption = A412VitSigla;
      ...
      protected void E154O2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "VisitaTipo",  StringUtil.Trim( StringUtil.Str( (decimal)(A411VitID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "VisitaTipo",  2) )
         {
      ...
      protected void E114O2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"VisitaTipo",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A411VitID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E124O2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"VisitaTipo",StringUtil.Trim( StringUtil.Str( (decimal)(A411VitID), 9, 0)),(string)AV14RecordDescription,formatLink("core.visitatipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.VisitaTipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.visitatipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.VisitaTipoGeneral";
               WebComp_Generalwc_Component = "core.VisitaTipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10VitID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10VitID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10VitID", StringUtil.LTrimStr( (decimal)(AV10VitID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vVITID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10VitID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828224937", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/visitatipoview.js", "?2023828224938", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A411VitID',fld:'VITID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10VitID',fld:'vVITID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E114O2',iparms:[{av:'A411VitID',fld:'VITID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E124O2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A411VitID',fld:'VITID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E134O2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10VitID',fld:'vVITID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H004O2_A411VitID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004O3_A411VitID = new int[1] ;
         H004O3_A412VitSigla = new string[] {""} ;
         A412VitSigla = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.visitatipoview__default(),
            new Object[][] {
                new Object[] {
               H004O2_A411VitID
               }
               , new Object[] {
               H004O3_A411VitID, H004O3_A412VitSigla
               }
            }
         );
      ...
      private int AV10VitID ;
      private int wcpOAV10VitID ;
      ...
      private int[] H004O2_A411VitID ;
      private int[] H004O3_A411VitID ;
      private string[] H004O3_A412VitSigla ;
   ...
   public class visitatipoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10VitID",GXType.Int32,9,0)
          };
          Object[] prmH004O3;
          ...
          def= new CursorDef[] {
              new CursorDef("H004O2", "SELECT VitID FROM tb_visitatipo WHERE VitID = :AV10VitID ORDER BY VitID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004O3", "SELECT VitID, VitSigla FROM tb_visitatipo WHERE VitID = :AV10VitID ORDER BY VitID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
