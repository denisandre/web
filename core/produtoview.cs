...
namespace GeneXus.Programs.core {
   public class produtoview : GXDataArea
   {
      public produtoview( )
      {
      ...
      public produtoview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.produtoview.aspx"+UrlEncode(AV10PrdID.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.produtoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRDID", AV10PrdID.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vPRDID", GetSecureSignedToken( "", AV10PrdID, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.produtoview.aspx"+UrlEncode(AV10PrdID.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.produtoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.ProdutoView" ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Produto ou Serviço", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\ProdutoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ProdutoView.htm");
            /* Div Control */
      ...
      protected void START3F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Produto View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA3F2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.produtoview.aspx")), "core.produtoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.produtoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10PrdID = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10PrdID", AV10PrdID.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vPRDID", GetSecureSignedToken( "", AV10PrdID, context));
      ...
      protected void RF3F2( )
      {
         ...
         {
            /* Using cursor H003F2 */
            pr_default.execute(0, new Object[] {AV10PrdID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A220PrdID = H003F2_A220PrdID[0];
               /* Execute user event: Load */
               E163F2 ();
      ...
      protected void E143F2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.produtoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003F3 */
         pr_default.execute(1, new Object[] {AV10PrdID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A220PrdID = H003F3_A220PrdID[0];
            A221PrdCodigo = H003F3_A221PrdCodigo[0];
            AV16GXLvl9 = 1;
            Form.Caption = A221PrdCodigo;
      ...
      protected void E153F2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Produto",  StringUtil.Trim( A220PrdID.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Produto",  2) )
         {
      ...
      protected void E113F2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"Produto",(short)2,StringUtil.Trim( A220PrdID.ToString()),(string)AV14RecordDescription});
      ...
      protected void E123F2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"Produto",StringUtil.Trim( A220PrdID.ToString()),(string)AV14RecordDescription,formatLink("core.produtoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ProdutoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.produtogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ProdutoGeneral";
               WebComp_Generalwc_Component = "core.ProdutoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(Guid)AV10PrdID});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828213192", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/produtoview.js", "?2023828213193", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A220PrdID',fld:'PRDID',pic:''},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10PrdID',fld:'vPRDID',pic:'',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E113F2',iparms:[{av:'A220PrdID',fld:'PRDID',pic:''},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E123F2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A220PrdID',fld:'PRDID',pic:''}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E133F2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10PrdID',fld:'vPRDID',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H003F2_A220PrdID = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H003F3_A220PrdID = new Guid[] {Guid.Empty} ;
         H003F3_A221PrdCodigo = new string[] {""} ;
         A221PrdCodigo = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.produtoview__default(),
            new Object[][] {
                new Object[] {
               H003F2_A220PrdID
               }
               , new Object[] {
               H003F3_A220PrdID, H003F3_A221PrdCodigo
               }
            }
         );
      ...
      private Guid AV10PrdID ;
      private Guid wcpOAV10PrdID ;
      ...
      private Guid[] H003F2_A220PrdID ;
      private Guid[] H003F3_A220PrdID ;
      private string[] H003F3_A221PrdCodigo ;
   ...
   public class produtoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10PrdID",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH003F3;
          ...
          def= new CursorDef[] {
              new CursorDef("H003F2", "SELECT PrdID FROM tb_produto WHERE PrdID = :AV10PrdID ORDER BY PrdID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003F2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003F3", "SELECT PrdID, PrdCodigo FROM tb_produto WHERE PrdID = :AV10PrdID ORDER BY PrdID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003F3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
