...
namespace GeneXus.Programs.core {
   public class mesorregiaomicrorregiaowc : GXWebComponent
   {
      public mesorregiaomicrorregiaowc( )
      {
      ...
      public mesorregiaomicrorregiaowc( IGxContext context )
      {
      ...
      public void execute( int aP0_MicrorregiaoMesoID )
      {
         this.AV8MicrorregiaoMesoID = aP0_MicrorregiaoMesoID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "MicrorregiaoMesoID");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8MicrorregiaoMesoID = (int)(Math.Round(NumberUtil.Val( GetPar( "MicrorregiaoMesoID"), "."), 18, MidpointRounding.ToEven));
                  AssignAttri(sPrefix, false, "AV8MicrorregiaoMesoID", StringUtil.LTrimStr( (decimal)(AV8MicrorregiaoMesoID), 9, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(int)AV8MicrorregiaoMesoID});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27IsAuthorized_MicrorregiaoNome = StringUtil.StrToBool( GetPar( "IsAuthorized_MicrorregiaoNome"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16FilterFullText, AV8MicrorregiaoMesoID, AV20ManageFiltersExecutionStep, AV28Pgmname, AV14OrderedBy, AV15OrderedDsc, AV27IsAuthorized_MicrorregiaoNome, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV28Pgmname = "core.mesorregiaomicrorregiaoWC";
               WS4G2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "mesorregiaomicrorregiao WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "core.mesorregiaomicrorregiaowc.aspx"+UrlEncode(StringUtil.LTrimStr(AV8MicrorregiaoMesoID,9,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.mesorregiaomicrorregiaowc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_MICRORREGIAONOME", AV27IsAuthorized_MicrorregiaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MICRORREGIAONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MicrorregiaoNome, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8MicrorregiaoMesoID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV8MicrorregiaoMesoID), 9, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vMICRORREGIAOMESOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MicrorregiaoMesoID), 9, 0, ",", "")));
      ...
      {
         return "core.mesorregiaomicrorregiaoWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "mesorregiaomicrorregiao WC" ;
      }
      ...
      protected void WB4G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.mesorregiaomicrorregiaowc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            wb_table1_16_4G2( true) ;
         }
         else
         {
            wb_table1_16_4G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_16_4G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 31 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMicrorregiaoMesoID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A25MicrorregiaoMesoID), 11, 0, ",", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A25MicrorregiaoMesoID), "ZZZ,ZZZ,ZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMicrorregiaoMesoID_Jsonclick, 0, "Attribute", "", "", "", "", edtMicrorregiaoMesoID_Visible, 0, 0, "text", "", 11, "chr", 1, "row", 11, 0, 0, 0, 0, -1, 0, true, "core\\ID", "end", false, "", "HLP_core\\mesorregiaomicrorregiaoWC.htm");
            /* User Defined Control */
      ...
      protected void START4G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "mesorregiaomicrorregiao WC", 0) ;
            }
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.mesorregiaomicrorregiaowc.aspx")), "core.mesorregiaomicrorregiaowc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.mesorregiaomicrorregiaowc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       int AV8MicrorregiaoMesoID ,
                                       short AV20ManageFiltersExecutionStep ,
                                       string AV28Pgmname ,
                                       short AV14OrderedBy ,
                                       bool AV15OrderedDsc ,
                                       bool AV27IsAuthorized_MicrorregiaoNome ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF4G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV14OrderedBy ,
                                                 AV15OrderedDsc ,
                                                 A25MicrorregiaoMesoID ,
                                                 AV8MicrorregiaoMesoID } ,
                                                 new int[]{
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H004G2 */
            pr_default.execute(0, new Object[] {AV8MicrorregiaoMesoID, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_31_idx = 1;
            sGXsfl_31_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_31_idx), 4, 0), 4, "0");
            SubsflControlProps_312( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A25MicrorregiaoMesoID = H004G2_A25MicrorregiaoMesoID[0];
               AssignAttri(sPrefix, false, "A25MicrorregiaoMesoID", StringUtil.LTrimStr( (decimal)(A25MicrorregiaoMesoID), 9, 0));
               A24MicrorregiaoNome = H004G2_A24MicrorregiaoNome[0];
               A23MicrorregiaoID = H004G2_A23MicrorregiaoID[0];
               E174G2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H004G3 */
         pr_default.execute(1, new Object[] {AV8MicrorregiaoMesoID, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP4G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8MicrorregiaoMesoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MicrorregiaoMesoID"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      protected void E154G2( )
      {
         ...
         GXt_boolean1 = AV27IsAuthorized_MicrorregiaoNome;
         ...
         AV27IsAuthorized_MicrorregiaoNome = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV27IsAuthorized_MicrorregiaoNome", AV27IsAuthorized_MicrorregiaoNome);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_MICRORREGIAONOME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_MicrorregiaoNome, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtMicrorregiaoMesoID_Visible = 0;
         AssignProp(sPrefix, false, edtMicrorregiaoMesoID_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMicrorregiaoMesoID_Visible), 5, 0), true);
      ...
      protected void E164G2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV28Pgmname, out  GXt_char3) ;
      ...
      private void E174G2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         if ( AV27IsAuthorized_MicrorregiaoNome )
         {
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
      ...
      protected void E114G2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("core.mesorregiaomicrorregiaoWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV28Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("core.mesorregiaomicrorregiaoWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "core.mesorregiaomicrorregiaoWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV28Pgmname+"GridState",  AV19ManageFiltersXml) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "core.mesorregiaomicrorregiaoWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV17Session.Get(AV28Pgmname+"GridState"), "") == 0 )
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV28Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV12GridState.FromXml(AV17Session.Get(AV28Pgmname+"GridState"), null, "", "");
         }
         AV14OrderedBy = AV12GridState.gxTpr_Orderedby;
         AssignAttri(sPrefix, false, "AV14OrderedBy", StringUtil.LTrimStr( (decimal)(AV14OrderedBy), 4, 0));
         AV15OrderedDsc = AV12GridState.gxTpr_Ordereddsc;
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV29GXV1 = 1;
         while ( AV29GXV1 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV29GXV1));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV28Pgmname+"GridState",  AV12GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV28Pgmname;
         AV10TrnContext.gxTpr_Callerondelete = true;
         AV10TrnContext.gxTpr_Callerurl = AV9HTTPRequest.ScriptName+"?"+AV9HTTPRequest.QueryString;
         AV10TrnContext.gxTpr_Transactionname = "core.microrregiao";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "MicrorregiaoMesoID";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV8MicrorregiaoMesoID), 9, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
         AV17Session.Set("TrnContext", AV10TrnContext.ToXml(false, true, "", ""));
      }

      protected void wb_table1_16_4G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            wb_table2_21_4G2( true) ;
         }
         else
         {
            wb_table2_21_4G2( false) ;
         }
         return  ;
      }

      protected void wb_table2_21_4G2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_16_4G2e( true) ;
         }
         else
         {
            wb_table1_16_4G2e( false) ;
         }
      }

      protected void wb_table2_21_4G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8MicrorregiaoMesoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV8MicrorregiaoMesoID", StringUtil.LTrimStr( (decimal)(AV8MicrorregiaoMesoID), 9, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8MicrorregiaoMesoID = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\mesorregiaomicrorregiaowc", GetJustCreated( ));
         ...
         {
            AV8MicrorregiaoMesoID = Convert.ToInt32(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV8MicrorregiaoMesoID", StringUtil.LTrimStr( (decimal)(AV8MicrorregiaoMesoID), 9, 0));
         }
         wcpOAV8MicrorregiaoMesoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV8MicrorregiaoMesoID"), ",", "."), 18, MidpointRounding.ToEven));
         if ( ! GetJustCreated( ) && ( ( AV8MicrorregiaoMesoID != wcpOAV8MicrorregiaoMesoID ) ) )
         {
            setjustcreated();
         }
         wcpOAV8MicrorregiaoMesoID = AV8MicrorregiaoMesoID;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8MicrorregiaoMesoID = cgiGet( sPrefix+"AV8MicrorregiaoMesoID_CTRL");
         if ( StringUtil.Len( sCtrlAV8MicrorregiaoMesoID) > 0 )
         {
            AV8MicrorregiaoMesoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV8MicrorregiaoMesoID), ",", "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV8MicrorregiaoMesoID", StringUtil.LTrimStr( (decimal)(AV8MicrorregiaoMesoID), 9, 0));
         }
         else
         {
            AV8MicrorregiaoMesoID = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV8MicrorregiaoMesoID_PARM"), ",", "."), 18, MidpointRounding.ToEven));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8MicrorregiaoMesoID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8MicrorregiaoMesoID), 9, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8MicrorregiaoMesoID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8MicrorregiaoMesoID_CTRL", StringUtil.RTrim( sCtrlAV8MicrorregiaoMesoID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382811611", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("core/mesorregiaomicrorregiaowc.js", "?202382811612", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtMicrorregiaoID_Internalname = sPrefix+"MICRORREGIAOID_"+sGXsfl_31_idx;
         edtMicrorregiaoNome_Internalname = sPrefix+"MICRORREGIAONOME_"+sGXsfl_31_idx;
      }

      protected void SubsflControlProps_fel_312( )
      {
         edtMicrorregiaoID_Internalname = sPrefix+"MICRORREGIAOID_"+sGXsfl_31_fel_idx;
         edtMicrorregiaoNome_Internalname = sPrefix+"MICRORREGIAONOME_"+sGXsfl_31_fel_idx;
      }
      ...
      protected void sendrow_312( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_31_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMicrorregiaoNome_Internalname,(string)A24MicrorregiaoNome,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtMicrorregiaoNome_Link,(string)"",(string)"",(string)"",(string)edtMicrorregiaoNome_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)80,(short)0,(short)0,(short)31,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void init_default_properties( )
      {
         ...
         edtMicrorregiaoMesoID_Internalname = sPrefix+"MICRORREGIAOMESOID";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:MicrorregiaoID|1:MicrorregiaoNome";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV8MicrorregiaoMesoID',fld:'vMICRORREGIAOMESOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'sPrefix'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true}]");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E124G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MicrorregiaoMesoID',fld:'vMICRORREGIAOMESOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E134G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MicrorregiaoMesoID',fld:'vMICRORREGIAOMESOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","{handler:'E144G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MicrorregiaoMesoID',fld:'vMICRORREGIAOMESOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_grid_Activeeventkey',ctrl:'DDO_GRID',prop:'ActiveEventKey'},{av:'Ddo_grid_Selectedvalue_get',ctrl:'DDO_GRID',prop:'SelectedValue_get'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174G2',iparms:[{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true},{av:'A23MicrorregiaoID',fld:'MICRORREGIAOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtMicrorregiaoNome_Link',ctrl:'MICRORREGIAONOME',prop:'Link'}]}");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","{handler:'E114G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV16FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV8MicrorregiaoMesoID',fld:'vMICRORREGIAOMESOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV20ManageFiltersExecutionStep',fld:'vMANAGEFILTERSEXECUTIONSTEP',pic:'9'},{av:'AV28Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV27IsAuthorized_MicrorregiaoNome',fld:'vISAUTHORIZED_MICRORREGIAONOME',pic:'',hsh:true},{av:'sPrefix'},{av:'Ddo_managefilters_Activeeventkey',ctrl:'DDO_MANAGEFILTERS',prop:'ActiveEventKey'},{av:'AV12GridState',fld:'vGRIDSTATE',pic:''}]");
         ...
         setEventMetadata("NULL","{handler:'Valid_Microrregiaonome',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16FilterFullText = "";
         H004G2_A25MicrorregiaoMesoID = new int[1] ;
         H004G2_A24MicrorregiaoNome = new string[] {""} ;
         H004G2_A23MicrorregiaoID = new int[1] ;
         ...
         sCtrlAV8MicrorregiaoMesoID = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.mesorregiaomicrorregiaowc__default(),
            new Object[][] {
                new Object[] {
               H004G2_A25MicrorregiaoMesoID, H004G2_A24MicrorregiaoNome, H004G2_A23MicrorregiaoID
               }
               , new Object[] {
      ...
      private int AV8MicrorregiaoMesoID ;
      private int wcpOAV8MicrorregiaoMesoID ;
      ...
      private string sCtrlAV8MicrorregiaoMesoID ;
      ...
      private bool AV27IsAuthorized_MicrorregiaoNome ;
      ...
      private int[] H004G2_A25MicrorregiaoMesoID ;
      private string[] H004G2_A24MicrorregiaoNome ;
      private int[] H004G2_A23MicrorregiaoID ;
   ...
   public class mesorregiaomicrorregiaowc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             int AV8MicrorregiaoMesoID )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " MicrorregiaoMesoID, MicrorregiaoNome, MicrorregiaoID";
         sFromString = " FROM tbibge_microrregiao";
         sOrderString = "";
         AddWhere(sWhereString, "(MicrorregiaoMesoID = :AV8MicrorregiaoMesoID)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( SUBSTR(TO_CHAR(MicrorregiaoID,'999999999'), 2) like '%' || :lV16FilterFullText) or ( MicrorregiaoNome like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY MicrorregiaoMesoID, MicrorregiaoNome, MicrorregiaoID";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MicrorregiaoMesoID DESC, MicrorregiaoNome DESC, MicrorregiaoID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY MicrorregiaoMesoID, MicrorregiaoID";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY MicrorregiaoMesoID DESC, MicrorregiaoID DESC";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004G2(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
               case 1 :
                     return conditional_H004G3(context, (string)dynConstraints[0] , (int)dynConstraints[1] , (string)dynConstraints[2] , (short)dynConstraints[3] , (bool)dynConstraints[4] , (int)dynConstraints[5] , (int)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8MicrorregiaoMesoID",GXType.Int32,9,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H004G3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004G3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
