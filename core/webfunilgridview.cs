...
namespace GeneXus.Programs.core {
   public class webfunilgridview : GXWebComponent
   {
      public webfunilgridview( )
      {
      ...
      public webfunilgridview( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.webfunilgridview.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV52GridCurrentPage), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53GridPageCount), 10, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDAPPLIEDFILTERS", AV54GridAppliedFilters);
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return "core.webfunilGridView" ;
      }

      public override string GetPgmdesc( )
      {
         return "webfunil Grid View" ;
      }
      ...
      protected void WB4Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "core.webfunilgridview.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 9 )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, sPrefix+"W0025"+"", StringUtil.RTrim( WebComp_Selectlistview_wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+sPrefix+"gxHTMLWrpW0025"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( bGXsfl_9_Refreshing )
               {
                  ...
                  {
                     context.httpAjaxContext.ajax_rspStartCmp(sPrefix+"gxHTMLWrpW0025"+"");
                  }
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, sPrefix+"W0028"+"", StringUtil.RTrim( WebComp_Wwpaux_wc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START4Z2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "webfunil Grid View", 0) ;
            }
            context.wjLoc = "";
               ...
               if ( context.wbHandled == 0 )
               {
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 25 )
                        {
                           OldSelectlistview_wc = cgiGet( sPrefix+"W0025");
                           ...
                           WebComp_Selectlistview_wc.componentprocess(sPrefix+"W0025", "", sEvt);
                           WebComp_Selectlistview_wc_Component = OldSelectlistview_wc;
                        }
                        else if ( nCmpId == 28 )
                        {
                           OldWwpaux_wc = cgiGet( sPrefix+"W0028");
                           ...
                           WebComp_Wwpaux_wc.componentprocess(sPrefix+"W0028", "", sEvt);
                           WebComp_Wwpaux_wc_Component = OldWwpaux_wc;
                        }
                     }
                     context.wbHandled = 1;
      ...
      {
         AV58Core_webfunilds_1_filterfulltext = AV17FilterFullText;
         AV59Core_webfunilds_2_dynamicfiltersselector1 = AV18DynamicFiltersSelector1;
         AV60Core_webfunilds_3_dynamicfiltersoperator1 = AV19DynamicFiltersOperator1;
         AV61Core_webfunilds_4_itenome1 = AV20IteNome1;
         AV62Core_webfunilds_5_dynamicfiltersenabled2 = AV21DynamicFiltersEnabled2;
         AV63Core_webfunilds_6_dynamicfiltersselector2 = AV22DynamicFiltersSelector2;
         AV64Core_webfunilds_7_dynamicfiltersoperator2 = AV23DynamicFiltersOperator2;
         AV65Core_webfunilds_8_itenome2 = AV24IteNome2;
         AV66Core_webfunilds_9_dynamicfiltersenabled3 = AV25DynamicFiltersEnabled3;
         AV67Core_webfunilds_10_dynamicfiltersselector3 = AV26DynamicFiltersSelector3;
         AV68Core_webfunilds_11_dynamicfiltersoperator3 = AV27DynamicFiltersOperator3;
         AV69Core_webfunilds_12_itenome3 = AV28IteNome3;
         AV70Core_webfunilds_13_tfitenome = AV41TFIteNome;
         AV71Core_webfunilds_14_tfitenome_sel = AV42TFIteNome_Sel;
         GRID_nRecordCount = 0;
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A420NegUltIteID } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.INT, TypeConstants.DECIMAL
                                              }
         });
         ...
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV58Core_webfunilds_1_filterfulltext)) || ( ( StringUtil.Like( A383IteNome , StringUtil.PadR( "%" + AV58Core_webfunilds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( (decimal)(A432IteQtdeOportunidades), 8, 0) , StringUtil.PadR( "%" + AV58Core_webfunilds_1_filterfulltext , 254 , "%"),  ' ' ) ) || ( StringUtil.Like( StringUtil.Str( A431IteTotalOportunidades, 16, 2) , StringUtil.PadR( "%" + AV58Core_webfunilds_1_filterfulltext , 254 , "%"),  ' ' ) ) ) )
            {
      ...
      protected void RF4Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV70Core_webfunilds_13_tfitenome = StringUtil.Concat( StringUtil.RTrim( AV70Core_webfunilds_13_tfitenome), "%", "");
            /* Using cursor H004Z3 */
            pr_default.execute(1, new Object[] {lV61Core_webfunilds_4_itenome1, lV61Core_webfunilds_4_itenome1, lV65Core_webfunilds_8_itenome2, lV65Core_webfunilds_8_itenome2, lV69Core_webfunilds_12_itenome3, lV69Core_webfunilds_12_itenome3, lV70Core_webfunilds_13_tfitenome, AV71Core_webfunilds_14_tfitenome_sel});
            nGXsfl_9_idx = 1;
            sGXsfl_9_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_9_idx), 4, 0), 4, "0");
            SubsflControlProps_92( ) ;
            GRID_nEOF = 0;
      ...
      protected void STRUP4Z0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV52GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ",", "."), 18, MidpointRounding.ToEven));
            AV53GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ",", "."), 18, MidpointRounding.ToEven));
            AV54GridAppliedFilters = cgiGet( sPrefix+"vGRIDAPPLIEDFILTERS");
      ...
      protected void E164Z2( )
      {
         ...
         AssignProp(sPrefix, false, edtIteNome_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIteNome_Visible), 5, 0), !bGXsfl_9_Refreshing);
         ...
         AssignProp(sPrefix, false, edtIteQtdeOportunidades_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIteQtdeOportunidades_Visible), 5, 0), !bGXsfl_9_Refreshing);
         ...
         AssignProp(sPrefix, false, edtIteTotalOportunidades_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIteTotalOportunidades_Visible), 5, 0), !bGXsfl_9_Refreshing);
         AV52GridCurrentPage = subGrid_fnc_Currentpage( );
         AssignAttri(sPrefix, false, "AV52GridCurrentPage", StringUtil.LTrimStr( (decimal)(AV52GridCurrentPage), 10, 0));
         AV53GridPageCount = subGrid_fnc_Pagecount( );
         AssignAttri(sPrefix, false, "AV53GridPageCount", StringUtil.LTrimStr( (decimal)(AV53GridPageCount), 10, 0));
         GXt_char2 = AV54GridAppliedFilters;
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  "core.webfunil", out  GXt_char2) ;
         AV54GridAppliedFilters = GXt_char2;
         AssignAttri(sPrefix, false, "AV54GridAppliedFilters", AV54GridAppliedFilters);
         AV58Core_webfunilds_1_filterfulltext = AV17FilterFullText;
         AV59Core_webfunilds_2_dynamicfiltersselector1 = AV18DynamicFiltersSelector1;
         AV60Core_webfunilds_3_dynamicfiltersoperator1 = AV19DynamicFiltersOperator1;
         AV61Core_webfunilds_4_itenome1 = AV20IteNome1;
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFITENOME",  "Iteração",  !String.IsNullOrEmpty(StringUtil.RTrim( AV41TFIteNome)),  0,  AV41TFIteNome,  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV42TFIteNome_Sel)),  AV42TFIteNome_Sel,  "") ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "core\\webfunilgridview", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023752255099", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("core/webfunilgridview.js", "?202375225511", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtIteID_Internalname = sPrefix+"ITEID_"+sGXsfl_9_idx;
         edtIteOrdem_Internalname = sPrefix+"ITEORDEM_"+sGXsfl_9_idx;
         edtIteNome_Internalname = sPrefix+"ITENOME_"+sGXsfl_9_idx;
         chkIteAtivo_Internalname = sPrefix+"ITEATIVO_"+sGXsfl_9_idx;
         edtIteQtdeOportunidades_Internalname = sPrefix+"ITEQTDEOPORTUNIDADES_"+sGXsfl_9_idx;
         edtIteTotalOportunidades_Internalname = sPrefix+"ITETOTALOPORTUNIDADES_"+sGXsfl_9_idx;
      }

      protected void SubsflControlProps_fel_92( )
      {
         edtIteID_Internalname = sPrefix+"ITEID_"+sGXsfl_9_fel_idx;
         edtIteOrdem_Internalname = sPrefix+"ITEORDEM_"+sGXsfl_9_fel_idx;
         edtIteNome_Internalname = sPrefix+"ITENOME_"+sGXsfl_9_fel_idx;
         chkIteAtivo_Internalname = sPrefix+"ITEATIVO_"+sGXsfl_9_fel_idx;
         edtIteQtdeOportunidades_Internalname = sPrefix+"ITEQTDEOPORTUNIDADES_"+sGXsfl_9_fel_idx;
         edtIteTotalOportunidades_Internalname = sPrefix+"ITETOTALOPORTUNIDADES_"+sGXsfl_9_fel_idx;
      }
      ...
      protected void sendrow_92( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_9_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            GXCCtl = "ITEATIVO_" + sGXsfl_9_idx;
            chkIteAtivo.Name = GXCCtl;
            chkIteAtivo.WebTags = "";
            chkIteAtivo.Caption = "";
            AssignProp(sPrefix, false, chkIteAtivo_Internalname, "TitleCaption", chkIteAtivo.Caption, !bGXsfl_9_Refreshing);
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtIteTotalOportunidades_Internalname,StringUtil.LTrim( StringUtil.NToC( A431IteTotalOportunidades, 20, 2, ",", "")),StringUtil.LTrim( context.localUtil.Format( A431IteTotalOportunidades, "Z,ZZZ,ZZZ,ZZZ,ZZ9.99")),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtIteTotalOportunidades_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtIteTotalOportunidades_Visible,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)0,(short)9,(short)0,(short)-1,(short)0,(bool)true,(string)"core\\Monetario",(string)"end",(bool)false,(string)""});
      ...
      protected void StartGridControl9( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( A431IteTotalOportunidades, 20, 2, ".", ""))));
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "webfunil Grid View";
         subGrid_Rows = 0;
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'sPrefix'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV35ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:'',hsh:true},{av:'AV17FilterFullText',fld:'vFILTERFULLTEXT',pic:''},{av:'AV18DynamicFiltersSelector1',fld:'vDYNAMICFILTERSSELECTOR1',pic:''},{av:'AV19DynamicFiltersOperator1',fld:'vDYNAMICFILTERSOPERATOR1',pic:'ZZZ9'},{av:'AV20IteNome1',fld:'vITENOME1',pic:'@!'},{av:'AV21DynamicFiltersEnabled2',fld:'vDYNAMICFILTERSENABLED2',pic:''},{av:'AV22DynamicFiltersSelector2',fld:'vDYNAMICFILTERSSELECTOR2',pic:''},{av:'AV23DynamicFiltersOperator2',fld:'vDYNAMICFILTERSOPERATOR2',pic:'ZZZ9'},{av:'AV24IteNome2',fld:'vITENOME2',pic:'@!'},{av:'AV25DynamicFiltersEnabled3',fld:'vDYNAMICFILTERSENABLED3',pic:''},{av:'AV26DynamicFiltersSelector3',fld:'vDYNAMICFILTERSSELECTOR3',pic:''},{av:'AV27DynamicFiltersOperator3',fld:'vDYNAMICFILTERSOPERATOR3',pic:'ZZZ9'},{av:'AV28IteNome3',fld:'vITENOME3',pic:'@!'},{av:'AV41TFIteNome',fld:'vTFITENOME',pic:'@!'},{av:'AV42TFIteNome_Sel',fld:'vTFITENOME_SEL',pic:'@!'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV30DynamicFiltersIgnoreFirst',fld:'vDYNAMICFILTERSIGNOREFIRST',pic:'',hsh:true},{av:'AV29DynamicFiltersRemoving',fld:'vDYNAMICFILTERSREMOVING',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV35ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:'',hsh:true},{av:'edtIteNome_Visible',ctrl:'ITENOME',prop:'Visible'},{av:'edtIteQtdeOportunidades_Visible',ctrl:'ITEQTDEOPORTUNIDADES',prop:'Visible'},{av:'edtIteTotalOportunidades_Visible',ctrl:'ITETOTALOPORTUNIDADES',prop:'Visible'},{av:'AV52GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV53GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV54GridAppliedFilters',fld:'vGRIDAPPLIEDFILTERS',pic:''},{av:'AV11GridState',fld:'vGRIDSTATE',pic:''}]}");
         setEventMetadata("GLOBALEVENTS.LISTVIEW_REFRESHVIEW","{handler:'E144Z2',iparms:[{av:'AV11GridState',fld:'vGRIDSTATE',pic:''},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV42TFIteNome_Sel',fld:'vTFITENOME_SEL',pic:'@!'},{av:'AV41TFIteNome',fld:'vTFITENOME',pic:'@!'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E174Z2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.webfunilgridview__default(),
            new Object[][] {
                new Object[] {
   ...
   public class webfunilgridview__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid A420NegUltIteID )
      {
         ...
         if ( ! AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY IteOrdem, IteID";
         }
         else if ( AV15OrderedDsc )
         {
            scmdbuf += " ORDER BY IteOrdem DESC, IteID";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004Z2(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (bool)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (bool)dynConstraints[14] , (string)dynConstraints[15] , (int)dynConstraints[16] , (decimal)dynConstraints[17] , (Guid)dynConstraints[18] , (Guid)dynConstraints[19] );
               case 1 :
                     return conditional_H004Z3(context, (string)dynConstraints[0] , (short)dynConstraints[1] , (string)dynConstraints[2] , (bool)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (string)dynConstraints[6] , (bool)dynConstraints[7] , (string)dynConstraints[8] , (short)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (bool)dynConstraints[14] , (string)dynConstraints[15] , (int)dynConstraints[16] , (decimal)dynConstraints[17] , (Guid)dynConstraints[18] , (Guid)dynConstraints[19] );
         }
