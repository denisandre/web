...
namespace GeneXus.Programs.core {
   public class documentotipoview : GXDataArea
   {
      public documentotipoview( )
      {
      ...
      public documentotipoview( IGxContext context )
      {
      ...
      public void execute( int aP0_DocTipoID ,
                           string aP1_TabCode )
      {
         this.AV10DocTipoID = aP0_DocTipoID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "DocTipoID");
      ...
      {
         get {
            return "documentotipoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.documentotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocTipoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.documentotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDOCTIPOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10DocTipoID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCTIPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocTipoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.documentotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10DocTipoID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.documentotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.DocumentoTipoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Documento Tipo View" ;
      }
      ...
      protected void WB2X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo de Documento", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\DocumentoTipoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\DocumentoTipoView.htm");
            /* Div Control */
      ...
      protected void START2X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Documento Tipo View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void PA2X2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.documentotipoview.aspx")), "core.documentotipoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.documentotipoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10DocTipoID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10DocTipoID", StringUtil.LTrimStr( (decimal)(AV10DocTipoID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vDOCTIPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocTipoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF2X2( )
      {
         ...
         {
            /* Using cursor H002X2 */
            pr_default.execute(0, new Object[] {AV10DocTipoID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A146DocTipoID = H002X2_A146DocTipoID[0];
               /* Execute user event: Load */
               E162X2 ();
      ...
      protected void E142X2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.documentotipoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H002X3 */
         pr_default.execute(1, new Object[] {AV10DocTipoID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A146DocTipoID = H002X3_A146DocTipoID[0];
            A147DocTipoSigla = H002X3_A147DocTipoSigla[0];
            AV16GXLvl9 = 1;
            Form.Caption = A147DocTipoSigla;
      ...
      protected void E152X2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "DocumentoTipo",  StringUtil.Trim( StringUtil.Str( (decimal)(A146DocTipoID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "DocumentoTipo",  2) )
         {
      ...
      protected void E112X2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"DocumentoTipo",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A146DocTipoID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E122X2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0034",(string)"",(string)"DocumentoTipo",StringUtil.Trim( StringUtil.Str( (decimal)(A146DocTipoID), 9, 0)),(string)AV14RecordDescription,formatLink("core.documentotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.DocumentoTipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.documentotipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.DocumentoTipoGeneral";
               WebComp_Generalwc_Component = "core.DocumentoTipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10DocTipoID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10DocTipoID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10DocTipoID", StringUtil.LTrimStr( (decimal)(AV10DocTipoID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vDOCTIPOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10DocTipoID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828211679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/documentotipoview.js", "?2023828211679", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Documento Tipo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A146DocTipoID',fld:'DOCTIPOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10DocTipoID',fld:'vDOCTIPOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E112X2',iparms:[{av:'A146DocTipoID',fld:'DOCTIPOID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E122X2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A146DocTipoID',fld:'DOCTIPOID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E132X2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10DocTipoID',fld:'vDOCTIPOID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         scmdbuf = "";
         H002X2_A146DocTipoID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H002X3_A146DocTipoID = new int[1] ;
         H002X3_A147DocTipoSigla = new string[] {""} ;
         A147DocTipoSigla = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.documentotipoview__default(),
            new Object[][] {
                new Object[] {
               H002X2_A146DocTipoID
               }
               , new Object[] {
               H002X3_A146DocTipoID, H002X3_A147DocTipoSigla
               }
            }
         );
      ...
      private int AV10DocTipoID ;
      private int wcpOAV10DocTipoID ;
      ...
      private int[] H002X2_A146DocTipoID ;
      private int[] H002X3_A146DocTipoID ;
      private string[] H002X3_A147DocTipoSigla ;
   ...
   public class documentotipoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10DocTipoID",GXType.Int32,9,0)
          };
          Object[] prmH002X3;
          ...
          def= new CursorDef[] {
              new CursorDef("H002X2", "SELECT DocTipoID FROM tb_documentotipo WHERE DocTipoID = :AV10DocTipoID ORDER BY DocTipoID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002X2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H002X3", "SELECT DocTipoID, DocTipoSigla FROM tb_documentotipo WHERE DocTipoID = :AV10DocTipoID ORDER BY DocTipoID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002X3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
