...
namespace GeneXus.Programs.core {
   public class produtotipoview : GXDataArea
   {
      public produtotipoview( )
      {
      ...
      public produtotipoview( IGxContext context )
      {
      ...
      public void execute( int aP0_PrtID ,
                           string aP1_TabCode )
      {
         this.AV10PrtID = aP0_PrtID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "PrtID");
      ...
      {
         get {
            return "produtotipoview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "core.produtotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PrtID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("core.produtotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPRTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10PrtID), 9, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PrtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Produtowc == null ) )
         {
            WebComp_Produtowc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "core.produtotipoview.aspx"+UrlEncode(StringUtil.LTrimStr(AV10PrtID,9,0)) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("core.produtotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "core.ProdutoTipoView" ;
      }

      public override string GetPgmdesc( )
      {
         return "Produto Tipo View" ;
      }
      ...
      protected void WB3M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Ir a Tipo de Produto", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_core\\ProdutoTipoView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalhes", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ProdutoTipoView.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblProduto_title_Internalname, "Produtos", "", "", lblProduto_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_core\\ProdutoTipoView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Produto") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableproduto_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Produtowc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldProdutowc), StringUtil.Lower( WebComp_Produtowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Produtowc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldProdutowc), StringUtil.Lower( WebComp_Produtowc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START3M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Produto Tipo View", 0) ;
         }
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldProdutowc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldProdutowc) == 0 ) || ( StringUtil.StrCmp(OldProdutowc, WebComp_Produtowc_Component) != 0 ) )
                           {
                              WebComp_Produtowc = getWebComponent(GetType(), "GeneXus.Programs", OldProdutowc, new Object[] {context} );
                              WebComp_Produtowc.ComponentInit();
                              WebComp_Produtowc.Name = "OldProdutowc";
                              WebComp_Produtowc_Component = OldProdutowc;
                           }
                           if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
                           {
                              WebComp_Produtowc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Produtowc_Component = OldProdutowc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PA3M2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "core.produtotipoview.aspx")), "core.produtotipoview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "core.produtotipoview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10PrtID = (int)(Math.Round(NumberUtil.Val( gxfirstwebparm, "."), 18, MidpointRounding.ToEven));
                     AssignAttri("", false, "AV10PrtID", StringUtil.LTrimStr( (decimal)(AV10PrtID), 9, 0));
                     GxWebStd.gx_hidden_field( context, "gxhash_vPRTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PrtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void RF3M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
               {
                  WebComp_Produtowc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H003M2 */
            pr_default.execute(0, new Object[] {AV10PrtID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A211PrtID = H003M2_A211PrtID[0];
               /* Execute user event: Load */
               E163M2 ();
      ...
      protected void E143M2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("core.produtotipoww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H003M3 */
         pr_default.execute(1, new Object[] {AV10PrtID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A211PrtID = H003M3_A211PrtID[0];
            A213PrtNome = H003M3_A213PrtNome[0];
            AV16GXLvl9 = 1;
            Form.Caption = A213PrtNome;
      ...
      protected void E153M2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "ProdutoTipo",  StringUtil.Trim( StringUtil.Str( (decimal)(A211PrtID), 9, 0))) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "ProdutoTipo",  2) )
         {
      ...
      protected void E113M2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"ProdutoTipo",(short)2,StringUtil.Trim( StringUtil.Str( (decimal)(A211PrtID), 9, 0)),(string)AV14RecordDescription});
      ...
      protected void E123M2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"ProdutoTipo",StringUtil.Trim( StringUtil.Str( (decimal)(A211PrtID), 9, 0)),(string)AV14RecordDescription,formatLink("core.produtotipoview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "core.ProdutoTipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "core.produtotipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "core.ProdutoTipoGeneral";
               WebComp_Generalwc_Component = "core.ProdutoTipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0029",(string)"",(int)AV10PrtID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "Produto") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Produtowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Produtowc_Component), StringUtil.Lower( "core.ProdutoTipoProdutoWC")) != 0 )
            {
               WebComp_Produtowc = getWebComponent(GetType(), "GeneXus.Programs", "core.produtotipoprodutowc", new Object[] {context} );
               WebComp_Produtowc.ComponentInit();
               WebComp_Produtowc.Name = "core.ProdutoTipoProdutoWC";
               WebComp_Produtowc_Component = "core.ProdutoTipoProdutoWC";
            }
            if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
            {
               WebComp_Produtowc.setjustcreated();
               WebComp_Produtowc.componentprepare(new Object[] {(string)"W0037",(string)"",(int)AV10PrtID});
               WebComp_Produtowc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Produtowc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Produtowc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10PrtID = Convert.ToInt32(getParm(obj,0));
         AssignAttri("", false, "AV10PrtID", StringUtil.LTrimStr( (decimal)(AV10PrtID), 9, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vPRTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10PrtID), "ZZZ,ZZZ,ZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Produtowc == null ) )
         {
            if ( StringUtil.Len( WebComp_Produtowc_Component) != 0 )
            {
               WebComp_Produtowc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382822743", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("core/produtotipoview.js", "?202382822743", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblProduto_title_Internalname = "PRODUTO_TITLE";
         divUnnamedtableproduto_Internalname = "UNNAMEDTABLEPRODUTO";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Produto Tipo View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'A211PrtID',fld:'PRTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'AV10PrtID',fld:'vPRTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","{handler:'E113M2',iparms:[{av:'A211PrtID',fld:'PRTID',pic:'ZZZ,ZZZ,ZZ9'},{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true}]");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","{handler:'E123M2',iparms:[{av:'AV14RecordDescription',fld:'vRECORDDESCRIPTION',pic:'',hsh:true},{av:'A211PrtID',fld:'PRTID',pic:'ZZZ,ZZZ,ZZ9'}]");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",",oparms:[{ctrl:'WWPAUX_WC'}]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E133M2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10PrtID',fld:'vPRTID',pic:'ZZZ,ZZZ,ZZ9',hsh:true}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{ctrl:'GENERALWC'},{ctrl:'PRODUTOWC'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblProduto_title_Jsonclick = "";
         WebComp_Produtowc_Component = "";
         OldProdutowc = "";
         ...
         GXDecQS = "";
         scmdbuf = "";
         H003M2_A211PrtID = new int[1] ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H003M3_A211PrtID = new int[1] ;
         H003M3_A213PrtNome = new string[] {""} ;
         A213PrtNome = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.core.produtotipoview__default(),
            new Object[][] {
                new Object[] {
               H003M2_A211PrtID
               }
               , new Object[] {
               H003M3_A211PrtID, H003M3_A213PrtNome
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Produtowc = new GeneXus.Http.GXNullWebComponent();
      ...
      private int AV10PrtID ;
      private int wcpOAV10PrtID ;
      ...
      private string lblProduto_title_Internalname ;
      private string lblProduto_title_Jsonclick ;
      private string divUnnamedtableproduto_Internalname ;
      private string WebComp_Produtowc_Component ;
      private string OldProdutowc ;
      ...
      private int[] H003M2_A211PrtID ;
      private int[] H003M3_A211PrtID ;
      private string[] H003M3_A213PrtNome ;
   ...
   public class produtotipoview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10PrtID",GXType.Int32,9,0)
          };
          Object[] prmH003M3;
          ...
          def= new CursorDef[] {
              new CursorDef("H003M2", "SELECT PrtID FROM tb_produtotipo WHERE PrtID = :AV10PrtID ORDER BY PrtID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003M2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003M3", "SELECT PrtID, PrtNome FROM tb_produtotipo WHERE PrtID = :AV10PrtID ORDER BY PrtID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003M3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
