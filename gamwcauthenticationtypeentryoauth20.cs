...
namespace GeneXus.Programs {
   public class gamwcauthenticationtypeentryoauth20 : GXWebComponent
   {
      ...
      {
         nRC_GXsfl_462 = (int)(Math.Round(NumberUtil.Val( GetPar( "nRC_GXsfl_462"), "."), 18, MidpointRounding.ToEven));
         nGXsfl_462_idx = (int)(Math.Round(NumberUtil.Val( GetPar( "nGXsfl_462_idx"), "."), 18, MidpointRounding.ToEven));
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 DataContentCellFL", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+edtavUserinfoadditionalparameters_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 DataContentCellFL", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplitteduserinforesponseuserlastnametag_Internalname, 1, 0, "px", 0, "px", "Table", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTextblockuserinforesponseuserlastnametag_cell_Internalname, 1, 0, "px", 0, "px", divTextblockuserinforesponseuserlastnametag_cell_Class, "start", "top", "", "", "div");
            /* Text block */
            ...
            wb_table1_413_1E2( true) ;
         }
         else
         {
            wb_table1_413_1E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_413_1E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 21), "VDELETEPROPERTY.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 21), "VDELETEPROPERTY.CLICK") == 0 ) )
                           {
                              ...
                              nGXsfl_462_idx = (int)(Math.Round(NumberUtil.Val( sEvtType, "."), 18, MidpointRounding.ToEven));
                              ...
                              AssignProp(sPrefix, false, edtavDeleteproperty_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV24DeleteProperty)) ? AV108Deleteproperty_GXI : context.convertURL( context.PathToRelativeUrl( AV24DeleteProperty))), !bGXsfl_462_Refreshing);
      ...
      protected void RF1E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            SubsflControlProps_4622( ) ;
            E141E2 ();
            if ( ( subGrid_Islastpage == 0 ) && ( GRID_nCurrentRecord > 0 ) && ( GRID_nGridOutOfScope == 0 ) && ( nGXsfl_462_idx == 1 ) )
            {
               GRID_nCurrentRecord = 0;
      ...
      protected void STRUP1E0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            nRC_GXsfl_462 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_462"), ",", "."), 18, MidpointRounding.ToEven));
      ...
      private void E141E2( )
      {
         ...
         returnInSub = false;
         AV107GXV1 = 1;
         while ( AV107GXV1 <= AV9AuthenticationTypeOauth20.gxTpr_Oauth20.gxTpr_Userinfo.gxTpr_Responseuserproperties.Count )
         {
            AV31GAMPropertySimple = ((GeneXus.Programs.genexussecurity.SdtGAMPropertySimple)AV9AuthenticationTypeOauth20.gxTpr_Oauth20.gxTpr_Userinfo.gxTpr_Responseuserproperties.Item(AV107GXV1));
            ...
            AV108Deleteproperty_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f454b006-8fb2-471d-b379-a84a77f89118", "", context.GetTheme( )));
         ...
         AssignAttri(sPrefix, false, edtavDeleteproperty_Internalname, AV24DeleteProperty);
         AV108Deleteproperty_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void E121E2( )
      {
         ...
         if ( AV105CheckRequiredFieldsResult )
         {
            ...
            else
            {
               ...
               AV109GXV2 = 1;
               while ( AV109GXV2 <= AV29Errors.Count )
               {
                  AV28Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV109GXV2));
      ...
      protected void S142( )
      {
         ...
         while ( nGXsfl_462_fel_idx < nRC_GXsfl_462 )
         {
            ...
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV26DynamicPropName)) && ! String.IsNullOrEmpty(StringUtil.RTrim( AV27DynamicPropTag)) )
            {
               ...
               {
                  AV111GXV3 = 1;
                  while ( AV111GXV3 <= AV29Errors.Count )
                  {
                     AV28Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV29Errors.Item(AV111GXV3));
      ...
      protected void wb_table1_413_1E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_413_1E2e( true) ;
         }
         else
         {
            wb_table1_413_1E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2023828101043", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("gamwcauthenticationtypeentryoauth20.js", "?2023828101044", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void sendrow_4622( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_462_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV24DeleteProperty_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV24DeleteProperty))&&String.IsNullOrEmpty(StringUtil.RTrim( AV108Deleteproperty_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV24DeleteProperty)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV24DeleteProperty)) ? AV108Deleteproperty_GXI : context.PathToRelativeUrl( AV24DeleteProperty));
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_unnamedtable2_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable4_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable6_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable8_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable7_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable10_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
         ...
         Dvpanel_unnamedtable11_Cls = "PanelCard_IconAndTitle Panel_BaseColor";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E141E2',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!'}]");
         ...
         setEventMetadata("'DOADD'","{handler:'E111E2',iparms:[]");
      ...
      private string AV108Deleteproperty_GXI ;
