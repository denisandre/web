...
namespace GeneXus.Programs {
   public class gamwweventsubscriptions : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV50ColumnsSelector, AV66Pgmname, AV62IsAuthorized_Display, AV63IsAuthorized_Update, AV64IsAuthorized_Delete, AV29IsAuthorized_Description, AV65IsAuthorized_Insert) ;
      ...
      protected void WB270( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(32), 2, 0)+","+"null"+");", "Incluir", bttBtninsert_Jsonclick, 5, "Incluir", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWEventSubscriptions.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(32), 2, 0)+","+"null"+");", "Selecionar colunas", bttBtneditcolumns_Jsonclick, 0, "Selecionar colunas", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWEventSubscriptions.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table1_21_272e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      {
         /* GeneXus formulas. */
         AV66Pgmname = "GAMWWEventSubscriptions";
         edtavDescription_Enabled = 0;
         AssignProp("", false, edtavDescription_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavDescription_Enabled), 5, 0), !bGXsfl_32_Refreshing);
         cmbavStatus.Enabled = 0;
         AssignProp("", false, cmbavStatus_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavStatus.Enabled), 5, 0), !bGXsfl_32_Refreshing);
         edtavSubscribe_Enabled = 0;
         AssignProp("", false, edtavSubscribe_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavSubscribe_Enabled), 5, 0), !bGXsfl_32_Refreshing);
         cmbavEvent.Enabled = 0;
         AssignProp("", false, cmbavEvent_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbavEvent.Enabled), 5, 0), !bGXsfl_32_Refreshing);
         edtavFilename_Enabled = 0;
         AssignProp("", false, edtavFilename_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavFilename_Enabled), 5, 0), !bGXsfl_32_Refreshing);
         edtavClassname_Enabled = 0;
         AssignProp("", false, edtavClassname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavClassname_Enabled), 5, 0), !bGXsfl_32_Refreshing);
         edtavMethodname_Enabled = 0;
         AssignProp("", false, edtavMethodname_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavMethodname_Enabled), 5, 0), !bGXsfl_32_Refreshing);
         edtavId_Enabled = 0;
         AssignProp("", false, edtavId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtavId_Enabled), 5, 0), !bGXsfl_32_Refreshing);
      }
      ...
      private void E17272( )
      {
         ...
         AV67GXV1 = 1;
         while ( AV67GXV1 <= AV23GAMEventSubscriptions.Count )
         {
            AV12EventSuscription = ((GeneXus.Programs.genexussecurity.SdtGAMEventSubscription)AV23GAMEventSubscriptions.Item(AV67GXV1));
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV55Session.Get(AV66Pgmname+"GridState"), "") == 0 )
         {
            AV36GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV66Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV36GridState.FromXml(AV55Session.Get(AV66Pgmname+"GridState"), null, "", "");
         }
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV66Pgmname+"GridState",  AV36GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void E19272( )
      {
         ...
         {
            AV68GXV2 = 1;
            while ( AV68GXV2 <= AV9Errors.Count )
            {
               AV25Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV9Errors.Item(AV68GXV2));
      ...
      protected void wb_table1_21_272( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382821562", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwweventsubscriptions.js", "?202382821565", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_322( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_32_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            TempTags = " " + ((edtavClassname_Enabled!=0)&&(edtavClassname_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 39,'',false,'"+sGXsfl_32_idx+"',32)\"" : " ");
            ROClassString = "Attribute";
            ...
            /* Single line edit */
            TempTags = " " + ((edtavMethodname_Enabled!=0)&&(edtavMethodname_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 40,'',false,'"+sGXsfl_32_idx+"',32)\"" : " ");
            ROClassString = "Attribute";
            ...
            /* Single line edit */
            TempTags = " " + ((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 41,'',false,'"+sGXsfl_32_idx+"',32)\"" : " ");
            ROClassString = "Attribute";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E17272',iparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV62IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV63IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV64IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV29IsAuthorized_Description',fld:'vISAUTHORIZED_DESCRIPTION',pic:'',hsh:true}]");
         ...
         setEventMetadata("VGRIDACTIONS.CLICK","{handler:'E18272',iparms:[{av:'cmbavGridactions'},{av:'AV59GridActions',fld:'vGRIDACTIONS',pic:'ZZZ9'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV50ColumnsSelector',fld:'vCOLUMNSSELECTOR',pic:''},{av:'AV66Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV62IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:'',hsh:true},{av:'AV63IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:'',hsh:true},{av:'AV64IsAuthorized_Delete',fld:'vISAUTHORIZED_DELETE',pic:'',hsh:true},{av:'AV29IsAuthorized_Description',fld:'vISAUTHORIZED_DESCRIPTION',pic:'',hsh:true},{av:'AV65IsAuthorized_Insert',fld:'vISAUTHORIZED_INSERT',pic:'',hsh:true},{av:'AV14Id',fld:'vID',pic:''}]");
