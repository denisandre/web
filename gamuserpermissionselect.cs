   ...
   public class gamuserpermissionselect : GXDataArea
   {
      ...
      protected void WB260( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_262( true) ;
         }
         else
         {
            wb_table1_12_262( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_262e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void wb_table1_12_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_17_262( true) ;
         }
         else
         {
            wb_table2_17_262( false) ;
         }
         return  ;
      }

      protected void wb_table2_17_262e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_12_262e( true) ;
         }
         else
         {
            wb_table1_12_262e( false) ;
         }
      }

      protected void wb_table2_17_262( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_17_262e( true) ;
         }
         else
         {
            wb_table2_17_262e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202382820466", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamuserpermissionselect.js", "?202382820467", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
